...
<a id="class_ResourceImporterTexture"></a>
...
<table>
  <thead>
    <tr>
      ...
      <th>[compress/channel_pack](#class_ResourceImporterTexture_property_compress/channel_pack)</th>
      <th>`0`</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>[compress/hdr_compression](#class_ResourceImporterTexture_property_compress/hdr_compression)</td>
      <td>`1`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[compress/high_quality](#class_ResourceImporterTexture_property_compress/high_quality)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[compress/lossy_quality](#class_ResourceImporterTexture_property_compress/lossy_quality)</td>
      <td>`0.7`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[compress/mode](#class_ResourceImporterTexture_property_compress/mode)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[compress/normal_map](#class_ResourceImporterTexture_property_compress/normal_map)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[compress/rdo_quality_loss](#class_ResourceImporterTexture_property_compress/rdo_quality_loss)</td>
      <td>`0.0`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[compress/uastc_level](#class_ResourceImporterTexture_property_compress/uastc_level)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[detect_3d/compress_to](#class_ResourceImporterTexture_property_detect_3d/compress_to)</td>
      <td>`1`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[editor/convert_colors_with_editor_theme](#class_ResourceImporterTexture_property_editor/convert_colors_with_editor_theme)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[editor/scale_with_editor_scale](#class_ResourceImporterTexture_property_editor/scale_with_editor_scale)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[mipmaps/generate](#class_ResourceImporterTexture_property_mipmaps/generate)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[mipmaps/limit](#class_ResourceImporterTexture_property_mipmaps/limit)</td>
      <td>`-1`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[process/channel_remap/alpha](#class_ResourceImporterTexture_property_process/channel_remap/alpha)</td>
      <td>`3`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[process/channel_remap/blue](#class_ResourceImporterTexture_property_process/channel_remap/blue)</td>
      <td>`2`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[process/channel_remap/green](#class_ResourceImporterTexture_property_process/channel_remap/green)</td>
      <td>`1`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[process/channel_remap/red](#class_ResourceImporterTexture_property_process/channel_remap/red)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[process/fix_alpha_border](#class_ResourceImporterTexture_property_process/fix_alpha_border)</td>
      <td>`true`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[process/hdr_as_srgb](#class_ResourceImporterTexture_property_process/hdr_as_srgb)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[process/hdr_clamp_exposure](#class_ResourceImporterTexture_property_process/hdr_clamp_exposure)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[process/normal_map_invert_y](#class_ResourceImporterTexture_property_process/normal_map_invert_y)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[process/premult_alpha](#class_ResourceImporterTexture_property_process/premult_alpha)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[process/size_limit](#class_ResourceImporterTexture_property_process/size_limit)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[roughness/mode](#class_ResourceImporterTexture_property_roughness/mode)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[roughness/src_normal](#class_ResourceImporterTexture_property_roughness/src_normal)</td>
      <td>`""`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[svg/scale](#class_ResourceImporterTexture_property_svg/scale)</td>
      <td>`1.0`</td>
    </tr>
  </tbody>
</table>
...
<a id="class_ResourceImporterTexture_property_compress/channel_pack"></a>

<!-- classref-property -->

[int](class_int.md) **compress/channel_pack** = `0` [🔗](#class_ResourceImporterTexture_property_compress/channel_pack)
...
<a id="class_ResourceImporterTexture_property_compress/hdr_compression"></a>

<!-- classref-property -->

[int](class_int.md) **compress/hdr_compression** = `1` [🔗](#class_ResourceImporterTexture_property_compress/hdr_compression)
...
<a id="class_ResourceImporterTexture_property_compress/high_quality"></a>

<!-- classref-property -->

[bool](class_bool.md) **compress/high_quality** = `false` [🔗](#class_ResourceImporterTexture_property_compress/high_quality)
...
<a id="class_ResourceImporterTexture_property_compress/lossy_quality"></a>

<!-- classref-property -->

[float](class_float.md) **compress/lossy_quality** = `0.7` [🔗](#class_ResourceImporterTexture_property_compress/lossy_quality)
...
<a id="class_ResourceImporterTexture_property_compress/mode"></a>

<!-- classref-property -->

[int](class_int.md) **compress/mode** = `0` [🔗](#class_ResourceImporterTexture_property_compress/mode)
...
<a id="class_ResourceImporterTexture_property_compress/normal_map"></a>

<!-- classref-property -->

[int](class_int.md) **compress/normal_map** = `0` [🔗](#class_ResourceImporterTexture_property_compress/normal_map)
...
<a id="class_ResourceImporterTexture_property_compress/rdo_quality_loss"></a>

<!-- classref-property -->

[float](class_float.md) **compress/rdo_quality_loss** = `0.0` [🔗](#class_ResourceImporterTexture_property_compress/rdo_quality_loss)
...
<a id="class_ResourceImporterTexture_property_compress/uastc_level"></a>

<!-- classref-property -->

[int](class_int.md) **compress/uastc_level** = `0` [🔗](#class_ResourceImporterTexture_property_compress/uastc_level)

The UASTC encoding level. Higher values result in better quality but make encoding times longer.

<hr class="classref-item-separator">

<a id="class_ResourceImporterTexture_property_detect_3d/compress_to"></a>

<!-- classref-property -->

[int](class_int.md) **detect_3d/compress_to** = `1` [🔗](#class_ResourceImporterTexture_property_detect_3d/compress_to)
...
<a id="class_ResourceImporterTexture_property_editor/convert_colors_with_editor_theme"></a>

<!-- classref-property -->

[bool](class_bool.md) **editor/convert_colors_with_editor_theme** = `false` [🔗](#class_ResourceImporterTexture_property_editor/convert_colors_with_editor_theme)
...
<a id="class_ResourceImporterTexture_property_editor/scale_with_editor_scale"></a>

<!-- classref-property -->

[bool](class_bool.md) **editor/scale_with_editor_scale** = `false` [🔗](#class_ResourceImporterTexture_property_editor/scale_with_editor_scale)
...
<a id="class_ResourceImporterTexture_property_mipmaps/generate"></a>

<!-- classref-property -->

[bool](class_bool.md) **mipmaps/generate** = `false` [🔗](#class_ResourceImporterTexture_property_mipmaps/generate)
...
<a id="class_ResourceImporterTexture_property_mipmaps/limit"></a>

<!-- classref-property -->

[int](class_int.md) **mipmaps/limit** = `-1` [🔗](#class_ResourceImporterTexture_property_mipmaps/limit)

Unimplemented. This currently has no effect when changed.

<hr class="classref-item-separator">

<a id="class_ResourceImporterTexture_property_process/channel_remap/alpha"></a>

<!-- classref-property -->

[int](class_int.md) **process/channel_remap/alpha** = `3` [🔗](#class_ResourceImporterTexture_property_process/channel_remap/alpha)
...
<a id="class_ResourceImporterTexture_property_process/channel_remap/blue"></a>

<!-- classref-property -->

[int](class_int.md) **process/channel_remap/blue** = `2` [🔗](#class_ResourceImporterTexture_property_process/channel_remap/blue)
...
<a id="class_ResourceImporterTexture_property_process/channel_remap/green"></a>

<!-- classref-property -->

[int](class_int.md) **process/channel_remap/green** = `1` [🔗](#class_ResourceImporterTexture_property_process/channel_remap/green)
...
<a id="class_ResourceImporterTexture_property_process/channel_remap/red"></a>

<!-- classref-property -->

[int](class_int.md) **process/channel_remap/red** = `0` [🔗](#class_ResourceImporterTexture_property_process/channel_remap/red)
...
<a id="class_ResourceImporterTexture_property_process/fix_alpha_border"></a>

<!-- classref-property -->

[bool](class_bool.md) **process/fix_alpha_border** = `true` [🔗](#class_ResourceImporterTexture_property_process/fix_alpha_border)
...
<a id="class_ResourceImporterTexture_property_process/hdr_as_srgb"></a>

<!-- classref-property -->

[bool](class_bool.md) **process/hdr_as_srgb** = `false` [🔗](#class_ResourceImporterTexture_property_process/hdr_as_srgb)
...
<a id="class_ResourceImporterTexture_property_process/hdr_clamp_exposure"></a>

<!-- classref-property -->

[bool](class_bool.md) **process/hdr_clamp_exposure** = `false` [🔗](#class_ResourceImporterTexture_property_process/hdr_clamp_exposure)
...
<a id="class_ResourceImporterTexture_property_process/normal_map_invert_y"></a>

<!-- classref-property -->

[bool](class_bool.md) **process/normal_map_invert_y** = `false` [🔗](#class_ResourceImporterTexture_property_process/normal_map_invert_y)

**Deprecated:** The same result can be achieved by setting [process/channel_remap/green](class_resourceimportertexture.md#class_ResourceImporterTexture_property_process/channel_remap/green) to ``Green Inverted``.
...
<a id="class_ResourceImporterTexture_property_process/premult_alpha"></a>

<!-- classref-property -->

[bool](class_bool.md) **process/premult_alpha** = `false` [🔗](#class_ResourceImporterTexture_property_process/premult_alpha)
...
<a id="class_ResourceImporterTexture_property_process/size_limit"></a>

<!-- classref-property -->

[int](class_int.md) **process/size_limit** = `0` [🔗](#class_ResourceImporterTexture_property_process/size_limit)
...
\ **Note:** Even if this is set to ``0``, import size is limited to the following dimensions for technical reasons. Depending on [compress/mode](class_resourceimportertexture.md#class_ResourceImporterTexture_property_compress/mode), textures will be downsampled on import if necessary:
...
<a id="class_ResourceImporterTexture_property_roughness/mode"></a>

<!-- classref-property -->

[int](class_int.md) **roughness/mode** = `0` [🔗](#class_ResourceImporterTexture_property_roughness/mode)

The color channel to consider as a roughness map in this texture. Only effective if [roughness/src_normal](class_resourceimportertexture.md#class_ResourceImporterTexture_property_roughness/src_normal) is not empty.

<hr class="classref-item-separator">

<a id="class_ResourceImporterTexture_property_roughness/src_normal"></a>
...
<a id="class_ResourceImporterTexture_property_svg/scale"></a>

<!-- classref-property -->

[float](class_float.md) **svg/scale** = `1.0` [🔗](#class_ResourceImporterTexture_property_svg/scale)
