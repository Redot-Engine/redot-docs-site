...
JavaScriptObject is used to interact with JavaScript objects retrieved or created via [JavaScriptBridge.get_interface()](JavaScriptBridge.md#JavaScriptBridge_method_get_interface), [JavaScriptBridge.create_object()](JavaScriptBridge.md#JavaScriptBridge_method_create_object), or [JavaScriptBridge.create_callback()](JavaScriptBridge.md#JavaScriptBridge_method_create_callback).
