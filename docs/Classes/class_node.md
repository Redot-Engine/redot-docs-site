...
\ **Networking with nodes:** After connecting to a server (or making one, see [ENetMultiplayerPeer](class_enetmultiplayerpeer.md)), it is possible to use the built-in RPC (remote procedure call) system to communicate over the network. By calling [rpc()](class_node.md#class_Node_method_rpc) with a method name, it will be called locally and in all connected peers (peers = clients and the server that accepts connections). To identify which node receives the RPC call, Redot will use its [NodePath](class_nodepath.md) (make sure node names are the same on all peers). Also, take a look at the high-level networking tutorial and corresponding demos.
...
<table>
  <thead>
    <tr>
      <th>[AutoTranslateMode](class_node.md#enum_Node_AutoTranslateMode)</th>
      <th>[auto_translate_mode](#class_Node_property_auto_translate_mode)</th>
      <th>`0`</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>[editor_description](#class_Node_property_editor_description)</td>
      <td>`""`</td>
    </tr>
    <tr>
      <td>[MultiplayerAPI](class_multiplayerapi.md)</td>
      <td>[multiplayer](#class_Node_property_multiplayer)</td>
      <td></td>
    </tr>
    <tr>
      <td>[StringName](class_stringname.md)</td>
      <td>[name](#class_Node_property_name)</td>
      <td></td>
    </tr>
    <tr>
      <td>[Node](class_node.md)</td>
      <td>[owner](#class_Node_property_owner)</td>
      <td></td>
    </tr>
    <tr>
      <td>[PhysicsInterpolationMode](class_node.md#enum_Node_PhysicsInterpolationMode)</td>
      <td>[physics_interpolation_mode](#class_Node_property_physics_interpolation_mode)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[ProcessMode](class_node.md#enum_Node_ProcessMode)</td>
      <td>[process_mode](#class_Node_property_process_mode)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[process_physics_priority](#class_Node_property_process_physics_priority)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[process_priority](#class_Node_property_process_priority)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[ProcessThreadGroup](class_node.md#enum_Node_ProcessThreadGroup)</td>
      <td>[process_thread_group](#class_Node_property_process_thread_group)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[process_thread_group_order](#class_Node_property_process_thread_group_order)</td>
      <td></td>
    </tr>
    <tr>
      <td>**BitField**\[[ProcessThreadMessages](class_node.md#enum_Node_ProcessThreadMessages)\]</td>
      <td>[process_thread_messages](#class_Node_property_process_thread_messages)</td>
      <td></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[scene_file_path](#class_Node_property_scene_file_path)</td>
      <td></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[unique_name_in_owner](#class_Node_property_unique_name_in_owner)</td>
      <td>`false`</td>
    </tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr>
      <th>`void`</th>
      <th>[_enter_tree](#class_Node_private_method__enter_tree)\ (\ ) <span class="virtual">virtual</span></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>`void`</td>
      <td>[_exit_tree](#class_Node_private_method__exit_tree)\ (\ ) <span class="virtual">virtual</span></td>
    </tr>
    <tr>
      <td>[PackedStringArray](class_packedstringarray.md)</td>
      <td>[_get_accessibility_configuration_warnings](#class_Node_private_method__get_accessibility_configuration_warnings)\ (\ ) <span class="virtual">virtual</span> <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[PackedStringArray](class_packedstringarray.md)</td>
      <td>[_get_configuration_warnings](#class_Node_private_method__get_configuration_warnings)\ (\ ) <span class="virtual">virtual</span> <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[RID](class_rid.md)</td>
      <td>[_get_focused_accessibility_element](#class_Node_private_method__get_focused_accessibility_element)\ (\ ) <span class="virtual">virtual</span> <span class="const">const</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[_input](#class_Node_private_method__input)\ (\ event\: [InputEvent](class_inputevent.md)\ ) <span class="virtual">virtual</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[_physics_process](#class_Node_private_method__physics_process)\ (\ delta\: [float](class_float.md)\ ) <span class="virtual">virtual</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[_process](#class_Node_private_method__process)\ (\ delta\: [float](class_float.md)\ ) <span class="virtual">virtual</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[_ready](#class_Node_private_method__ready)\ (\ ) <span class="virtual">virtual</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[_shortcut_input](#class_Node_private_method__shortcut_input)\ (\ event\: [InputEvent](class_inputevent.md)\ ) <span class="virtual">virtual</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[_unhandled_input](#class_Node_private_method__unhandled_input)\ (\ event\: [InputEvent](class_inputevent.md)\ ) <span class="virtual">virtual</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[_unhandled_key_input](#class_Node_private_method__unhandled_key_input)\ (\ event\: [InputEvent](class_inputevent.md)\ ) <span class="virtual">virtual</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[_unhandled_picking_input](#class_Node_private_method__unhandled_picking_input)\ (\ event\: [InputEvent](class_inputevent.md)\ ) <span class="virtual">virtual</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[add_child](#class_Node_method_add_child)\ (\ node\: [Node](class_node.md), force_readable_name\: [bool](class_bool.md) = false, internal\: [InternalMode](class_node.md#enum_Node_InternalMode) = 0\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[add_sibling](#class_Node_method_add_sibling)\ (\ sibling\: [Node](class_node.md), force_readable_name\: [bool](class_bool.md) = false\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[add_to_group](#class_Node_method_add_to_group)\ (\ group\: [StringName](class_stringname.md), persistent\: [bool](class_bool.md) = false\ )</td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[atr](#class_Node_method_atr)\ (\ message\: [String](class_string.md), context\: [StringName](class_stringname.md) = ""\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[atr_n](#class_Node_method_atr_n)\ (\ message\: [String](class_string.md), plural_message\: [StringName](class_stringname.md), n\: [int](class_int.md), context\: [StringName](class_stringname.md) = ""\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Variant](class_variant.md)</td>
      <td>[call_deferred_thread_group](#class_Node_method_call_deferred_thread_group)\ (\ method\: [StringName](class_stringname.md), ...\ ) <span class="vararg">vararg</span></td>
    </tr>
    <tr>
      <td>[Variant](class_variant.md)</td>
      <td>[call_thread_safe](#class_Node_method_call_thread_safe)\ (\ method\: [StringName](class_stringname.md), ...\ ) <span class="vararg">vararg</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[can_auto_translate](#class_Node_method_can_auto_translate)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[can_process](#class_Node_method_can_process)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Tween](class_tween.md)</td>
      <td>[create_tween](#class_Node_method_create_tween)\ (\ )</td>
    </tr>
    <tr>
      <td>[Node](class_node.md)</td>
      <td>[duplicate](#class_Node_method_duplicate)\ (\ flags\: [int](class_int.md) = 15\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Node](class_node.md)</td>
      <td>[find_child](#class_Node_method_find_child)\ (\ pattern\: [String](class_string.md), recursive\: [bool](class_bool.md) = true, owned\: [bool](class_bool.md) = true\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Array](class_array.md)\[[Node](class_node.md)\]</td>
      <td>[find_children](#class_Node_method_find_children)\ (\ pattern\: [String](class_string.md), type\: [String](class_string.md) = "", recursive\: [bool](class_bool.md) = true, owned\: [bool](class_bool.md) = true\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Node](class_node.md)</td>
      <td>[find_parent](#class_Node_method_find_parent)\ (\ pattern\: [String](class_string.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[RID](class_rid.md)</td>
      <td>[get_accessibility_element](#class_Node_method_get_accessibility_element)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Node](class_node.md)</td>
      <td>[get_child](#class_Node_method_get_child)\ (\ idx\: [int](class_int.md), include_internal\: [bool](class_bool.md) = false\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_child_count](#class_Node_method_get_child_count)\ (\ include_internal\: [bool](class_bool.md) = false\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Array](class_array.md)\[[Node](class_node.md)\]</td>
      <td>[get_children](#class_Node_method_get_children)\ (\ include_internal\: [bool](class_bool.md) = false\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Array](class_array.md)\[[StringName](class_stringname.md)\]</td>
      <td>[get_groups](#class_Node_method_get_groups)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_index](#class_Node_method_get_index)\ (\ include_internal\: [bool](class_bool.md) = false\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Window](class_window.md)</td>
      <td>[get_last_exclusive_window](#class_Node_method_get_last_exclusive_window)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_multiplayer_authority](#class_Node_method_get_multiplayer_authority)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Node](class_node.md)</td>
      <td>[get_node](#class_Node_method_get_node)\ (\ path\: [NodePath](class_nodepath.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Array](class_array.md)</td>
      <td>[get_node_and_resource](#class_Node_method_get_node_and_resource)\ (\ path\: [NodePath](class_nodepath.md)\ )</td>
    </tr>
    <tr>
      <td>[Node](class_node.md)</td>
      <td>[get_node_or_null](#class_Node_method_get_node_or_null)\ (\ path\: [NodePath](class_nodepath.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Variant](class_variant.md)</td>
      <td>[get_node_rpc_config](#class_Node_method_get_node_rpc_config)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Array](class_array.md)\[[int](class_int.md)\]</td>
      <td>[get_orphan_node_ids](#class_Node_method_get_orphan_node_ids)\ (\ ) <span class="static">static</span></td>
    </tr>
    <tr>
      <td>[Node](class_node.md)</td>
      <td>[get_parent](#class_Node_method_get_parent)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[NodePath](class_nodepath.md)</td>
      <td>[get_path](#class_Node_method_get_path)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[NodePath](class_nodepath.md)</td>
      <td>[get_path_to](#class_Node_method_get_path_to)\ (\ node\: [Node](class_node.md), use_unique_path\: [bool](class_bool.md) = false\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[get_physics_process_delta_time](#class_Node_method_get_physics_process_delta_time)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[get_process_delta_time](#class_Node_method_get_process_delta_time)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[get_scene_instance_load_placeholder](#class_Node_method_get_scene_instance_load_placeholder)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[SceneTree](class_scenetree.md)</td>
      <td>[get_tree](#class_Node_method_get_tree)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_tree_string](#class_Node_method_get_tree_string)\ (\ )</td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_tree_string_pretty](#class_Node_method_get_tree_string_pretty)\ (\ )</td>
    </tr>
    <tr>
      <td>[Viewport](class_viewport.md)</td>
      <td>[get_viewport](#class_Node_method_get_viewport)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Window](class_window.md)</td>
      <td>[get_window](#class_Node_method_get_window)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[has_node](#class_Node_method_has_node)\ (\ path\: [NodePath](class_nodepath.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[has_node_and_resource](#class_Node_method_has_node_and_resource)\ (\ path\: [NodePath](class_nodepath.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_ancestor_of](#class_Node_method_is_ancestor_of)\ (\ node\: [Node](class_node.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_displayed_folded](#class_Node_method_is_displayed_folded)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_editable_instance](#class_Node_method_is_editable_instance)\ (\ node\: [Node](class_node.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_greater_than](#class_Node_method_is_greater_than)\ (\ node\: [Node](class_node.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_in_group](#class_Node_method_is_in_group)\ (\ group\: [StringName](class_stringname.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_inside_tree](#class_Node_method_is_inside_tree)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_multiplayer_authority](#class_Node_method_is_multiplayer_authority)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_node_ready](#class_Node_method_is_node_ready)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_part_of_edited_scene](#class_Node_method_is_part_of_edited_scene)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_physics_interpolated](#class_Node_method_is_physics_interpolated)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_physics_interpolated_and_enabled](#class_Node_method_is_physics_interpolated_and_enabled)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_physics_processing](#class_Node_method_is_physics_processing)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_physics_processing_internal](#class_Node_method_is_physics_processing_internal)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_processing](#class_Node_method_is_processing)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_processing_input](#class_Node_method_is_processing_input)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_processing_internal](#class_Node_method_is_processing_internal)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_processing_shortcut_input](#class_Node_method_is_processing_shortcut_input)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_processing_unhandled_input](#class_Node_method_is_processing_unhandled_input)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_processing_unhandled_key_input](#class_Node_method_is_processing_unhandled_key_input)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_processing_unhandled_picking_input](#class_Node_method_is_processing_unhandled_picking_input)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[move_child](#class_Node_method_move_child)\ (\ child_node\: [Node](class_node.md), to_index\: [int](class_int.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[notify_deferred_thread_group](#class_Node_method_notify_deferred_thread_group)\ (\ what\: [int](class_int.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[notify_thread_safe](#class_Node_method_notify_thread_safe)\ (\ what\: [int](class_int.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[print_orphan_nodes](#class_Node_method_print_orphan_nodes)\ (\ ) <span class="static">static</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[print_tree](#class_Node_method_print_tree)\ (\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[print_tree_pretty](#class_Node_method_print_tree_pretty)\ (\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[propagate_call](#class_Node_method_propagate_call)\ (\ method\: [StringName](class_stringname.md), args\: [Array](class_array.md) = [], parent_first\: [bool](class_bool.md) = false\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[propagate_notification](#class_Node_method_propagate_notification)\ (\ what\: [int](class_int.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[queue_accessibility_update](#class_Node_method_queue_accessibility_update)\ (\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[queue_free](#class_Node_method_queue_free)\ (\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[remove_child](#class_Node_method_remove_child)\ (\ node\: [Node](class_node.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[remove_from_group](#class_Node_method_remove_from_group)\ (\ group\: [StringName](class_stringname.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[reparent](#class_Node_method_reparent)\ (\ new_parent\: [Node](class_node.md), keep_global_transform\: [bool](class_bool.md) = true\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[replace_by](#class_Node_method_replace_by)\ (\ node\: [Node](class_node.md), keep_groups\: [bool](class_bool.md) = false\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[request_ready](#class_Node_method_request_ready)\ (\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[reset_physics_interpolation](#class_Node_method_reset_physics_interpolation)\ (\ )</td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[rpc](#class_Node_method_rpc)\ (\ method\: [StringName](class_stringname.md), ...\ ) <span class="vararg">vararg</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[rpc_config](#class_Node_method_rpc_config)\ (\ method\: [StringName](class_stringname.md), config\: [Variant](class_variant.md)\ )</td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[rpc_id](#class_Node_method_rpc_id)\ (\ peer_id\: [int](class_int.md), method\: [StringName](class_stringname.md), ...\ ) <span class="vararg">vararg</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_deferred_thread_group](#class_Node_method_set_deferred_thread_group)\ (\ property\: [StringName](class_stringname.md), value\: [Variant](class_variant.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_display_folded](#class_Node_method_set_display_folded)\ (\ fold\: [bool](class_bool.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_editable_instance](#class_Node_method_set_editable_instance)\ (\ node\: [Node](class_node.md), is_editable\: [bool](class_bool.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_multiplayer_authority](#class_Node_method_set_multiplayer_authority)\ (\ id\: [int](class_int.md), recursive\: [bool](class_bool.md) = true\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_physics_process](#class_Node_method_set_physics_process)\ (\ enable\: [bool](class_bool.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_physics_process_internal](#class_Node_method_set_physics_process_internal)\ (\ enable\: [bool](class_bool.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_process](#class_Node_method_set_process)\ (\ enable\: [bool](class_bool.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_process_input](#class_Node_method_set_process_input)\ (\ enable\: [bool](class_bool.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_process_internal](#class_Node_method_set_process_internal)\ (\ enable\: [bool](class_bool.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_process_shortcut_input](#class_Node_method_set_process_shortcut_input)\ (\ enable\: [bool](class_bool.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_process_unhandled_input](#class_Node_method_set_process_unhandled_input)\ (\ enable\: [bool](class_bool.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_process_unhandled_key_input](#class_Node_method_set_process_unhandled_key_input)\ (\ enable\: [bool](class_bool.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_process_unhandled_picking_input](#class_Node_method_set_process_unhandled_picking_input)\ (\ enable\: [bool](class_bool.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_scene_instance_load_placeholder](#class_Node_method_set_scene_instance_load_placeholder)\ (\ load_placeholder\: [bool](class_bool.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_thread_safe](#class_Node_method_set_thread_safe)\ (\ property\: [StringName](class_stringname.md), value\: [Variant](class_variant.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_translation_domain_inherited](#class_Node_method_set_translation_domain_inherited)\ (\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[update_configuration_warnings](#class_Node_method_update_configuration_warnings)\ (\ )</td>
    </tr>
  </tbody>
</table>
...
<a id="class_Node_signal_child_entered_tree"></a>

<!-- classref-signal -->

**child_entered_tree**\ (\ node\: [Node](class_node.md)\ ) [🔗](#class_Node_signal_child_entered_tree)
...
<a id="class_Node_signal_child_exiting_tree"></a>

<!-- classref-signal -->

**child_exiting_tree**\ (\ node\: [Node](class_node.md)\ ) [🔗](#class_Node_signal_child_exiting_tree)
...
<a id="class_Node_signal_child_order_changed"></a>
...
<a id="class_Node_signal_editor_description_changed"></a>

<!-- classref-signal -->

**editor_description_changed**\ (\ node\: [Node](class_node.md)\ ) [🔗](#class_Node_signal_editor_description_changed)

Emitted when the node's editor description field changed.

<hr class="classref-item-separator">

<a id="class_Node_signal_editor_state_changed"></a>
...
<a id="class_Node_signal_ready"></a>
...
<a id="class_Node_signal_renamed"></a>
...
<a id="class_Node_signal_replacing_by"></a>

<!-- classref-signal -->

**replacing_by**\ (\ node\: [Node](class_node.md)\ ) [🔗](#class_Node_signal_replacing_by)
...
<a id="class_Node_signal_tree_entered"></a>
...
<a id="class_Node_signal_tree_exited"></a>
...
<a id="class_Node_signal_tree_exiting"></a>
...
<a id="class_Node_constant_PROCESS_MODE_INHERIT"></a>

<!-- classref-enumeration-constant -->

[ProcessMode](class_node.md#enum_Node_ProcessMode) **PROCESS_MODE_INHERIT** = `0`

Inherits [process_mode](class_node.md#class_Node_property_process_mode) from the node's parent. This is the default for any newly created node.<a id="class_Node_constant_PROCESS_MODE_PAUSABLE"></a>

<!-- classref-enumeration-constant -->

[ProcessMode](class_node.md#enum_Node_ProcessMode) **PROCESS_MODE_PAUSABLE** = `1`

Stops processing when [SceneTree.paused](class_scenetree.md#class_SceneTree_property_paused) is ``true``. This is the inverse of [PROCESS_MODE_WHEN_PAUSED](class_node.md#class_Node_constant_PROCESS_MODE_WHEN_PAUSED), and the default for the root node.<a id="class_Node_constant_PROCESS_MODE_WHEN_PAUSED"></a>

<!-- classref-enumeration-constant -->

[ProcessMode](class_node.md#enum_Node_ProcessMode) **PROCESS_MODE_WHEN_PAUSED** = `2`

Process **only** when [SceneTree.paused](class_scenetree.md#class_SceneTree_property_paused) is ``true``. This is the inverse of [PROCESS_MODE_PAUSABLE](class_node.md#class_Node_constant_PROCESS_MODE_PAUSABLE).<a id="class_Node_constant_PROCESS_MODE_ALWAYS"></a>

<!-- classref-enumeration-constant -->

[ProcessMode](class_node.md#enum_Node_ProcessMode) **PROCESS_MODE_ALWAYS** = `3`

Always process. Keeps processing, ignoring [SceneTree.paused](class_scenetree.md#class_SceneTree_property_paused). This is the inverse of [PROCESS_MODE_DISABLED](class_node.md#class_Node_constant_PROCESS_MODE_DISABLED).<a id="class_Node_constant_PROCESS_MODE_DISABLED"></a>

<!-- classref-enumeration-constant -->

[ProcessMode](class_node.md#enum_Node_ProcessMode) **PROCESS_MODE_DISABLED** = `4`

Never process. Completely disables processing, ignoring [SceneTree.paused](class_scenetree.md#class_SceneTree_property_paused). This is the inverse of [PROCESS_MODE_ALWAYS](class_node.md#class_Node_constant_PROCESS_MODE_ALWAYS).<hr class="classref-item-separator">
...
<a id="class_Node_constant_PROCESS_THREAD_GROUP_INHERIT"></a>

<!-- classref-enumeration-constant -->

[ProcessThreadGroup](class_node.md#enum_Node_ProcessThreadGroup) **PROCESS_THREAD_GROUP_INHERIT** = `0`

Process this node based on the thread group mode of the first parent (or grandparent) node that has a thread group mode that is not inherit. See [process_thread_group](class_node.md#class_Node_property_process_thread_group) for more information.<a id="class_Node_constant_PROCESS_THREAD_GROUP_MAIN_THREAD"></a>

<!-- classref-enumeration-constant -->

[ProcessThreadGroup](class_node.md#enum_Node_ProcessThreadGroup) **PROCESS_THREAD_GROUP_MAIN_THREAD** = `1`

Process this node (and child nodes set to inherit) on the main thread. See [process_thread_group](class_node.md#class_Node_property_process_thread_group) for more information.<a id="class_Node_constant_PROCESS_THREAD_GROUP_SUB_THREAD"></a>

<!-- classref-enumeration-constant -->

[ProcessThreadGroup](class_node.md#enum_Node_ProcessThreadGroup) **PROCESS_THREAD_GROUP_SUB_THREAD** = `2`

Process this node (and child nodes set to inherit) on a sub-thread. See [process_thread_group](class_node.md#class_Node_property_process_thread_group) for more information.<hr class="classref-item-separator">
...
<a id="class_Node_constant_FLAG_PROCESS_THREAD_MESSAGES"></a>

<!-- classref-enumeration-constant -->

[ProcessThreadMessages](class_node.md#enum_Node_ProcessThreadMessages) **FLAG_PROCESS_THREAD_MESSAGES** = `1`

Allows this node to process threaded messages created with [call_deferred_thread_group()](class_node.md#class_Node_method_call_deferred_thread_group) right before [_process()](class_node.md#class_Node_private_method__process) is called.<a id="class_Node_constant_FLAG_PROCESS_THREAD_MESSAGES_PHYSICS"></a>

<!-- classref-enumeration-constant -->

[ProcessThreadMessages](class_node.md#enum_Node_ProcessThreadMessages) **FLAG_PROCESS_THREAD_MESSAGES_PHYSICS** = `2`

Allows this node to process threaded messages created with [call_deferred_thread_group()](class_node.md#class_Node_method_call_deferred_thread_group) right before [_physics_process()](class_node.md#class_Node_private_method__physics_process) is called.<a id="class_Node_constant_FLAG_PROCESS_THREAD_MESSAGES_ALL"></a>
...
<a id="class_Node_constant_PHYSICS_INTERPOLATION_MODE_INHERIT"></a>

<!-- classref-enumeration-constant -->

[PhysicsInterpolationMode](class_node.md#enum_Node_PhysicsInterpolationMode) **PHYSICS_INTERPOLATION_MODE_INHERIT** = `0`

Inherits [physics_interpolation_mode](class_node.md#class_Node_property_physics_interpolation_mode) from the node's parent. This is the default for any newly created node.<a id="class_Node_constant_PHYSICS_INTERPOLATION_MODE_ON"></a>

<!-- classref-enumeration-constant -->

[PhysicsInterpolationMode](class_node.md#enum_Node_PhysicsInterpolationMode) **PHYSICS_INTERPOLATION_MODE_ON** = `1`

Enables physics interpolation for this node and for children set to [PHYSICS_INTERPOLATION_MODE_INHERIT](class_node.md#class_Node_constant_PHYSICS_INTERPOLATION_MODE_INHERIT). This is the default for the root node.<a id="class_Node_constant_PHYSICS_INTERPOLATION_MODE_OFF"></a>

<!-- classref-enumeration-constant -->

[PhysicsInterpolationMode](class_node.md#enum_Node_PhysicsInterpolationMode) **PHYSICS_INTERPOLATION_MODE_OFF** = `2`

Disables physics interpolation for this node and for children set to [PHYSICS_INTERPOLATION_MODE_INHERIT](class_node.md#class_Node_constant_PHYSICS_INTERPOLATION_MODE_INHERIT).<hr class="classref-item-separator">
...
<a id="class_Node_constant_DUPLICATE_SIGNALS"></a>

<!-- classref-enumeration-constant -->

[DuplicateFlags](class_node.md#enum_Node_DuplicateFlags) **DUPLICATE_SIGNALS** = `1`

Duplicate the node's signal connections that are connected with the [Object.CONNECT_PERSIST](class_object.md#class_Object_constant_CONNECT_PERSIST) flag.<a id="class_Node_constant_DUPLICATE_GROUPS"></a>

<!-- classref-enumeration-constant -->

[DuplicateFlags](class_node.md#enum_Node_DuplicateFlags) **DUPLICATE_GROUPS** = `2`

Duplicate the node's groups.<a id="class_Node_constant_DUPLICATE_SCRIPTS"></a>

<!-- classref-enumeration-constant -->

[DuplicateFlags](class_node.md#enum_Node_DuplicateFlags) **DUPLICATE_SCRIPTS** = `4`

Duplicate the node's script (also overriding the duplicated children's scripts, if combined with [DUPLICATE_USE_INSTANTIATION](class_node.md#class_Node_constant_DUPLICATE_USE_INSTANTIATION)).<a id="class_Node_constant_DUPLICATE_USE_INSTANTIATION"></a>

<!-- classref-enumeration-constant -->

[DuplicateFlags](class_node.md#enum_Node_DuplicateFlags) **DUPLICATE_USE_INSTANTIATION** = `8`

Duplicate using [PackedScene.instantiate()](class_packedscene.md#class_PackedScene_method_instantiate). If the node comes from a scene saved on disk, reuses [PackedScene.instantiate()](class_packedscene.md#class_PackedScene_method_instantiate) as the base for the duplicated node and its children.<hr class="classref-item-separator">
...
<a id="class_Node_constant_INTERNAL_MODE_DISABLED"></a>

<!-- classref-enumeration-constant -->

[InternalMode](class_node.md#enum_Node_InternalMode) **INTERNAL_MODE_DISABLED** = `0`

The node will not be internal.<a id="class_Node_constant_INTERNAL_MODE_FRONT"></a>

<!-- classref-enumeration-constant -->

[InternalMode](class_node.md#enum_Node_InternalMode) **INTERNAL_MODE_FRONT** = `1`

The node will be placed at the beginning of the parent's children, before any non-internal sibling.<a id="class_Node_constant_INTERNAL_MODE_BACK"></a>
...
<a id="class_Node_constant_AUTO_TRANSLATE_MODE_INHERIT"></a>

<!-- classref-enumeration-constant -->

[AutoTranslateMode](class_node.md#enum_Node_AutoTranslateMode) **AUTO_TRANSLATE_MODE_INHERIT** = `0`

Inherits [auto_translate_mode](class_node.md#class_Node_property_auto_translate_mode) from the node's parent. This is the default for any newly created node.<a id="class_Node_constant_AUTO_TRANSLATE_MODE_ALWAYS"></a>

<!-- classref-enumeration-constant -->

[AutoTranslateMode](class_node.md#enum_Node_AutoTranslateMode) **AUTO_TRANSLATE_MODE_ALWAYS** = `1`

Always automatically translate. This is the inverse of [AUTO_TRANSLATE_MODE_DISABLED](class_node.md#class_Node_constant_AUTO_TRANSLATE_MODE_DISABLED), and the default for the root node.<a id="class_Node_constant_AUTO_TRANSLATE_MODE_DISABLED"></a>
...
String parsing for POT generation will be skipped for this node and children that are set to [AUTO_TRANSLATE_MODE_INHERIT](class_node.md#class_Node_constant_AUTO_TRANSLATE_MODE_INHERIT).<hr class="classref-section-separator">

<!-- classref-descriptions-group -->

## Constants

<a id="class_Node_constant_NOTIFICATION_ENTER_TREE"></a>
...
<a id="class_Node_constant_NOTIFICATION_EXIT_TREE"></a>
...
<a id="class_Node_constant_NOTIFICATION_MOVED_IN_PARENT"></a>
...
<a id="class_Node_constant_NOTIFICATION_READY"></a>
...
<a id="class_Node_constant_NOTIFICATION_PAUSED"></a>
...
<a id="class_Node_constant_NOTIFICATION_UNPAUSED"></a>
...
<a id="class_Node_constant_NOTIFICATION_PHYSICS_PROCESS"></a>
...
<a id="class_Node_constant_NOTIFICATION_PROCESS"></a>
...
<a id="class_Node_constant_NOTIFICATION_PARENTED"></a>
...
<a id="class_Node_constant_NOTIFICATION_UNPARENTED"></a>
...
<a id="class_Node_constant_NOTIFICATION_SCENE_INSTANTIATED"></a>
...
<a id="class_Node_constant_NOTIFICATION_DRAG_BEGIN"></a>
...
<a id="class_Node_constant_NOTIFICATION_DRAG_END"></a>
...
<a id="class_Node_constant_NOTIFICATION_PATH_RENAMED"></a>
...
<a id="class_Node_constant_NOTIFICATION_CHILD_ORDER_CHANGED"></a>
...
<a id="class_Node_constant_NOTIFICATION_INTERNAL_PROCESS"></a>
...
<a id="class_Node_constant_NOTIFICATION_INTERNAL_PHYSICS_PROCESS"></a>
...
<a id="class_Node_constant_NOTIFICATION_POST_ENTER_TREE"></a>
...
<a id="class_Node_constant_NOTIFICATION_DISABLED"></a>
...
<a id="class_Node_constant_NOTIFICATION_ENABLED"></a>
...
<a id="class_Node_constant_NOTIFICATION_RESET_PHYSICS_INTERPOLATION"></a>
...
<a id="class_Node_constant_NOTIFICATION_EDITOR_PRE_SAVE"></a>
...
<a id="class_Node_constant_NOTIFICATION_EDITOR_POST_SAVE"></a>
...
<a id="class_Node_constant_NOTIFICATION_WM_MOUSE_ENTER"></a>
...
<a id="class_Node_constant_NOTIFICATION_WM_MOUSE_EXIT"></a>
...
<a id="class_Node_constant_NOTIFICATION_WM_WINDOW_FOCUS_IN"></a>
...
<a id="class_Node_constant_NOTIFICATION_WM_WINDOW_FOCUS_OUT"></a>
...
<a id="class_Node_constant_NOTIFICATION_WM_CLOSE_REQUEST"></a>
...
<a id="class_Node_constant_NOTIFICATION_WM_GO_BACK_REQUEST"></a>
...
<a id="class_Node_constant_NOTIFICATION_WM_SIZE_CHANGED"></a>
...
<a id="class_Node_constant_NOTIFICATION_WM_DPI_CHANGE"></a>
...
<a id="class_Node_constant_NOTIFICATION_VP_MOUSE_ENTER"></a>
...
<a id="class_Node_constant_NOTIFICATION_VP_MOUSE_EXIT"></a>
...
<a id="class_Node_constant_NOTIFICATION_WM_POSITION_CHANGED"></a>
...
<a id="class_Node_constant_NOTIFICATION_OS_MEMORY_WARNING"></a>
...
<a id="class_Node_constant_NOTIFICATION_TRANSLATION_CHANGED"></a>
...
<a id="class_Node_constant_NOTIFICATION_WM_ABOUT"></a>
...
<a id="class_Node_constant_NOTIFICATION_CRASH"></a>
...
<a id="class_Node_constant_NOTIFICATION_OS_IME_UPDATE"></a>
...
<a id="class_Node_constant_NOTIFICATION_APPLICATION_RESUMED"></a>
...
<a id="class_Node_constant_NOTIFICATION_APPLICATION_PAUSED"></a>
...
<a id="class_Node_constant_NOTIFICATION_APPLICATION_FOCUS_IN"></a>
...
<a id="class_Node_constant_NOTIFICATION_APPLICATION_FOCUS_OUT"></a>
...
<a id="class_Node_constant_NOTIFICATION_TEXT_SERVER_CHANGED"></a>
...
<a id="class_Node_constant_NOTIFICATION_ACCESSIBILITY_UPDATE"></a>
...
<a id="class_Node_constant_NOTIFICATION_ACCESSIBILITY_INVALIDATE"></a>
...
<a id="class_Node_property_auto_translate_mode"></a>

<!-- classref-property -->

[AutoTranslateMode](class_node.md#enum_Node_AutoTranslateMode) **auto_translate_mode** = `0` [🔗](#class_Node_property_auto_translate_mode)
...
<a id="class_Node_property_editor_description"></a>
...
<a id="class_Node_property_multiplayer"></a>
...
<a id="class_Node_property_name"></a>
...
<a id="class_Node_property_owner"></a>
...
The owner of this node. The owner must be an ancestor of this node. When packing the owner node in a [PackedScene](class_packedscene.md), all the nodes it owns are also saved with it. See also [unique_name_in_owner](class_node.md#class_Node_property_unique_name_in_owner).
...
<a id="class_Node_property_physics_interpolation_mode"></a>

<!-- classref-property -->

[PhysicsInterpolationMode](class_node.md#enum_Node_PhysicsInterpolationMode) **physics_interpolation_mode** = `0` [🔗](#class_Node_property_physics_interpolation_mode)
...
\ **Note:** Some node types like [VehicleWheel3D](class_vehiclewheel3d.md) have physics interpolation disabled by default, as they rely on their own custom solution.
...
<a id="class_Node_property_process_mode"></a>

<!-- classref-property -->

[ProcessMode](class_node.md#enum_Node_ProcessMode) **process_mode** = `0` [🔗](#class_Node_property_process_mode)
...
<a id="class_Node_property_process_physics_priority"></a>

<!-- classref-property -->

[int](class_int.md) **process_physics_priority** = `0` [🔗](#class_Node_property_process_physics_priority)
...
<a id="class_Node_property_process_priority"></a>

<!-- classref-property -->

[int](class_int.md) **process_priority** = `0` [🔗](#class_Node_property_process_priority)
...
<a id="class_Node_property_process_thread_group"></a>

<!-- classref-property -->

[ProcessThreadGroup](class_node.md#enum_Node_ProcessThreadGroup) **process_thread_group** = `0` [🔗](#class_Node_property_process_thread_group)
...
<a id="class_Node_property_process_thread_group_order"></a>
...
<a id="class_Node_property_process_thread_messages"></a>

<!-- classref-property -->

**BitField**\[[ProcessThreadMessages](class_node.md#enum_Node_ProcessThreadMessages)\] **process_thread_messages** [🔗](#class_Node_property_process_thread_messages)
...
<a id="class_Node_property_scene_file_path"></a>
...
<a id="class_Node_property_unique_name_in_owner"></a>

<!-- classref-property -->

[bool](class_bool.md) **unique_name_in_owner** = `false` [🔗](#class_Node_property_unique_name_in_owner)
...
<a id="class_Node_private_method__enter_tree"></a>

<!-- classref-method -->

`void` **_enter_tree**\ (\ ) <span class="virtual">virtual</span> [🔗](#class_Node_private_method__enter_tree)
...
<a id="class_Node_private_method__exit_tree"></a>

<!-- classref-method -->

`void` **_exit_tree**\ (\ ) <span class="virtual">virtual</span> [🔗](#class_Node_private_method__exit_tree)
...
<a id="class_Node_private_method__get_accessibility_configuration_warnings"></a>

<!-- classref-method -->

[PackedStringArray](class_packedstringarray.md) **_get_accessibility_configuration_warnings**\ (\ ) <span class="virtual">virtual</span> <span class="const">const</span> [🔗](#class_Node_private_method__get_accessibility_configuration_warnings)
...
<a id="class_Node_private_method__get_configuration_warnings"></a>

<!-- classref-method -->

[PackedStringArray](class_packedstringarray.md) **_get_configuration_warnings**\ (\ ) <span class="virtual">virtual</span> <span class="const">const</span> [🔗](#class_Node_private_method__get_configuration_warnings)
...
<a id="class_Node_private_method__get_focused_accessibility_element"></a>

<!-- classref-method -->

[RID](class_rid.md) **_get_focused_accessibility_element**\ (\ ) <span class="virtual">virtual</span> <span class="const">const</span> [🔗](#class_Node_private_method__get_focused_accessibility_element)
...
<a id="class_Node_private_method__input"></a>

<!-- classref-method -->

`void` **_input**\ (\ event\: [InputEvent](class_inputevent.md)\ ) <span class="virtual">virtual</span> [🔗](#class_Node_private_method__input)
...
<a id="class_Node_private_method__physics_process"></a>

<!-- classref-method -->

`void` **_physics_process**\ (\ delta\: [float](class_float.md)\ ) <span class="virtual">virtual</span> [🔗](#class_Node_private_method__physics_process)
...
<a id="class_Node_private_method__process"></a>

<!-- classref-method -->

`void` **_process**\ (\ delta\: [float](class_float.md)\ ) <span class="virtual">virtual</span> [🔗](#class_Node_private_method__process)
...
\ **Note:** When ``--fixed-fps`` is enabled or the engine is running in Movie Maker mode (see [MovieWriter](class_moviewriter.md)), process `delta` will always be the same for every frame, regardless of how much time the frame took to render.
...
<a id="class_Node_private_method__ready"></a>

<!-- classref-method -->

`void` **_ready**\ (\ ) <span class="virtual">virtual</span> [🔗](#class_Node_private_method__ready)
...
<a id="class_Node_private_method__shortcut_input"></a>

<!-- classref-method -->

`void` **_shortcut_input**\ (\ event\: [InputEvent](class_inputevent.md)\ ) <span class="virtual">virtual</span> [🔗](#class_Node_private_method__shortcut_input)
...
<a id="class_Node_private_method__unhandled_input"></a>

<!-- classref-method -->

`void` **_unhandled_input**\ (\ event\: [InputEvent](class_inputevent.md)\ ) <span class="virtual">virtual</span> [🔗](#class_Node_private_method__unhandled_input)
...
<a id="class_Node_private_method__unhandled_key_input"></a>

<!-- classref-method -->

`void` **_unhandled_key_input**\ (\ event\: [InputEvent](class_inputevent.md)\ ) <span class="virtual">virtual</span> [🔗](#class_Node_private_method__unhandled_key_input)
...
<a id="class_Node_private_method__unhandled_picking_input"></a>

<!-- classref-method -->

`void` **_unhandled_picking_input**\ (\ event\: [InputEvent](class_inputevent.md)\ ) <span class="virtual">virtual</span> [🔗](#class_Node_private_method__unhandled_picking_input)

Called when an [InputEvent](class_inputevent.md) hasn't been consumed by physics picking. The input event propagates up through the node tree in the current [Viewport](class_viewport.md) until a node consumes it.

It is only called if unhandled picking input processing is enabled, which is done automatically if this method is overridden, and can be toggled with [set_process_unhandled_picking_input()](class_node.md#class_Node_method_set_process_unhandled_picking_input).
...
<a id="class_Node_method_add_child"></a>

<!-- classref-method -->

`void` **add_child**\ (\ node\: [Node](class_node.md), force_readable_name\: [bool](class_bool.md) = false, internal\: [InternalMode](class_node.md#enum_Node_InternalMode) = 0\ ) [🔗](#class_Node_method_add_child)
...
<a id="class_Node_method_add_sibling"></a>

<!-- classref-method -->

`void` **add_sibling**\ (\ sibling\: [Node](class_node.md), force_readable_name\: [bool](class_bool.md) = false\ ) [🔗](#class_Node_method_add_sibling)
...
<a id="class_Node_method_add_to_group"></a>

<!-- classref-method -->

`void` **add_to_group**\ (\ group\: [StringName](class_stringname.md), persistent\: [bool](class_bool.md) = false\ ) [🔗](#class_Node_method_add_to_group)
...
<a id="class_Node_method_atr"></a>

<!-- classref-method -->

[String](class_string.md) **atr**\ (\ message\: [String](class_string.md), context\: [StringName](class_stringname.md) = ""\ ) <span class="const">const</span> [🔗](#class_Node_method_atr)
...
<a id="class_Node_method_atr_n"></a>

<!-- classref-method -->

[String](class_string.md) **atr_n**\ (\ message\: [String](class_string.md), plural_message\: [StringName](class_stringname.md), n\: [int](class_int.md), context\: [StringName](class_stringname.md) = ""\ ) <span class="const">const</span> [🔗](#class_Node_method_atr_n)
...
<a id="class_Node_method_call_deferred_thread_group"></a>

<!-- classref-method -->

[Variant](class_variant.md) **call_deferred_thread_group**\ (\ method\: [StringName](class_stringname.md), ...\ ) <span class="vararg">vararg</span> [🔗](#class_Node_method_call_deferred_thread_group)
...
<a id="class_Node_method_call_thread_safe"></a>

<!-- classref-method -->

[Variant](class_variant.md) **call_thread_safe**\ (\ method\: [StringName](class_stringname.md), ...\ ) <span class="vararg">vararg</span> [🔗](#class_Node_method_call_thread_safe)

This function ensures that the calling of this function will succeed, no matter whether it's being done from a thread or not. If called from a thread that is not allowed to call the function, the call will become deferred. Otherwise, the call will go through directly.

<hr class="classref-item-separator">

<a id="class_Node_method_can_auto_translate"></a>

<!-- classref-method -->

[bool](class_bool.md) **can_auto_translate**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_can_auto_translate)
...
<a id="class_Node_method_can_process"></a>

<!-- classref-method -->

[bool](class_bool.md) **can_process**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_can_process)
...
<a id="class_Node_method_create_tween"></a>
...
<a id="class_Node_method_duplicate"></a>

<!-- classref-method -->

[Node](class_node.md) **duplicate**\ (\ flags\: [int](class_int.md) = 15\ ) <span class="const">const</span> [🔗](#class_Node_method_duplicate)

Duplicates the node, returning a new node with all of its properties, signals, groups, and children copied from the original. The behavior can be tweaked through the `flags` (see [DuplicateFlags](class_node.md#enum_Node_DuplicateFlags)). Internal nodes are not duplicated.
...
<a id="class_Node_method_find_child"></a>

<!-- classref-method -->

[Node](class_node.md) **find_child**\ (\ pattern\: [String](class_string.md), recursive\: [bool](class_bool.md) = true, owned\: [bool](class_bool.md) = true\ ) <span class="const">const</span> [🔗](#class_Node_method_find_child)
...
<a id="class_Node_method_find_children"></a>

<!-- classref-method -->

[Array](class_array.md)\[[Node](class_node.md)\] **find_children**\ (\ pattern\: [String](class_string.md), type\: [String](class_string.md) = "", recursive\: [bool](class_bool.md) = true, owned\: [bool](class_bool.md) = true\ ) <span class="const">const</span> [🔗](#class_Node_method_find_children)
...
<a id="class_Node_method_find_parent"></a>

<!-- classref-method -->

[Node](class_node.md) **find_parent**\ (\ pattern\: [String](class_string.md)\ ) <span class="const">const</span> [🔗](#class_Node_method_find_parent)
...
<a id="class_Node_method_get_accessibility_element"></a>

<!-- classref-method -->

[RID](class_rid.md) **get_accessibility_element**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_get_accessibility_element)
...
<a id="class_Node_method_get_child"></a>

<!-- classref-method -->

[Node](class_node.md) **get_child**\ (\ idx\: [int](class_int.md), include_internal\: [bool](class_bool.md) = false\ ) <span class="const">const</span> [🔗](#class_Node_method_get_child)
...
<a id="class_Node_method_get_child_count"></a>

<!-- classref-method -->

[int](class_int.md) **get_child_count**\ (\ include_internal\: [bool](class_bool.md) = false\ ) <span class="const">const</span> [🔗](#class_Node_method_get_child_count)
...
<a id="class_Node_method_get_children"></a>

<!-- classref-method -->

[Array](class_array.md)\[[Node](class_node.md)\] **get_children**\ (\ include_internal\: [bool](class_bool.md) = false\ ) <span class="const">const</span> [🔗](#class_Node_method_get_children)
...
<a id="class_Node_method_get_groups"></a>

<!-- classref-method -->

[Array](class_array.md)\[[StringName](class_stringname.md)\] **get_groups**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_get_groups)
...
<a id="class_Node_method_get_index"></a>

<!-- classref-method -->

[int](class_int.md) **get_index**\ (\ include_internal\: [bool](class_bool.md) = false\ ) <span class="const">const</span> [🔗](#class_Node_method_get_index)
...
<a id="class_Node_method_get_last_exclusive_window"></a>

<!-- classref-method -->

[Window](class_window.md) **get_last_exclusive_window**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_get_last_exclusive_window)
...
<a id="class_Node_method_get_multiplayer_authority"></a>

<!-- classref-method -->

[int](class_int.md) **get_multiplayer_authority**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_get_multiplayer_authority)
...
<a id="class_Node_method_get_node"></a>

<!-- classref-method -->

[Node](class_node.md) **get_node**\ (\ path\: [NodePath](class_nodepath.md)\ ) <span class="const">const</span> [🔗](#class_Node_method_get_node)
...
<a id="class_Node_method_get_node_and_resource"></a>

<!-- classref-method -->

[Array](class_array.md) **get_node_and_resource**\ (\ path\: [NodePath](class_nodepath.md)\ ) [🔗](#class_Node_method_get_node_and_resource)
...
\ **Example:** Assume that the child's [Sprite2D.texture](class_sprite2d.md#class_Sprite2D_property_texture) has been assigned an [AtlasTexture](class_atlastexture.md):
...
<a id="class_Node_method_get_node_or_null"></a>

<!-- classref-method -->

[Node](class_node.md) **get_node_or_null**\ (\ path\: [NodePath](class_nodepath.md)\ ) <span class="const">const</span> [🔗](#class_Node_method_get_node_or_null)
...
<a id="class_Node_method_get_node_rpc_config"></a>

<!-- classref-method -->

[Variant](class_variant.md) **get_node_rpc_config**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_get_node_rpc_config)
...
\ **Note:** This method only returns the RPC configuration assigned via [rpc_config()](class_node.md#class_Node_method_rpc_config). See [Script.get_rpc_config()](class_script.md#class_Script_method_get_rpc_config) to retrieve the RPCs defined by the [Script](class_script.md).

<hr class="classref-item-separator">

<a id="class_Node_method_get_orphan_node_ids"></a>

<!-- classref-method -->

[Array](class_array.md)\[[int](class_int.md)\] **get_orphan_node_ids**\ (\ ) <span class="static">static</span> [🔗](#class_Node_method_get_orphan_node_ids)

Returns object IDs of all orphan nodes (nodes outside the [SceneTree](class_scenetree.md)). Used for debugging.
...
<a id="class_Node_method_get_parent"></a>

<!-- classref-method -->

[Node](class_node.md) **get_parent**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_get_parent)

Returns this node's parent node, or ``null`` if the node doesn't have a parent.

<hr class="classref-item-separator">

<a id="class_Node_method_get_path"></a>

<!-- classref-method -->

[NodePath](class_nodepath.md) **get_path**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_get_path)
...
<a id="class_Node_method_get_path_to"></a>

<!-- classref-method -->

[NodePath](class_nodepath.md) **get_path_to**\ (\ node\: [Node](class_node.md), use_unique_path\: [bool](class_bool.md) = false\ ) <span class="const">const</span> [🔗](#class_Node_method_get_path_to)
...
<a id="class_Node_method_get_physics_process_delta_time"></a>

<!-- classref-method -->

[float](class_float.md) **get_physics_process_delta_time**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_get_physics_process_delta_time)
...
<a id="class_Node_method_get_scene_instance_load_placeholder"></a>

<!-- classref-method -->

[bool](class_bool.md) **get_scene_instance_load_placeholder**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_get_scene_instance_load_placeholder)
...
<a id="class_Node_method_get_tree"></a>

<!-- classref-method -->

[SceneTree](class_scenetree.md) **get_tree**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_get_tree)
...
<a id="class_Node_method_get_tree_string"></a>
...
<a id="class_Node_method_get_tree_string_pretty"></a>
...
<a id="class_Node_method_get_viewport"></a>

<!-- classref-method -->

[Viewport](class_viewport.md) **get_viewport**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_get_viewport)

Returns the node's closest [Viewport](class_viewport.md) ancestor, if the node is inside the tree. Otherwise, returns ``null``.

<hr class="classref-item-separator">

<a id="class_Node_method_get_window"></a>

<!-- classref-method -->

[Window](class_window.md) **get_window**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_get_window)
...
<a id="class_Node_method_has_node"></a>

<!-- classref-method -->

[bool](class_bool.md) **has_node**\ (\ path\: [NodePath](class_nodepath.md)\ ) <span class="const">const</span> [🔗](#class_Node_method_has_node)

Returns ``true`` if the `path` points to a valid node. See also [get_node()](class_node.md#class_Node_method_get_node).

<hr class="classref-item-separator">

<a id="class_Node_method_has_node_and_resource"></a>

<!-- classref-method -->

[bool](class_bool.md) **has_node_and_resource**\ (\ path\: [NodePath](class_nodepath.md)\ ) <span class="const">const</span> [🔗](#class_Node_method_has_node_and_resource)
...
<a id="class_Node_method_is_ancestor_of"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_ancestor_of**\ (\ node\: [Node](class_node.md)\ ) <span class="const">const</span> [🔗](#class_Node_method_is_ancestor_of)

Returns ``true`` if the given `node` is a direct or indirect child of this node.

<hr class="classref-item-separator">

<a id="class_Node_method_is_displayed_folded"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_displayed_folded**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_is_displayed_folded)
...
<a id="class_Node_method_is_editable_instance"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_editable_instance**\ (\ node\: [Node](class_node.md)\ ) <span class="const">const</span> [🔗](#class_Node_method_is_editable_instance)
...
<a id="class_Node_method_is_greater_than"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_greater_than**\ (\ node\: [Node](class_node.md)\ ) <span class="const">const</span> [🔗](#class_Node_method_is_greater_than)
...
<a id="class_Node_method_is_in_group"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_in_group**\ (\ group\: [StringName](class_stringname.md)\ ) <span class="const">const</span> [🔗](#class_Node_method_is_in_group)
...
<a id="class_Node_method_is_inside_tree"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_inside_tree**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_is_inside_tree)
...
<a id="class_Node_method_is_multiplayer_authority"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_multiplayer_authority**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_is_multiplayer_authority)

Returns ``true`` if the local system is the multiplayer authority of this node.

<hr class="classref-item-separator">

<a id="class_Node_method_is_node_ready"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_node_ready**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_is_node_ready)
...
<a id="class_Node_method_is_part_of_edited_scene"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_part_of_edited_scene**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_is_part_of_edited_scene)

Returns ``true`` if the node is part of the scene currently opened in the editor.

<hr class="classref-item-separator">

<a id="class_Node_method_is_physics_interpolated"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_physics_interpolated**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_is_physics_interpolated)
...
<a id="class_Node_method_is_physics_interpolated_and_enabled"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_physics_interpolated_and_enabled**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_is_physics_interpolated_and_enabled)
...
<a id="class_Node_method_is_physics_processing"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_physics_processing**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_is_physics_processing)
...
<a id="class_Node_method_is_physics_processing_internal"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_physics_processing_internal**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_is_physics_processing_internal)
...
<a id="class_Node_method_is_processing"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_processing**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_is_processing)

Returns ``true`` if processing is enabled (see [set_process()](class_node.md#class_Node_method_set_process)).

<hr class="classref-item-separator">

<a id="class_Node_method_is_processing_input"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_processing_input**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_is_processing_input)

Returns ``true`` if the node is processing input (see [set_process_input()](class_node.md#class_Node_method_set_process_input)).

<hr class="classref-item-separator">

<a id="class_Node_method_is_processing_internal"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_processing_internal**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_is_processing_internal)
...
<a id="class_Node_method_is_processing_shortcut_input"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_processing_shortcut_input**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_is_processing_shortcut_input)
...
<a id="class_Node_method_is_processing_unhandled_input"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_processing_unhandled_input**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_is_processing_unhandled_input)
...
<a id="class_Node_method_is_processing_unhandled_key_input"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_processing_unhandled_key_input**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_is_processing_unhandled_key_input)
...
<a id="class_Node_method_is_processing_unhandled_picking_input"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_processing_unhandled_picking_input**\ (\ ) <span class="const">const</span> [🔗](#class_Node_method_is_processing_unhandled_picking_input)

Returns ``true`` if the node is processing unhandled physics input (see [set_process_unhandled_picking_input()](class_node.md#class_Node_method_set_process_unhandled_picking_input)).

<hr class="classref-item-separator">

<a id="class_Node_method_move_child"></a>

<!-- classref-method -->

`void` **move_child**\ (\ child_node\: [Node](class_node.md), to_index\: [int](class_int.md)\ ) [🔗](#class_Node_method_move_child)
...
<a id="class_Node_method_notify_deferred_thread_group"></a>

<!-- classref-method -->

`void` **notify_deferred_thread_group**\ (\ what\: [int](class_int.md)\ ) [🔗](#class_Node_method_notify_deferred_thread_group)

Similar to [call_deferred_thread_group()](class_node.md#class_Node_method_call_deferred_thread_group), but for notifications.

<hr class="classref-item-separator">

<a id="class_Node_method_notify_thread_safe"></a>

<!-- classref-method -->

`void` **notify_thread_safe**\ (\ what\: [int](class_int.md)\ ) [🔗](#class_Node_method_notify_thread_safe)

Similar to [call_thread_safe()](class_node.md#class_Node_method_call_thread_safe), but for notifications.

<hr class="classref-item-separator">

<a id="class_Node_method_print_orphan_nodes"></a>

<!-- classref-method -->

`void` **print_orphan_nodes**\ (\ ) <span class="static">static</span> [🔗](#class_Node_method_print_orphan_nodes)
...
<a id="class_Node_method_print_tree"></a>
...
<a id="class_Node_method_print_tree_pretty"></a>
...
<a id="class_Node_method_propagate_call"></a>

<!-- classref-method -->

`void` **propagate_call**\ (\ method\: [StringName](class_stringname.md), args\: [Array](class_array.md) = [], parent_first\: [bool](class_bool.md) = false\ ) [🔗](#class_Node_method_propagate_call)
...
<a id="class_Node_method_propagate_notification"></a>

<!-- classref-method -->

`void` **propagate_notification**\ (\ what\: [int](class_int.md)\ ) [🔗](#class_Node_method_propagate_notification)
...
<a id="class_Node_method_queue_accessibility_update"></a>
...
<a id="class_Node_method_queue_free"></a>
...
<a id="class_Node_method_remove_child"></a>

<!-- classref-method -->

`void` **remove_child**\ (\ node\: [Node](class_node.md)\ ) [🔗](#class_Node_method_remove_child)
...
<a id="class_Node_method_remove_from_group"></a>

<!-- classref-method -->

`void` **remove_from_group**\ (\ group\: [StringName](class_stringname.md)\ ) [🔗](#class_Node_method_remove_from_group)
...
<a id="class_Node_method_reparent"></a>

<!-- classref-method -->

`void` **reparent**\ (\ new_parent\: [Node](class_node.md), keep_global_transform\: [bool](class_bool.md) = true\ ) [🔗](#class_Node_method_reparent)
...
<a id="class_Node_method_replace_by"></a>

<!-- classref-method -->

`void` **replace_by**\ (\ node\: [Node](class_node.md), keep_groups\: [bool](class_bool.md) = false\ ) [🔗](#class_Node_method_replace_by)
...
<a id="class_Node_method_request_ready"></a>
...
<a id="class_Node_method_reset_physics_interpolation"></a>
...
<a id="class_Node_method_rpc"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **rpc**\ (\ method\: [StringName](class_stringname.md), ...\ ) <span class="vararg">vararg</span> [🔗](#class_Node_method_rpc)
...
<a id="class_Node_method_rpc_config"></a>

<!-- classref-method -->

`void` **rpc_config**\ (\ method\: [StringName](class_stringname.md), config\: [Variant](class_variant.md)\ ) [🔗](#class_Node_method_rpc_config)
...
\ **Note:** In GDScript, this method corresponds to the [@GDScript.@rpc](class_@gdscript.md#class_@GDScript_annotation_@rpc) annotation, with various parameters passed (``@rpc(any)``, ``@rpc(authority)``...). See also the [high-level multiplayer](../tutorials/networking/high_level_multiplayer.md) tutorial.

<hr class="classref-item-separator">

<a id="class_Node_method_rpc_id"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **rpc_id**\ (\ peer_id\: [int](class_int.md), method\: [StringName](class_stringname.md), ...\ ) <span class="vararg">vararg</span> [🔗](#class_Node_method_rpc_id)
...
<a id="class_Node_method_set_deferred_thread_group"></a>

<!-- classref-method -->

`void` **set_deferred_thread_group**\ (\ property\: [StringName](class_stringname.md), value\: [Variant](class_variant.md)\ ) [🔗](#class_Node_method_set_deferred_thread_group)
...
<a id="class_Node_method_set_display_folded"></a>

<!-- classref-method -->

`void` **set_display_folded**\ (\ fold\: [bool](class_bool.md)\ ) [🔗](#class_Node_method_set_display_folded)
...
<a id="class_Node_method_set_editable_instance"></a>

<!-- classref-method -->

`void` **set_editable_instance**\ (\ node\: [Node](class_node.md), is_editable\: [bool](class_bool.md)\ ) [🔗](#class_Node_method_set_editable_instance)
...
<a id="class_Node_method_set_multiplayer_authority"></a>

<!-- classref-method -->

`void` **set_multiplayer_authority**\ (\ id\: [int](class_int.md), recursive\: [bool](class_bool.md) = true\ ) [🔗](#class_Node_method_set_multiplayer_authority)
...
<a id="class_Node_method_set_physics_process"></a>

<!-- classref-method -->

`void` **set_physics_process**\ (\ enable\: [bool](class_bool.md)\ ) [🔗](#class_Node_method_set_physics_process)
...
<a id="class_Node_method_set_physics_process_internal"></a>

<!-- classref-method -->

`void` **set_physics_process_internal**\ (\ enable\: [bool](class_bool.md)\ ) [🔗](#class_Node_method_set_physics_process_internal)
...
<a id="class_Node_method_set_process"></a>

<!-- classref-method -->

`void` **set_process**\ (\ enable\: [bool](class_bool.md)\ ) [🔗](#class_Node_method_set_process)
...
<a id="class_Node_method_set_process_input"></a>

<!-- classref-method -->

`void` **set_process_input**\ (\ enable\: [bool](class_bool.md)\ ) [🔗](#class_Node_method_set_process_input)
...
<a id="class_Node_method_set_process_internal"></a>

<!-- classref-method -->

`void` **set_process_internal**\ (\ enable\: [bool](class_bool.md)\ ) [🔗](#class_Node_method_set_process_internal)
...
<a id="class_Node_method_set_process_shortcut_input"></a>

<!-- classref-method -->

`void` **set_process_shortcut_input**\ (\ enable\: [bool](class_bool.md)\ ) [🔗](#class_Node_method_set_process_shortcut_input)
...
<a id="class_Node_method_set_process_unhandled_input"></a>

<!-- classref-method -->

`void` **set_process_unhandled_input**\ (\ enable\: [bool](class_bool.md)\ ) [🔗](#class_Node_method_set_process_unhandled_input)
...
<a id="class_Node_method_set_process_unhandled_key_input"></a>

<!-- classref-method -->

`void` **set_process_unhandled_key_input**\ (\ enable\: [bool](class_bool.md)\ ) [🔗](#class_Node_method_set_process_unhandled_key_input)
...
<a id="class_Node_method_set_process_unhandled_picking_input"></a>

<!-- classref-method -->

`void` **set_process_unhandled_picking_input**\ (\ enable\: [bool](class_bool.md)\ ) [🔗](#class_Node_method_set_process_unhandled_picking_input)

Enables unhandled picking input processing. Enabled automatically if [_unhandled_picking_input()](class_node.md#class_Node_private_method__unhandled_picking_input) is overridden. Any calls to this before [_ready()](class_node.md#class_Node_private_method__ready) will be ignored.

<hr class="classref-item-separator">

<a id="class_Node_method_set_scene_instance_load_placeholder"></a>

<!-- classref-method -->

`void` **set_scene_instance_load_placeholder**\ (\ load_placeholder\: [bool](class_bool.md)\ ) [🔗](#class_Node_method_set_scene_instance_load_placeholder)

If set to ``true``, the node becomes an [InstancePlaceholder](class_instanceplaceholder.md) when packed and instantiated from a [PackedScene](class_packedscene.md). See also [get_scene_instance_load_placeholder()](class_node.md#class_Node_method_get_scene_instance_load_placeholder).

<hr class="classref-item-separator">

<a id="class_Node_method_set_thread_safe"></a>

<!-- classref-method -->

`void` **set_thread_safe**\ (\ property\: [StringName](class_stringname.md), value\: [Variant](class_variant.md)\ ) [🔗](#class_Node_method_set_thread_safe)

Similar to [call_thread_safe()](class_node.md#class_Node_method_call_thread_safe), but for setting properties.

<hr class="classref-item-separator">

<a id="class_Node_method_set_translation_domain_inherited"></a>
...
<a id="class_Node_method_update_configuration_warnings"></a>
