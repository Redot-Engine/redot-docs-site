...
This node applies weights from an [XRFaceTracker](class_xrfacetracker.md) to a mesh with supporting face blend shapes.
...
<table>
  <thead>
    <tr>
      ...
      <th>[face_tracker](#class_XRFaceModifier3D_property_face_tracker)</th>
  ...
  <tbody>
    <tr>
      ...
      <td>[target](#class_XRFaceModifier3D_property_target)</td>
      <td>`NodePath("")`</td>
    </tr>
  </tbody>
</table>
...
<a id="class_XRFaceModifier3D_property_face_tracker"></a>

<!-- classref-property -->

[StringName](class_stringname.md) **face_tracker** = `&"/user/face_tracker"` [🔗](#class_XRFaceModifier3D_property_face_tracker)
...
<a id="class_XRFaceModifier3D_property_target"></a>

<!-- classref-property -->

[NodePath](class_nodepath.md) **target** = `NodePath("")` [🔗](#class_XRFaceModifier3D_property_target)
