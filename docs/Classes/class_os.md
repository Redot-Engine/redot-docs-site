...
\ **Note:** In Redot 4, **OS** functions related to window management, clipboard, and TTS were moved to the [DisplayServer](class_displayserver.md) singleton (and the [Window](class_window.md) class). Functions related to time were removed and are only available in the [Time](class_time.md) class.
...
<table>
  <thead>
    <tr>
      ...
      <th>[delta_smoothing](#class_OS_property_delta_smoothing)</th>
      <th>`true`</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>[low_processor_usage_mode](#class_OS_property_low_processor_usage_mode)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[low_processor_usage_mode_sleep_usec](#class_OS_property_low_processor_usage_mode_sleep_usec)</td>
      <td>`6900`</td>
    </tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr>
      <th>`void`</th>
      <th>[add_logger](#class_OS_method_add_logger)\ (\ logger\: [Logger](class_logger.md)\ )</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>`void`</td>
      <td>[alert](#class_OS_method_alert)\ (\ text\: [String](class_string.md), title\: [String](class_string.md) = "Alert!"\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[close_midi_inputs](#class_OS_method_close_midi_inputs)\ (\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[crash](#class_OS_method_crash)\ (\ message\: [String](class_string.md)\ )</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[create_instance](#class_OS_method_create_instance)\ (\ arguments\: [PackedStringArray](class_packedstringarray.md)\ )</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[create_process](#class_OS_method_create_process)\ (\ path\: [String](class_string.md), arguments\: [PackedStringArray](class_packedstringarray.md), open_console\: [bool](class_bool.md) = false\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[delay_msec](#class_OS_method_delay_msec)\ (\ msec\: [int](class_int.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[delay_usec](#class_OS_method_delay_usec)\ (\ usec\: [int](class_int.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[execute](#class_OS_method_execute)\ (\ path\: [String](class_string.md), arguments\: [PackedStringArray](class_packedstringarray.md), output\: [Array](class_array.md) = [], read_stderr\: [bool](class_bool.md) = false, open_console\: [bool](class_bool.md) = false\ )</td>
    </tr>
    <tr>
      <td>[Dictionary](class_dictionary.md)</td>
      <td>[execute_with_pipe](#class_OS_method_execute_with_pipe)\ (\ path\: [String](class_string.md), arguments\: [PackedStringArray](class_packedstringarray.md), blocking\: [bool](class_bool.md) = true\ )</td>
    </tr>
    <tr>
      <td>[Key](class_@globalscope.md#enum_@GlobalScope_Key)</td>
      <td>[find_keycode_from_string](#class_OS_method_find_keycode_from_string)\ (\ string\: [String](class_string.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_cache_dir](#class_OS_method_get_cache_dir)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[PackedStringArray](class_packedstringarray.md)</td>
      <td>[get_cmdline_args](#class_OS_method_get_cmdline_args)\ (\ )</td>
    </tr>
    <tr>
      <td>[PackedStringArray](class_packedstringarray.md)</td>
      <td>[get_cmdline_user_args](#class_OS_method_get_cmdline_user_args)\ (\ )</td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_config_dir](#class_OS_method_get_config_dir)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[PackedStringArray](class_packedstringarray.md)</td>
      <td>[get_connected_midi_inputs](#class_OS_method_get_connected_midi_inputs)\ (\ )</td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_data_dir](#class_OS_method_get_data_dir)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_distribution_name](#class_OS_method_get_distribution_name)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[PackedByteArray](class_packedbytearray.md)</td>
      <td>[get_entropy](#class_OS_method_get_entropy)\ (\ size\: [int](class_int.md)\ )</td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_environment](#class_OS_method_get_environment)\ (\ variable\: [String](class_string.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_executable_path](#class_OS_method_get_executable_path)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[PackedStringArray](class_packedstringarray.md)</td>
      <td>[get_granted_permissions](#class_OS_method_get_granted_permissions)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_keycode_string](#class_OS_method_get_keycode_string)\ (\ code\: [Key](class_@globalscope.md#enum_@GlobalScope_Key)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_locale](#class_OS_method_get_locale)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_locale_language](#class_OS_method_get_locale_language)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_main_thread_id](#class_OS_method_get_main_thread_id)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Dictionary](class_dictionary.md)</td>
      <td>[get_memory_info](#class_OS_method_get_memory_info)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_model_name](#class_OS_method_get_model_name)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_name](#class_OS_method_get_name)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_process_exit_code](#class_OS_method_get_process_exit_code)\ (\ pid\: [int](class_int.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_process_id](#class_OS_method_get_process_id)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_processor_count](#class_OS_method_get_processor_count)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_processor_name](#class_OS_method_get_processor_name)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[PackedStringArray](class_packedstringarray.md)</td>
      <td>[get_restart_on_exit_arguments](#class_OS_method_get_restart_on_exit_arguments)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_static_memory_peak_usage](#class_OS_method_get_static_memory_peak_usage)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_static_memory_usage](#class_OS_method_get_static_memory_usage)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[StdHandleType](class_os.md#enum_OS_StdHandleType)</td>
      <td>[get_stderr_type](#class_OS_method_get_stderr_type)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[StdHandleType](class_os.md#enum_OS_StdHandleType)</td>
      <td>[get_stdin_type](#class_OS_method_get_stdin_type)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[StdHandleType](class_os.md#enum_OS_StdHandleType)</td>
      <td>[get_stdout_type](#class_OS_method_get_stdout_type)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_system_ca_certificates](#class_OS_method_get_system_ca_certificates)\ (\ )</td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_system_dir](#class_OS_method_get_system_dir)\ (\ dir\: [SystemDir](class_os.md#enum_OS_SystemDir), shared_storage\: [bool](class_bool.md) = true\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_system_font_path](#class_OS_method_get_system_font_path)\ (\ font_name\: [String](class_string.md), weight\: [int](class_int.md) = 400, stretch\: [int](class_int.md) = 100, italic\: [bool](class_bool.md) = false\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[PackedStringArray](class_packedstringarray.md)</td>
      <td>[get_system_font_path_for_text](#class_OS_method_get_system_font_path_for_text)\ (\ font_name\: [String](class_string.md), text\: [String](class_string.md), locale\: [String](class_string.md) = "", script\: [String](class_string.md) = "", weight\: [int](class_int.md) = 400, stretch\: [int](class_int.md) = 100, italic\: [bool](class_bool.md) = false\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[PackedStringArray](class_packedstringarray.md)</td>
      <td>[get_system_fonts](#class_OS_method_get_system_fonts)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_temp_dir](#class_OS_method_get_temp_dir)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_thread_caller_id](#class_OS_method_get_thread_caller_id)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_unique_id](#class_OS_method_get_unique_id)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_user_data_dir](#class_OS_method_get_user_data_dir)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_version](#class_OS_method_get_version)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_version_alias](#class_OS_method_get_version_alias)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[PackedStringArray](class_packedstringarray.md)</td>
      <td>[get_video_adapter_driver_info](#class_OS_method_get_video_adapter_driver_info)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[has_environment](#class_OS_method_has_environment)\ (\ variable\: [String](class_string.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[has_feature](#class_OS_method_has_feature)\ (\ tag_name\: [String](class_string.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_debug_build](#class_OS_method_is_debug_build)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_keycode_unicode](#class_OS_method_is_keycode_unicode)\ (\ code\: [int](class_int.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_process_running](#class_OS_method_is_process_running)\ (\ pid\: [int](class_int.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_restart_on_exit_set](#class_OS_method_is_restart_on_exit_set)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_sandboxed](#class_OS_method_is_sandboxed)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_stdout_verbose](#class_OS_method_is_stdout_verbose)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_userfs_persistent](#class_OS_method_is_userfs_persistent)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[kill](#class_OS_method_kill)\ (\ pid\: [int](class_int.md)\ )</td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[move_to_trash](#class_OS_method_move_to_trash)\ (\ path\: [String](class_string.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[open_midi_inputs](#class_OS_method_open_midi_inputs)\ (\ )</td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[open_with_program](#class_OS_method_open_with_program)\ (\ program_path\: [String](class_string.md), paths\: [PackedStringArray](class_packedstringarray.md)\ )</td>
    </tr>
    <tr>
      <td>[PackedByteArray](class_packedbytearray.md)</td>
      <td>[read_buffer_from_stdin](#class_OS_method_read_buffer_from_stdin)\ (\ buffer_size\: [int](class_int.md) = 1024\ )</td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[read_string_from_stdin](#class_OS_method_read_string_from_stdin)\ (\ buffer_size\: [int](class_int.md) = 1024\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[remove_logger](#class_OS_method_remove_logger)\ (\ logger\: [Logger](class_logger.md)\ )</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[request_permission](#class_OS_method_request_permission)\ (\ name\: [String](class_string.md)\ )</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[request_permissions](#class_OS_method_request_permissions)\ (\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[revoke_granted_permissions](#class_OS_method_revoke_granted_permissions)\ (\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_environment](#class_OS_method_set_environment)\ (\ variable\: [String](class_string.md), value\: [String](class_string.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_restart_on_exit](#class_OS_method_set_restart_on_exit)\ (\ restart\: [bool](class_bool.md), arguments\: [PackedStringArray](class_packedstringarray.md) = PackedStringArray()\ )</td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[set_thread_name](#class_OS_method_set_thread_name)\ (\ name\: [String](class_string.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_use_file_access_save_and_swap](#class_OS_method_set_use_file_access_save_and_swap)\ (\ enabled\: [bool](class_bool.md)\ )</td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[shell_open](#class_OS_method_shell_open)\ (\ uri\: [String](class_string.md)\ )</td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[shell_show_in_file_manager](#class_OS_method_shell_show_in_file_manager)\ (\ file_or_dir_path\: [String](class_string.md), open_folder\: [bool](class_bool.md) = true\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[unset_environment](#class_OS_method_unset_environment)\ (\ variable\: [String](class_string.md)\ ) <span class="const">const</span></td>
    </tr>
  </tbody>
</table>
...
<a id="class_OS_constant_RENDERING_DRIVER_VULKAN"></a>

<!-- classref-enumeration-constant -->

[RenderingDriver](class_os.md#enum_OS_RenderingDriver) **RENDERING_DRIVER_VULKAN** = `0`

The Vulkan rendering driver. It requires Vulkan 1.0 support and automatically uses features from Vulkan 1.1 and 1.2 if available.<a id="class_OS_constant_RENDERING_DRIVER_OPENGL3"></a>

<!-- classref-enumeration-constant -->

[RenderingDriver](class_os.md#enum_OS_RenderingDriver) **RENDERING_DRIVER_OPENGL3** = `1`

The OpenGL 3 rendering driver. It uses OpenGL 3.3 Core Profile on desktop platforms, OpenGL ES 3.0 on mobile devices, and WebGL 2.0 on Web.<a id="class_OS_constant_RENDERING_DRIVER_D3D12"></a>

<!-- classref-enumeration-constant -->

[RenderingDriver](class_os.md#enum_OS_RenderingDriver) **RENDERING_DRIVER_D3D12** = `2`

The Direct3D 12 rendering driver.<a id="class_OS_constant_RENDERING_DRIVER_METAL"></a>
...
<a id="class_OS_constant_SYSTEM_DIR_DESKTOP"></a>

<!-- classref-enumeration-constant -->

[SystemDir](class_os.md#enum_OS_SystemDir) **SYSTEM_DIR_DESKTOP** = `0`

Refers to the Desktop directory path.<a id="class_OS_constant_SYSTEM_DIR_DCIM"></a>

<!-- classref-enumeration-constant -->

[SystemDir](class_os.md#enum_OS_SystemDir) **SYSTEM_DIR_DCIM** = `1`

Refers to the DCIM (Digital Camera Images) directory path.<a id="class_OS_constant_SYSTEM_DIR_DOCUMENTS"></a>

<!-- classref-enumeration-constant -->

[SystemDir](class_os.md#enum_OS_SystemDir) **SYSTEM_DIR_DOCUMENTS** = `2`

Refers to the Documents directory path.<a id="class_OS_constant_SYSTEM_DIR_DOWNLOADS"></a>

<!-- classref-enumeration-constant -->

[SystemDir](class_os.md#enum_OS_SystemDir) **SYSTEM_DIR_DOWNLOADS** = `3`

Refers to the Downloads directory path.<a id="class_OS_constant_SYSTEM_DIR_MOVIES"></a>

<!-- classref-enumeration-constant -->

[SystemDir](class_os.md#enum_OS_SystemDir) **SYSTEM_DIR_MOVIES** = `4`

Refers to the Movies (or Videos) directory path.<a id="class_OS_constant_SYSTEM_DIR_MUSIC"></a>

<!-- classref-enumeration-constant -->

[SystemDir](class_os.md#enum_OS_SystemDir) **SYSTEM_DIR_MUSIC** = `5`

Refers to the Music directory path.<a id="class_OS_constant_SYSTEM_DIR_PICTURES"></a>

<!-- classref-enumeration-constant -->

[SystemDir](class_os.md#enum_OS_SystemDir) **SYSTEM_DIR_PICTURES** = `6`

Refers to the Pictures directory path.<a id="class_OS_constant_SYSTEM_DIR_RINGTONES"></a>
...
<a id="class_OS_constant_STD_HANDLE_INVALID"></a>

<!-- classref-enumeration-constant -->

[StdHandleType](class_os.md#enum_OS_StdHandleType) **STD_HANDLE_INVALID** = `0`

Standard I/O device is invalid. No data can be received from or sent to these standard I/O devices.<a id="class_OS_constant_STD_HANDLE_CONSOLE"></a>

<!-- classref-enumeration-constant -->

[StdHandleType](class_os.md#enum_OS_StdHandleType) **STD_HANDLE_CONSOLE** = `1`

Standard I/O device is a console. This typically occurs when Redot is run from a terminal with no redirection. This is also used for all standard I/O devices when running Redot from the editor, at least on desktop platforms.<a id="class_OS_constant_STD_HANDLE_FILE"></a>

<!-- classref-enumeration-constant -->

[StdHandleType](class_os.md#enum_OS_StdHandleType) **STD_HANDLE_FILE** = `2`

Standard I/O device is a regular file. This typically occurs with redirection from a terminal, e.g. ``redot > stdout.txt``, ``redot < stdin.txt`` or ``redot > stdout_stderr.txt 2>&1``.<a id="class_OS_constant_STD_HANDLE_PIPE"></a>

<!-- classref-enumeration-constant -->

[StdHandleType](class_os.md#enum_OS_StdHandleType) **STD_HANDLE_PIPE** = `3`

Standard I/O device is a FIFO/pipe. This typically occurs with pipe usage from a terminal, e.g. ``echo "Hello" | redot``.<a id="class_OS_constant_STD_HANDLE_UNKNOWN"></a>
...
<a id="class_OS_property_delta_smoothing"></a>

<!-- classref-property -->

[bool](class_bool.md) **delta_smoothing** = `true` [🔗](#class_OS_property_delta_smoothing)
...
<a id="class_OS_property_low_processor_usage_mode"></a>

<!-- classref-property -->

[bool](class_bool.md) **low_processor_usage_mode** = `false` [🔗](#class_OS_property_low_processor_usage_mode)
...
<a id="class_OS_property_low_processor_usage_mode_sleep_usec"></a>

<!-- classref-property -->

[int](class_int.md) **low_processor_usage_mode_sleep_usec** = `6900` [🔗](#class_OS_property_low_processor_usage_mode_sleep_usec)
...
<a id="class_OS_method_add_logger"></a>

<!-- classref-method -->

`void` **add_logger**\ (\ logger\: [Logger](class_logger.md)\ ) [🔗](#class_OS_method_add_logger)

Add a custom logger to intercept the internal message stream.

<hr class="classref-item-separator">

<a id="class_OS_method_alert"></a>

<!-- classref-method -->

`void` **alert**\ (\ text\: [String](class_string.md), title\: [String](class_string.md) = "Alert!"\ ) [🔗](#class_OS_method_alert)
...
<a id="class_OS_method_close_midi_inputs"></a>

<!-- classref-method -->

`void` **close_midi_inputs**\ (\ ) [🔗](#class_OS_method_close_midi_inputs)

Shuts down the system MIDI driver. Redot will no longer receive [InputEventMIDI](class_inputeventmidi.md). See also [open_midi_inputs()](class_os.md#class_OS_method_open_midi_inputs) and [get_connected_midi_inputs()](class_os.md#class_OS_method_get_connected_midi_inputs).

\ **Note:** This method is implemented on Linux, macOS, Windows, and Web.

<hr class="classref-item-separator">

<a id="class_OS_method_crash"></a>

<!-- classref-method -->

`void` **crash**\ (\ message\: [String](class_string.md)\ ) [🔗](#class_OS_method_crash)
...
<a id="class_OS_method_create_instance"></a>

<!-- classref-method -->

[int](class_int.md) **create_instance**\ (\ arguments\: [PackedStringArray](class_packedstringarray.md)\ ) [🔗](#class_OS_method_create_instance)
...
<a id="class_OS_method_create_process"></a>

<!-- classref-method -->

[int](class_int.md) **create_process**\ (\ path\: [String](class_string.md), arguments\: [PackedStringArray](class_packedstringarray.md), open_console\: [bool](class_bool.md) = false\ ) [🔗](#class_OS_method_create_process)
...
<a id="class_OS_method_delay_msec"></a>

<!-- classref-method -->

`void` **delay_msec**\ (\ msec\: [int](class_int.md)\ ) <span class="const">const</span> [🔗](#class_OS_method_delay_msec)
...
<a id="class_OS_method_delay_usec"></a>

<!-- classref-method -->

`void` **delay_usec**\ (\ usec\: [int](class_int.md)\ ) <span class="const">const</span> [🔗](#class_OS_method_delay_usec)
...
<a id="class_OS_method_execute"></a>

<!-- classref-method -->

[int](class_int.md) **execute**\ (\ path\: [String](class_string.md), arguments\: [PackedStringArray](class_packedstringarray.md), output\: [Array](class_array.md) = [], read_stderr\: [bool](class_bool.md) = false, open_console\: [bool](class_bool.md) = false\ ) [🔗](#class_OS_method_execute)
...
<a id="class_OS_method_execute_with_pipe"></a>

<!-- classref-method -->

[Dictionary](class_dictionary.md) **execute_with_pipe**\ (\ path\: [String](class_string.md), arguments\: [PackedStringArray](class_packedstringarray.md), blocking\: [bool](class_bool.md) = true\ ) [🔗](#class_OS_method_execute_with_pipe)
...
<a id="class_OS_method_find_keycode_from_string"></a>

<!-- classref-method -->

[Key](class_@globalscope.md#enum_@GlobalScope_Key) **find_keycode_from_string**\ (\ string\: [String](class_string.md)\ ) <span class="const">const</span> [🔗](#class_OS_method_find_keycode_from_string)

Finds the keycode for the given string. The returned values are equivalent to the [Key](class_@globalscope.md#enum_@GlobalScope_Key) constants.
...
<a id="class_OS_method_get_cache_dir"></a>

<!-- classref-method -->

[String](class_string.md) **get_cache_dir**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_cache_dir)
...
<a id="class_OS_method_get_cmdline_args"></a>
...
\ **Example:** Parse command-line arguments into a [Dictionary](class_dictionary.md) using the ``--key=value`` form for arguments:
...
<a id="class_OS_method_get_cmdline_user_args"></a>
...
<a id="class_OS_method_get_config_dir"></a>

<!-- classref-method -->

[String](class_string.md) **get_config_dir**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_config_dir)

Returns the *global* user configuration directory according to the operating system's standards.

On the Linux/BSD platform, this path can be overridden by setting the ``XDG_CONFIG_HOME`` environment variable before starting the project. See [File paths in Redot projects](../tutorials/io/data_paths.md) in the documentation for more information. See also [get_cache_dir()](class_os.md#class_OS_method_get_cache_dir) and [get_data_dir()](class_os.md#class_OS_method_get_data_dir).

Not to be confused with [get_user_data_dir()](class_os.md#class_OS_method_get_user_data_dir), which returns the *project-specific* user data path.

<hr class="classref-item-separator">

<a id="class_OS_method_get_connected_midi_inputs"></a>
...
<a id="class_OS_method_get_data_dir"></a>

<!-- classref-method -->

[String](class_string.md) **get_data_dir**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_data_dir)

Returns the *global* user data directory according to the operating system's standards.

On the Linux/BSD platform, this path can be overridden by setting the ``XDG_DATA_HOME`` environment variable before starting the project. See [File paths in Redot projects](../tutorials/io/data_paths.md) in the documentation for more information. See also [get_cache_dir()](class_os.md#class_OS_method_get_cache_dir) and [get_config_dir()](class_os.md#class_OS_method_get_config_dir).

Not to be confused with [get_user_data_dir()](class_os.md#class_OS_method_get_user_data_dir), which returns the *project-specific* user data path.

<hr class="classref-item-separator">

<a id="class_OS_method_get_distribution_name"></a>

<!-- classref-method -->

[String](class_string.md) **get_distribution_name**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_distribution_name)
...
<a id="class_OS_method_get_entropy"></a>

<!-- classref-method -->

[PackedByteArray](class_packedbytearray.md) **get_entropy**\ (\ size\: [int](class_int.md)\ ) [🔗](#class_OS_method_get_entropy)
...
<a id="class_OS_method_get_environment"></a>

<!-- classref-method -->

[String](class_string.md) **get_environment**\ (\ variable\: [String](class_string.md)\ ) <span class="const">const</span> [🔗](#class_OS_method_get_environment)
...
<a id="class_OS_method_get_executable_path"></a>

<!-- classref-method -->

[String](class_string.md) **get_executable_path**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_executable_path)

Returns the file path to the current engine executable.

\ **Note:** On macOS, if you want to launch another instance of Redot, always use [create_instance()](class_os.md#class_OS_method_create_instance) instead of relying on the executable path.

<hr class="classref-item-separator">

<a id="class_OS_method_get_granted_permissions"></a>

<!-- classref-method -->

[PackedStringArray](class_packedstringarray.md) **get_granted_permissions**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_granted_permissions)
...
<a id="class_OS_method_get_keycode_string"></a>

<!-- classref-method -->

[String](class_string.md) **get_keycode_string**\ (\ code\: [Key](class_@globalscope.md#enum_@GlobalScope_Key)\ ) <span class="const">const</span> [🔗](#class_OS_method_get_keycode_string)
...
<a id="class_OS_method_get_locale"></a>

<!-- classref-method -->

[String](class_string.md) **get_locale**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_locale)
...
<a id="class_OS_method_get_locale_language"></a>

<!-- classref-method -->

[String](class_string.md) **get_locale_language**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_locale_language)
...
<a id="class_OS_method_get_main_thread_id"></a>

<!-- classref-method -->

[int](class_int.md) **get_main_thread_id**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_main_thread_id)
...
<a id="class_OS_method_get_memory_info"></a>

<!-- classref-method -->

[Dictionary](class_dictionary.md) **get_memory_info**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_memory_info)
...
<a id="class_OS_method_get_model_name"></a>

<!-- classref-method -->

[String](class_string.md) **get_model_name**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_model_name)
...
<a id="class_OS_method_get_name"></a>

<!-- classref-method -->

[String](class_string.md) **get_name**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_name)
...
<a id="class_OS_method_get_process_exit_code"></a>

<!-- classref-method -->

[int](class_int.md) **get_process_exit_code**\ (\ pid\: [int](class_int.md)\ ) <span class="const">const</span> [🔗](#class_OS_method_get_process_exit_code)
...
<a id="class_OS_method_get_process_id"></a>

<!-- classref-method -->

[int](class_int.md) **get_process_id**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_process_id)
...
<a id="class_OS_method_get_processor_count"></a>

<!-- classref-method -->

[int](class_int.md) **get_processor_count**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_processor_count)
...
<a id="class_OS_method_get_processor_name"></a>

<!-- classref-method -->

[String](class_string.md) **get_processor_name**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_processor_name)
...
<a id="class_OS_method_get_restart_on_exit_arguments"></a>

<!-- classref-method -->

[PackedStringArray](class_packedstringarray.md) **get_restart_on_exit_arguments**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_restart_on_exit_arguments)
...
<a id="class_OS_method_get_static_memory_peak_usage"></a>

<!-- classref-method -->

[int](class_int.md) **get_static_memory_peak_usage**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_static_memory_peak_usage)

Returns the maximum amount of static memory used. Only works in debug builds.

<hr class="classref-item-separator">

<a id="class_OS_method_get_static_memory_usage"></a>

<!-- classref-method -->

[int](class_int.md) **get_static_memory_usage**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_static_memory_usage)

Returns the amount of static memory being used by the program in bytes. Only works in debug builds.

<hr class="classref-item-separator">

<a id="class_OS_method_get_stderr_type"></a>

<!-- classref-method -->

[StdHandleType](class_os.md#enum_OS_StdHandleType) **get_stderr_type**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_stderr_type)
...
<a id="class_OS_method_get_stdin_type"></a>

<!-- classref-method -->

[StdHandleType](class_os.md#enum_OS_StdHandleType) **get_stdin_type**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_stdin_type)
...
<a id="class_OS_method_get_stdout_type"></a>

<!-- classref-method -->

[StdHandleType](class_os.md#enum_OS_StdHandleType) **get_stdout_type**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_stdout_type)
...
<a id="class_OS_method_get_system_ca_certificates"></a>
...
<a id="class_OS_method_get_system_dir"></a>

<!-- classref-method -->

[String](class_string.md) **get_system_dir**\ (\ dir\: [SystemDir](class_os.md#enum_OS_SystemDir), shared_storage\: [bool](class_bool.md) = true\ ) <span class="const">const</span> [🔗](#class_OS_method_get_system_dir)
...
<a id="class_OS_method_get_system_font_path"></a>

<!-- classref-method -->

[String](class_string.md) **get_system_font_path**\ (\ font_name\: [String](class_string.md), weight\: [int](class_int.md) = 400, stretch\: [int](class_int.md) = 100, italic\: [bool](class_bool.md) = false\ ) <span class="const">const</span> [🔗](#class_OS_method_get_system_font_path)
...
<a id="class_OS_method_get_system_font_path_for_text"></a>

<!-- classref-method -->

[PackedStringArray](class_packedstringarray.md) **get_system_font_path_for_text**\ (\ font_name\: [String](class_string.md), text\: [String](class_string.md), locale\: [String](class_string.md) = "", script\: [String](class_string.md) = "", weight\: [int](class_int.md) = 400, stretch\: [int](class_int.md) = 100, italic\: [bool](class_bool.md) = false\ ) <span class="const">const</span> [🔗](#class_OS_method_get_system_font_path_for_text)
...
<a id="class_OS_method_get_system_fonts"></a>

<!-- classref-method -->

[PackedStringArray](class_packedstringarray.md) **get_system_fonts**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_system_fonts)
...
<a id="class_OS_method_get_temp_dir"></a>

<!-- classref-method -->

[String](class_string.md) **get_temp_dir**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_temp_dir)

Returns the *global* temporary data directory according to the operating system's standards.

<hr class="classref-item-separator">

<a id="class_OS_method_get_thread_caller_id"></a>

<!-- classref-method -->

[int](class_int.md) **get_thread_caller_id**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_thread_caller_id)
...
<a id="class_OS_method_get_unique_id"></a>

<!-- classref-method -->

[String](class_string.md) **get_unique_id**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_unique_id)
...
<a id="class_OS_method_get_user_data_dir"></a>

<!-- classref-method -->

[String](class_string.md) **get_user_data_dir**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_user_data_dir)

Returns the absolute directory path where user data is written (the ``user://`` directory in Redot). The path depends on the project name and [ProjectSettings.application/config/use_custom_user_dir](class_projectsettings.md#class_ProjectSettings_property_application/config/use_custom_user_dir).
...
<a id="class_OS_method_get_version"></a>

<!-- classref-method -->

[String](class_string.md) **get_version**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_version)
...
<a id="class_OS_method_get_version_alias"></a>

<!-- classref-method -->

[String](class_string.md) **get_version_alias**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_version_alias)
...
<a id="class_OS_method_get_video_adapter_driver_info"></a>

<!-- classref-method -->

[PackedStringArray](class_packedstringarray.md) **get_video_adapter_driver_info**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_get_video_adapter_driver_info)
...
\ **Note:** This method will run slowly the first time it is called in a session; it can take several seconds depending on the operating system and hardware. It is blocking if called on the main thread, so it's recommended to call it on a separate thread using [Thread](class_thread.md). This allows the engine to keep running while the information is being retrieved. However, [get_video_adapter_driver_info()](class_os.md#class_OS_method_get_video_adapter_driver_info) is *not* thread-safe, so it should not be called from multiple threads at the same time.
...
<a id="class_OS_method_has_environment"></a>

<!-- classref-method -->

[bool](class_bool.md) **has_environment**\ (\ variable\: [String](class_string.md)\ ) <span class="const">const</span> [🔗](#class_OS_method_has_environment)
...
<a id="class_OS_method_has_feature"></a>

<!-- classref-method -->

[bool](class_bool.md) **has_feature**\ (\ tag_name\: [String](class_string.md)\ ) <span class="const">const</span> [🔗](#class_OS_method_has_feature)
...
<a id="class_OS_method_is_debug_build"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_debug_build**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_is_debug_build)
...
<a id="class_OS_method_is_keycode_unicode"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_keycode_unicode**\ (\ code\: [int](class_int.md)\ ) <span class="const">const</span> [🔗](#class_OS_method_is_keycode_unicode)

Returns ``true`` if the input keycode corresponds to a Unicode character. For a list of codes, see the [Key](class_@globalscope.md#enum_@GlobalScope_Key) constants.
...
<a id="class_OS_method_is_process_running"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_process_running**\ (\ pid\: [int](class_int.md)\ ) <span class="const">const</span> [🔗](#class_OS_method_is_process_running)
...
<a id="class_OS_method_is_restart_on_exit_set"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_restart_on_exit_set**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_is_restart_on_exit_set)
...
<a id="class_OS_method_is_sandboxed"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_sandboxed**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_is_sandboxed)
...
<a id="class_OS_method_is_stdout_verbose"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_stdout_verbose**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_is_stdout_verbose)
...
<a id="class_OS_method_is_userfs_persistent"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_userfs_persistent**\ (\ ) <span class="const">const</span> [🔗](#class_OS_method_is_userfs_persistent)
...
<a id="class_OS_method_kill"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **kill**\ (\ pid\: [int](class_int.md)\ ) [🔗](#class_OS_method_kill)
...
<a id="class_OS_method_move_to_trash"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **move_to_trash**\ (\ path\: [String](class_string.md)\ ) <span class="const">const</span> [🔗](#class_OS_method_move_to_trash)
...
<a id="class_OS_method_open_midi_inputs"></a>

<!-- classref-method -->

`void` **open_midi_inputs**\ (\ ) [🔗](#class_OS_method_open_midi_inputs)

Initializes the singleton for the system MIDI driver, allowing Redot to receive [InputEventMIDI](class_inputeventmidi.md). See also [get_connected_midi_inputs()](class_os.md#class_OS_method_get_connected_midi_inputs) and [close_midi_inputs()](class_os.md#class_OS_method_close_midi_inputs).
...
<a id="class_OS_method_open_with_program"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **open_with_program**\ (\ program_path\: [String](class_string.md), paths\: [PackedStringArray](class_packedstringarray.md)\ ) [🔗](#class_OS_method_open_with_program)
...
<a id="class_OS_method_read_buffer_from_stdin"></a>

<!-- classref-method -->

[PackedByteArray](class_packedbytearray.md) **read_buffer_from_stdin**\ (\ buffer_size\: [int](class_int.md) = 1024\ ) [🔗](#class_OS_method_read_buffer_from_stdin)
...
<a id="class_OS_method_read_string_from_stdin"></a>

<!-- classref-method -->

[String](class_string.md) **read_string_from_stdin**\ (\ buffer_size\: [int](class_int.md) = 1024\ ) [🔗](#class_OS_method_read_string_from_stdin)
...
<a id="class_OS_method_remove_logger"></a>

<!-- classref-method -->

`void` **remove_logger**\ (\ logger\: [Logger](class_logger.md)\ ) [🔗](#class_OS_method_remove_logger)

Remove a custom logger added by [add_logger()](class_os.md#class_OS_method_add_logger).

<hr class="classref-item-separator">

<a id="class_OS_method_request_permission"></a>

<!-- classref-method -->

[bool](class_bool.md) **request_permission**\ (\ name\: [String](class_string.md)\ ) [🔗](#class_OS_method_request_permission)
...
<a id="class_OS_method_request_permissions"></a>
...
<a id="class_OS_method_revoke_granted_permissions"></a>
...
<a id="class_OS_method_set_environment"></a>

<!-- classref-method -->

`void` **set_environment**\ (\ variable\: [String](class_string.md), value\: [String](class_string.md)\ ) <span class="const">const</span> [🔗](#class_OS_method_set_environment)
...
<a id="class_OS_method_set_restart_on_exit"></a>

<!-- classref-method -->

`void` **set_restart_on_exit**\ (\ restart\: [bool](class_bool.md), arguments\: [PackedStringArray](class_packedstringarray.md) = PackedStringArray()\ ) [🔗](#class_OS_method_set_restart_on_exit)
...
<a id="class_OS_method_set_thread_name"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **set_thread_name**\ (\ name\: [String](class_string.md)\ ) [🔗](#class_OS_method_set_thread_name)
...
<a id="class_OS_method_set_use_file_access_save_and_swap"></a>

<!-- classref-method -->

`void` **set_use_file_access_save_and_swap**\ (\ enabled\: [bool](class_bool.md)\ ) [🔗](#class_OS_method_set_use_file_access_save_and_swap)
...
<a id="class_OS_method_shell_open"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **shell_open**\ (\ uri\: [String](class_string.md)\ ) [🔗](#class_OS_method_shell_open)
...
<a id="class_OS_method_shell_show_in_file_manager"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **shell_show_in_file_manager**\ (\ file_or_dir_path\: [String](class_string.md), open_folder\: [bool](class_bool.md) = true\ ) [🔗](#class_OS_method_shell_show_in_file_manager)
...
<a id="class_OS_method_unset_environment"></a>

<!-- classref-method -->

`void` **unset_environment**\ (\ variable\: [String](class_string.md)\ ) <span class="const">const</span> [🔗](#class_OS_method_unset_environment)
