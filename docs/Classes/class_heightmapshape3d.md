...
A 3D heightmap shape, intended for use in physics. Usually used to provide a shape for a [CollisionShape3D](class_collisionshape3d.md). This type is most commonly used for terrain with vertices placed in a fixed width grid. Due to the nature of the heightmap, it cannot be used to model overhangs or caves, which would require multiple vertices at the same vertical location. Holes can be punched through the collision by assigning [@GDScript.NAN](class_@gdscript.md#class_@GDScript_constant_NAN) to the height of the desired vertices (this is supported in both GodotPhysics3D and Jolt Physics). You could then insert meshes with their own separate collision to provide overhangs, caves, and so on.
...
A heightmap collision shape can also be built by using an [Image](class_image.md) reference:
...
<table>
  <thead>
    <tr>
      ...
      <th>[map_data](#class_HeightMapShape3D_property_map_data)</th>
  ...
  <tbody>
    <tr>
      ...
      <td>[map_depth](#class_HeightMapShape3D_property_map_depth)</td>
      <td>`2`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[map_width](#class_HeightMapShape3D_property_map_width)</td>
      <td>`2`</td>
    </tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr>
      ...
      <th>[get_max_height](#class_HeightMapShape3D_method_get_max_height)\ (\ ) <span class="const">const</span></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[get_min_height](#class_HeightMapShape3D_method_get_min_height)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[update_map_data_from_image](#class_HeightMapShape3D_method_update_map_data_from_image)\ (\ image\: [Image](class_image.md), height_min\: [float](class_float.md), height_max\: [float](class_float.md)\ )</td>
    </tr>
  </tbody>
</table>
...
<a id="class_HeightMapShape3D_property_map_data"></a>

<!-- classref-property -->

[PackedFloat32Array](class_packedfloat32array.md) **map_data** = `PackedFloat32Array(0, 0, 0, 0)` [🔗](#class_HeightMapShape3D_property_map_data)
...
<a id="class_HeightMapShape3D_property_map_depth"></a>

<!-- classref-property -->

[int](class_int.md) **map_depth** = `2` [🔗](#class_HeightMapShape3D_property_map_depth)
...
<a id="class_HeightMapShape3D_property_map_width"></a>

<!-- classref-property -->

[int](class_int.md) **map_width** = `2` [🔗](#class_HeightMapShape3D_property_map_width)
...
<a id="class_HeightMapShape3D_method_get_max_height"></a>

<!-- classref-method -->

[float](class_float.md) **get_max_height**\ (\ ) <span class="const">const</span> [🔗](#class_HeightMapShape3D_method_get_max_height)
...
<a id="class_HeightMapShape3D_method_get_min_height"></a>

<!-- classref-method -->

[float](class_float.md) **get_min_height**\ (\ ) <span class="const">const</span> [🔗](#class_HeightMapShape3D_method_get_min_height)
...
<a id="class_HeightMapShape3D_method_update_map_data_from_image"></a>

<!-- classref-method -->

`void` **update_map_data_from_image**\ (\ image\: [Image](class_image.md), height_min\: [float](class_float.md), height_max\: [float](class_float.md)\ ) [🔗](#class_HeightMapShape3D_method_update_map_data_from_image)
