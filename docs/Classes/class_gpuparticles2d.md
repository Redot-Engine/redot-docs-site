...
<table>
  <thead>
    <tr>
      ...
      <th>[amount](#class_GPUParticles2D_property_amount)</th>
      <th>`8`</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>[amount_ratio](#class_GPUParticles2D_property_amount_ratio)</td>
      <td>`1.0`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[collision_base_size](#class_GPUParticles2D_property_collision_base_size)</td>
      <td>`1.0`</td>
    </tr>
    <tr>
      <td>[DrawOrder](class_gpuparticles2d.md#enum_GPUParticles2D_DrawOrder)</td>
      <td>[draw_order](#class_GPUParticles2D_property_draw_order)</td>
      <td>`1`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[emitting](#class_GPUParticles2D_property_emitting)</td>
      <td>`true`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[explosiveness](#class_GPUParticles2D_property_explosiveness)</td>
      <td>`0.0`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[fixed_fps](#class_GPUParticles2D_property_fixed_fps)</td>
      <td>`30`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[fract_delta](#class_GPUParticles2D_property_fract_delta)</td>
      <td>`true`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[interp_to_end](#class_GPUParticles2D_property_interp_to_end)</td>
      <td>`0.0`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[interpolate](#class_GPUParticles2D_property_interpolate)</td>
      <td>`true`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[lifetime](#class_GPUParticles2D_property_lifetime)</td>
      <td>`1.0`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[local_coords](#class_GPUParticles2D_property_local_coords)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[one_shot](#class_GPUParticles2D_property_one_shot)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[preprocess](#class_GPUParticles2D_property_preprocess)</td>
      <td>`0.0`</td>
    </tr>
    <tr>
      <td>[Material](class_material.md)</td>
      <td>[process_material](#class_GPUParticles2D_property_process_material)</td>
      <td></td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[randomness](#class_GPUParticles2D_property_randomness)</td>
      <td>`0.0`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[seed](#class_GPUParticles2D_property_seed)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[speed_scale](#class_GPUParticles2D_property_speed_scale)</td>
      <td>`1.0`</td>
    </tr>
    <tr>
      <td>[NodePath](class_nodepath.md)</td>
      <td>[sub_emitter](#class_GPUParticles2D_property_sub_emitter)</td>
      <td>`NodePath("")`</td>
    </tr>
    <tr>
      <td>[Texture2D](class_texture2d.md)</td>
      <td>[texture](#class_GPUParticles2D_property_texture)</td>
      <td></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[trail_enabled](#class_GPUParticles2D_property_trail_enabled)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[trail_lifetime](#class_GPUParticles2D_property_trail_lifetime)</td>
      <td>`0.3`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[trail_section_subdivisions](#class_GPUParticles2D_property_trail_section_subdivisions)</td>
      <td>`4`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[trail_sections](#class_GPUParticles2D_property_trail_sections)</td>
      <td>`8`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[use_fixed_seed](#class_GPUParticles2D_property_use_fixed_seed)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[Rect2](class_rect2.md)</td>
      <td>[visibility_rect](#class_GPUParticles2D_property_visibility_rect)</td>
...
<table>
  <thead>
    <tr>
      ...
      <th>[capture_rect](#class_GPUParticles2D_method_capture_rect)\ (\ ) <span class="const">const</span></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>`void`</td>
      <td>[convert_from_particles](#class_GPUParticles2D_method_convert_from_particles)\ (\ particles\: [Node](class_node.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[emit_particle](#class_GPUParticles2D_method_emit_particle)\ (\ xform\: [Transform2D](class_transform2d.md), velocity\: [Vector2](class_vector2.md), color\: [Color](class_color.md), custom\: [Color](class_color.md), flags\: [int](class_int.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[request_particles_process](#class_GPUParticles2D_method_request_particles_process)\ (\ process_time\: [float](class_float.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[restart](#class_GPUParticles2D_method_restart)\ (\ keep_seed\: [bool](class_bool.md) = false\ )</td>
    </tr>
  </tbody>
</table>
...
<a id="class_GPUParticles2D_signal_finished"></a>
...
<a id="class_GPUParticles2D_constant_DRAW_ORDER_INDEX"></a>

<!-- classref-enumeration-constant -->

[DrawOrder](class_gpuparticles2d.md#enum_GPUParticles2D_DrawOrder) **DRAW_ORDER_INDEX** = `0`

Particles are drawn in the order emitted.<a id="class_GPUParticles2D_constant_DRAW_ORDER_LIFETIME"></a>

<!-- classref-enumeration-constant -->

[DrawOrder](class_gpuparticles2d.md#enum_GPUParticles2D_DrawOrder) **DRAW_ORDER_LIFETIME** = `1`

Particles are drawn in order of remaining lifetime. In other words, the particle with the highest lifetime is drawn at the front.<a id="class_GPUParticles2D_constant_DRAW_ORDER_REVERSE_LIFETIME"></a>
...
<a id="class_GPUParticles2D_constant_EMIT_FLAG_POSITION"></a>

<!-- classref-enumeration-constant -->

[EmitFlags](class_gpuparticles2d.md#enum_GPUParticles2D_EmitFlags) **EMIT_FLAG_POSITION** = `1`

Particle starts at the specified position.<a id="class_GPUParticles2D_constant_EMIT_FLAG_ROTATION_SCALE"></a>

<!-- classref-enumeration-constant -->

[EmitFlags](class_gpuparticles2d.md#enum_GPUParticles2D_EmitFlags) **EMIT_FLAG_ROTATION_SCALE** = `2`

Particle starts with specified rotation and scale.<a id="class_GPUParticles2D_constant_EMIT_FLAG_VELOCITY"></a>

<!-- classref-enumeration-constant -->

[EmitFlags](class_gpuparticles2d.md#enum_GPUParticles2D_EmitFlags) **EMIT_FLAG_VELOCITY** = `4`

Particle starts with the specified velocity vector, which defines the emission direction and speed.<a id="class_GPUParticles2D_constant_EMIT_FLAG_COLOR"></a>

<!-- classref-enumeration-constant -->

[EmitFlags](class_gpuparticles2d.md#enum_GPUParticles2D_EmitFlags) **EMIT_FLAG_COLOR** = `8`

Particle starts with specified color.<a id="class_GPUParticles2D_constant_EMIT_FLAG_CUSTOM"></a>
...
<a id="class_GPUParticles2D_property_amount"></a>

<!-- classref-property -->

[int](class_int.md) **amount** = `8` [🔗](#class_GPUParticles2D_property_amount)
...
<a id="class_GPUParticles2D_property_amount_ratio"></a>

<!-- classref-property -->

[float](class_float.md) **amount_ratio** = `1.0` [🔗](#class_GPUParticles2D_property_amount_ratio)
...
<a id="class_GPUParticles2D_property_collision_base_size"></a>

<!-- classref-property -->

[float](class_float.md) **collision_base_size** = `1.0` [🔗](#class_GPUParticles2D_property_collision_base_size)
...
<a id="class_GPUParticles2D_property_draw_order"></a>

<!-- classref-property -->

[DrawOrder](class_gpuparticles2d.md#enum_GPUParticles2D_DrawOrder) **draw_order** = `1` [🔗](#class_GPUParticles2D_property_draw_order)
...
<a id="class_GPUParticles2D_property_emitting"></a>

<!-- classref-property -->

[bool](class_bool.md) **emitting** = `true` [🔗](#class_GPUParticles2D_property_emitting)
...
<a id="class_GPUParticles2D_property_explosiveness"></a>

<!-- classref-property -->

[float](class_float.md) **explosiveness** = `0.0` [🔗](#class_GPUParticles2D_property_explosiveness)
...
<a id="class_GPUParticles2D_property_fixed_fps"></a>

<!-- classref-property -->

[int](class_int.md) **fixed_fps** = `30` [🔗](#class_GPUParticles2D_property_fixed_fps)
...
<a id="class_GPUParticles2D_property_fract_delta"></a>

<!-- classref-property -->

[bool](class_bool.md) **fract_delta** = `true` [🔗](#class_GPUParticles2D_property_fract_delta)
...
<a id="class_GPUParticles2D_property_interp_to_end"></a>

<!-- classref-property -->

[float](class_float.md) **interp_to_end** = `0.0` [🔗](#class_GPUParticles2D_property_interp_to_end)
...
<a id="class_GPUParticles2D_property_interpolate"></a>

<!-- classref-property -->

[bool](class_bool.md) **interpolate** = `true` [🔗](#class_GPUParticles2D_property_interpolate)
...
<a id="class_GPUParticles2D_property_lifetime"></a>

<!-- classref-property -->

[float](class_float.md) **lifetime** = `1.0` [🔗](#class_GPUParticles2D_property_lifetime)
...
<a id="class_GPUParticles2D_property_local_coords"></a>

<!-- classref-property -->

[bool](class_bool.md) **local_coords** = `false` [🔗](#class_GPUParticles2D_property_local_coords)
...
<a id="class_GPUParticles2D_property_one_shot"></a>

<!-- classref-property -->

[bool](class_bool.md) **one_shot** = `false` [🔗](#class_GPUParticles2D_property_one_shot)
...
<a id="class_GPUParticles2D_property_preprocess"></a>

<!-- classref-property -->

[float](class_float.md) **preprocess** = `0.0` [🔗](#class_GPUParticles2D_property_preprocess)
...
<a id="class_GPUParticles2D_property_process_material"></a>
...
<a id="class_GPUParticles2D_property_randomness"></a>

<!-- classref-property -->

[float](class_float.md) **randomness** = `0.0` [🔗](#class_GPUParticles2D_property_randomness)
...
<a id="class_GPUParticles2D_property_seed"></a>

<!-- classref-property -->

[int](class_int.md) **seed** = `0` [🔗](#class_GPUParticles2D_property_seed)
...
<a id="class_GPUParticles2D_property_speed_scale"></a>

<!-- classref-property -->

[float](class_float.md) **speed_scale** = `1.0` [🔗](#class_GPUParticles2D_property_speed_scale)
...
<a id="class_GPUParticles2D_property_sub_emitter"></a>

<!-- classref-property -->

[NodePath](class_nodepath.md) **sub_emitter** = `NodePath("")` [🔗](#class_GPUParticles2D_property_sub_emitter)
...
<a id="class_GPUParticles2D_property_texture"></a>
...
<a id="class_GPUParticles2D_property_trail_enabled"></a>

<!-- classref-property -->

[bool](class_bool.md) **trail_enabled** = `false` [🔗](#class_GPUParticles2D_property_trail_enabled)
...
<a id="class_GPUParticles2D_property_trail_lifetime"></a>

<!-- classref-property -->

[float](class_float.md) **trail_lifetime** = `0.3` [🔗](#class_GPUParticles2D_property_trail_lifetime)
...
<a id="class_GPUParticles2D_property_trail_section_subdivisions"></a>

<!-- classref-property -->

[int](class_int.md) **trail_section_subdivisions** = `4` [🔗](#class_GPUParticles2D_property_trail_section_subdivisions)
...
<a id="class_GPUParticles2D_property_trail_sections"></a>

<!-- classref-property -->

[int](class_int.md) **trail_sections** = `8` [🔗](#class_GPUParticles2D_property_trail_sections)
...
<a id="class_GPUParticles2D_property_use_fixed_seed"></a>

<!-- classref-property -->

[bool](class_bool.md) **use_fixed_seed** = `false` [🔗](#class_GPUParticles2D_property_use_fixed_seed)
...
<a id="class_GPUParticles2D_property_visibility_rect"></a>

<!-- classref-property -->

[Rect2](class_rect2.md) **visibility_rect** = `Rect2(-100, -100, 200, 200)` [🔗](#class_GPUParticles2D_property_visibility_rect)
...
<a id="class_GPUParticles2D_method_capture_rect"></a>

<!-- classref-method -->

[Rect2](class_rect2.md) **capture_rect**\ (\ ) <span class="const">const</span> [🔗](#class_GPUParticles2D_method_capture_rect)
...
<a id="class_GPUParticles2D_method_convert_from_particles"></a>

<!-- classref-method -->

`void` **convert_from_particles**\ (\ particles\: [Node](class_node.md)\ ) [🔗](#class_GPUParticles2D_method_convert_from_particles)

Sets this node's properties to match a given [CPUParticles2D](class_cpuparticles2d.md) node.

<hr class="classref-item-separator">

<a id="class_GPUParticles2D_method_emit_particle"></a>

<!-- classref-method -->

`void` **emit_particle**\ (\ xform\: [Transform2D](class_transform2d.md), velocity\: [Vector2](class_vector2.md), color\: [Color](class_color.md), custom\: [Color](class_color.md), flags\: [int](class_int.md)\ ) [🔗](#class_GPUParticles2D_method_emit_particle)
...
<a id="class_GPUParticles2D_method_request_particles_process"></a>

<!-- classref-method -->

`void` **request_particles_process**\ (\ process_time\: [float](class_float.md)\ ) [🔗](#class_GPUParticles2D_method_request_particles_process)
...
<a id="class_GPUParticles2D_method_restart"></a>

<!-- classref-method -->

`void` **restart**\ (\ keep_seed\: [bool](class_bool.md) = false\ ) [🔗](#class_GPUParticles2D_method_restart)
