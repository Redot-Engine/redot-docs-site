...
<table>
  <thead>
    <tr>
      ...
      <th>[create_placeholder](#class_CubemapArray_method_create_placeholder)\ (\ ) <span class="const">const</span></th>
    </tr>
  </thead>
  <tbody>
  </tbody>
...
<a id="class_CubemapArray_method_create_placeholder"></a>

<!-- classref-method -->

[Resource](class_resource.md) **create_placeholder**\ (\ ) <span class="const">const</span> [🔗](#class_CubemapArray_method_create_placeholder)
