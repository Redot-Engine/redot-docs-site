...
<a id="class_VisualShaderNodeColorOp"></a>
...
<table>
  <thead>
    <tr>
      <th>[Operator](class_visualshadernodecolorop.md#enum_VisualShaderNodeColorOp_Operator)</th>
      <th>[operator](#class_VisualShaderNodeColorOp_property_operator)</th>
      <th>`0`</th>
    </tr>
  </thead>
  <tbody>
...
<a id="class_VisualShaderNodeColorOp_constant_OP_SCREEN"></a>
...
```<a id="class_VisualShaderNodeColorOp_constant_OP_DIFFERENCE"></a>
...
```
    result = abs(a - b);
```<a id="class_VisualShaderNodeColorOp_constant_OP_DARKEN"></a>
...
```
    result = min(a, b);
```<a id="class_VisualShaderNodeColorOp_constant_OP_LIGHTEN"></a>
...
```
    result = max(a, b);
```<a id="class_VisualShaderNodeColorOp_constant_OP_OVERLAY"></a>
...
```<a id="class_VisualShaderNodeColorOp_constant_OP_DODGE"></a>
...
```
    result = a / (vec3(1.0) - b);
```<a id="class_VisualShaderNodeColorOp_constant_OP_BURN"></a>
...
```<a id="class_VisualShaderNodeColorOp_constant_OP_SOFT_LIGHT"></a>
...
```<a id="class_VisualShaderNodeColorOp_constant_OP_HARD_LIGHT"></a>
...
```<a id="class_VisualShaderNodeColorOp_constant_OP_MAX"></a>

<!-- classref-enumeration-constant -->

[Operator](class_visualshadernodecolorop.md#enum_VisualShaderNodeColorOp_Operator) **OP_MAX** = `9`

Represents the size of the [Operator](class_visualshadernodecolorop.md#enum_VisualShaderNodeColorOp_Operator) enum.<hr class="classref-section-separator">

<!-- classref-descriptions-group -->

## Property Descriptions

<a id="class_VisualShaderNodeColorOp_property_operator"></a>

<!-- classref-property -->

[Operator](class_visualshadernodecolorop.md#enum_VisualShaderNodeColorOp_Operator) **operator** = `0` [🔗](#class_VisualShaderNodeColorOp_property_operator)
