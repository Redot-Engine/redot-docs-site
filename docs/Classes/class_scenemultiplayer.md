...
This class is the default implementation of [MultiplayerAPI](class_multiplayerapi.md), used to provide multiplayer functionalities in Redot Engine.
...
<table>
  <thead>
    <tr>
      ...
      <th>[allow_object_decoding](#class_SceneMultiplayer_property_allow_object_decoding)</th>
      <th>`false`</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>[auth_callback](#class_SceneMultiplayer_property_auth_callback)</td>
      <td>`Callable()`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[auth_timeout](#class_SceneMultiplayer_property_auth_timeout)</td>
      <td>`3.0`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[max_delta_packet_size](#class_SceneMultiplayer_property_max_delta_packet_size)</td>
      <td>`65535`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[max_sync_packet_size](#class_SceneMultiplayer_property_max_sync_packet_size)</td>
      <td>`1350`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[refuse_new_connections](#class_SceneMultiplayer_property_refuse_new_connections)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[NodePath](class_nodepath.md)</td>
      <td>[root_path](#class_SceneMultiplayer_property_root_path)</td>
      <td>`NodePath("")`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[server_relay](#class_SceneMultiplayer_property_server_relay)</td>
      <td>`true`</td>
    </tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr>
      <th>`void`</th>
      <th>[clear](#class_SceneMultiplayer_method_clear)\ (\ )</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[complete_auth](#class_SceneMultiplayer_method_complete_auth)\ (\ id\: [int](class_int.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[disconnect_peer](#class_SceneMultiplayer_method_disconnect_peer)\ (\ id\: [int](class_int.md)\ )</td>
    </tr>
    <tr>
      <td>[PackedInt32Array](class_packedint32array.md)</td>
      <td>[get_authenticating_peers](#class_SceneMultiplayer_method_get_authenticating_peers)\ (\ )</td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[send_auth](#class_SceneMultiplayer_method_send_auth)\ (\ id\: [int](class_int.md), data\: [PackedByteArray](class_packedbytearray.md)\ )</td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[send_bytes](#class_SceneMultiplayer_method_send_bytes)\ (\ bytes\: [PackedByteArray](class_packedbytearray.md), id\: [int](class_int.md) = 0, mode\: [TransferMode](class_multiplayerpeer.md#enum_MultiplayerPeer_TransferMode) = 2, channel\: [int](class_int.md) = 0\ )</td>
    </tr>
  </tbody>
</table>
...
<a id="class_SceneMultiplayer_signal_peer_authenticating"></a>

<!-- classref-signal -->

**peer_authenticating**\ (\ id\: [int](class_int.md)\ ) [🔗](#class_SceneMultiplayer_signal_peer_authenticating)
...
<a id="class_SceneMultiplayer_signal_peer_authentication_failed"></a>

<!-- classref-signal -->

**peer_authentication_failed**\ (\ id\: [int](class_int.md)\ ) [🔗](#class_SceneMultiplayer_signal_peer_authentication_failed)
...
<a id="class_SceneMultiplayer_signal_peer_packet"></a>

<!-- classref-signal -->

**peer_packet**\ (\ id\: [int](class_int.md), packet\: [PackedByteArray](class_packedbytearray.md)\ ) [🔗](#class_SceneMultiplayer_signal_peer_packet)
...
<a id="class_SceneMultiplayer_property_allow_object_decoding"></a>

<!-- classref-property -->

[bool](class_bool.md) **allow_object_decoding** = `false` [🔗](#class_SceneMultiplayer_property_allow_object_decoding)
...
<a id="class_SceneMultiplayer_property_auth_callback"></a>

<!-- classref-property -->

[Callable](class_callable.md) **auth_callback** = `Callable()` [🔗](#class_SceneMultiplayer_property_auth_callback)
...
<a id="class_SceneMultiplayer_property_auth_timeout"></a>

<!-- classref-property -->

[float](class_float.md) **auth_timeout** = `3.0` [🔗](#class_SceneMultiplayer_property_auth_timeout)
...
<a id="class_SceneMultiplayer_property_max_delta_packet_size"></a>

<!-- classref-property -->

[int](class_int.md) **max_delta_packet_size** = `65535` [🔗](#class_SceneMultiplayer_property_max_delta_packet_size)
...
<a id="class_SceneMultiplayer_property_max_sync_packet_size"></a>

<!-- classref-property -->

[int](class_int.md) **max_sync_packet_size** = `1350` [🔗](#class_SceneMultiplayer_property_max_sync_packet_size)
...
<a id="class_SceneMultiplayer_property_refuse_new_connections"></a>

<!-- classref-property -->

[bool](class_bool.md) **refuse_new_connections** = `false` [🔗](#class_SceneMultiplayer_property_refuse_new_connections)
...
<a id="class_SceneMultiplayer_property_root_path"></a>

<!-- classref-property -->

[NodePath](class_nodepath.md) **root_path** = `NodePath("")` [🔗](#class_SceneMultiplayer_property_root_path)
...
<a id="class_SceneMultiplayer_property_server_relay"></a>

<!-- classref-property -->

[bool](class_bool.md) **server_relay** = `true` [🔗](#class_SceneMultiplayer_property_server_relay)
...
<a id="class_SceneMultiplayer_method_clear"></a>
...
<a id="class_SceneMultiplayer_method_complete_auth"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **complete_auth**\ (\ id\: [int](class_int.md)\ ) [🔗](#class_SceneMultiplayer_method_complete_auth)
...
<a id="class_SceneMultiplayer_method_disconnect_peer"></a>

<!-- classref-method -->

`void` **disconnect_peer**\ (\ id\: [int](class_int.md)\ ) [🔗](#class_SceneMultiplayer_method_disconnect_peer)
...
<a id="class_SceneMultiplayer_method_get_authenticating_peers"></a>
...
<a id="class_SceneMultiplayer_method_send_auth"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **send_auth**\ (\ id\: [int](class_int.md), data\: [PackedByteArray](class_packedbytearray.md)\ ) [🔗](#class_SceneMultiplayer_method_send_auth)
...
<a id="class_SceneMultiplayer_method_send_bytes"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **send_bytes**\ (\ bytes\: [PackedByteArray](class_packedbytearray.md), id\: [int](class_int.md) = 0, mode\: [TransferMode](class_multiplayerpeer.md#enum_MultiplayerPeer_TransferMode) = 2, channel\: [int](class_int.md) = 0\ ) [🔗](#class_SceneMultiplayer_method_send_bytes)
