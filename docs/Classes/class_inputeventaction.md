...
<table>
  <thead>
    <tr>
      ...
      <th>[action](#class_InputEventAction_property_action)</th>
      <th>`&""`</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>[event_index](#class_InputEventAction_property_event_index)</td>
      <td>`-1`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[pressed](#class_InputEventAction_property_pressed)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[strength](#class_InputEventAction_property_strength)</td>
      <td>`1.0`</td>
    </tr>
  </tbody>
</table>
...
<a id="class_InputEventAction_property_action"></a>
...
The action's name. This is usually the name of an existing action in the [InputMap](class_inputmap.md) which you want this custom event to match.

<hr class="classref-item-separator">

<a id="class_InputEventAction_property_event_index"></a>

<!-- classref-property -->

[int](class_int.md) **event_index** = `-1` [🔗](#class_InputEventAction_property_event_index)
...
<a id="class_InputEventAction_property_pressed"></a>

<!-- classref-property -->

[bool](class_bool.md) **pressed** = `false` [🔗](#class_InputEventAction_property_pressed)
...
<a id="class_InputEventAction_property_strength"></a>

<!-- classref-property -->

[float](class_float.md) **strength** = `1.0` [🔗](#class_InputEventAction_property_strength)
