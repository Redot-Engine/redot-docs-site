...
<table>
  <thead>
    <tr>
      ...
      <th>[max_pending_connections](#class_UDPServer_property_max_pending_connections)</th>
      <th>`16`</th>
    </tr>
  </thead>
  <tbody>
...
<table>
  <thead>
    <tr>
      <th>[int](class_int.md)</th>
      <th>[get_local_port](#class_UDPServer_method_get_local_port)\ (\ ) <span class="const">const</span></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_connection_available](#class_UDPServer_method_is_connection_available)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_listening](#class_UDPServer_method_is_listening)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[listen](#class_UDPServer_method_listen)\ (\ port\: [int](class_int.md), bind_address\: [String](class_string.md) = "*"\ )</td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[poll](#class_UDPServer_method_poll)\ (\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[stop](#class_UDPServer_method_stop)\ (\ )</td>
    </tr>
    <tr>
      <td>[PacketPeerUDP](class_packetpeerudp.md)</td>
      <td>[take_connection](#class_UDPServer_method_take_connection)\ (\ )</td>
    </tr>
  </tbody>
</table>
...
<a id="class_UDPServer_property_max_pending_connections"></a>

<!-- classref-property -->

[int](class_int.md) **max_pending_connections** = `16` [🔗](#class_UDPServer_property_max_pending_connections)
...
<a id="class_UDPServer_method_get_local_port"></a>

<!-- classref-method -->

[int](class_int.md) **get_local_port**\ (\ ) <span class="const">const</span> [🔗](#class_UDPServer_method_get_local_port)

Returns the local port this server is listening to.

<hr class="classref-item-separator">

<a id="class_UDPServer_method_is_connection_available"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_connection_available**\ (\ ) <span class="const">const</span> [🔗](#class_UDPServer_method_is_connection_available)

Returns ``true`` if a packet with a new address/port combination was received on the socket.

<hr class="classref-item-separator">

<a id="class_UDPServer_method_is_listening"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_listening**\ (\ ) <span class="const">const</span> [🔗](#class_UDPServer_method_is_listening)

Returns ``true`` if the socket is open and listening on a port.

<hr class="classref-item-separator">

<a id="class_UDPServer_method_listen"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **listen**\ (\ port\: [int](class_int.md), bind_address\: [String](class_string.md) = "*"\ ) [🔗](#class_UDPServer_method_listen)
...
<a id="class_UDPServer_method_take_connection"></a>
