...
<a id="class_AudioEffectHardLimiter"></a>
...
<table>
  <thead>
    <tr>
      ...
      <th>[ceiling_db](#class_AudioEffectHardLimiter_property_ceiling_db)</th>
      <th>`-0.3`</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>[pre_gain_db](#class_AudioEffectHardLimiter_property_pre_gain_db)</td>
      <td>`0.0`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[release](#class_AudioEffectHardLimiter_property_release)</td>
      <td>`0.1`</td>
    </tr>
  </tbody>
</table>
...
<a id="class_AudioEffectHardLimiter_property_ceiling_db"></a>

<!-- classref-property -->

[float](class_float.md) **ceiling_db** = `-0.3` [🔗](#class_AudioEffectHardLimiter_property_ceiling_db)
...
<a id="class_AudioEffectHardLimiter_property_pre_gain_db"></a>

<!-- classref-property -->

[float](class_float.md) **pre_gain_db** = `0.0` [🔗](#class_AudioEffectHardLimiter_property_pre_gain_db)
...
<a id="class_AudioEffectHardLimiter_property_release"></a>

<!-- classref-property -->

[float](class_float.md) **release** = `0.1` [🔗](#class_AudioEffectHardLimiter_property_release)
