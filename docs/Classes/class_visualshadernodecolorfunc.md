...
<a id="class_VisualShaderNodeColorFunc"></a>
...
<table>
  <thead>
    <tr>
      <th>[Function](class_visualshadernodecolorfunc.md#enum_VisualShaderNodeColorFunc_Function)</th>
      <th>[function](#class_VisualShaderNodeColorFunc_property_function)</th>
      <th>`0`</th>
    </tr>
  </thead>
  <tbody>
...
<a id="class_VisualShaderNodeColorFunc_constant_FUNC_GRAYSCALE"></a>
...
```<a id="class_VisualShaderNodeColorFunc_constant_FUNC_HSV2RGB"></a>

<!-- classref-enumeration-constant -->

[Function](class_visualshadernodecolorfunc.md#enum_VisualShaderNodeColorFunc_Function) **FUNC_HSV2RGB** = `1`

Converts HSV vector to RGB equivalent.<a id="class_VisualShaderNodeColorFunc_constant_FUNC_RGB2HSV"></a>

<!-- classref-enumeration-constant -->

[Function](class_visualshadernodecolorfunc.md#enum_VisualShaderNodeColorFunc_Function) **FUNC_RGB2HSV** = `2`

Converts RGB vector to HSV equivalent.<a id="class_VisualShaderNodeColorFunc_constant_FUNC_SEPIA"></a>
...
```
    ...
    return vec3(r, g, b);
```<a id="class_VisualShaderNodeColorFunc_constant_FUNC_LINEAR_TO_SRGB"></a>
...
```<a id="class_VisualShaderNodeColorFunc_constant_FUNC_SRGB_TO_LINEAR"></a>
...
```<a id="class_VisualShaderNodeColorFunc_constant_FUNC_MAX"></a>

<!-- classref-enumeration-constant -->

[Function](class_visualshadernodecolorfunc.md#enum_VisualShaderNodeColorFunc_Function) **FUNC_MAX** = `6`

Represents the size of the [Function](class_visualshadernodecolorfunc.md#enum_VisualShaderNodeColorFunc_Function) enum.<hr class="classref-section-separator">

<!-- classref-descriptions-group -->

## Property Descriptions

<a id="class_VisualShaderNodeColorFunc_property_function"></a>

<!-- classref-property -->

[Function](class_visualshadernodecolorfunc.md#enum_VisualShaderNodeColorFunc_Function) **function** = `0` [🔗](#class_VisualShaderNodeColorFunc_property_function)
