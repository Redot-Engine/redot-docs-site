...
<table>
  <thead>
    <tr>
      ...
      <th>[max_fps](#class_Engine_property_max_fps)</th>
      <th>`0`</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>[max_physics_steps_per_frame](#class_Engine_property_max_physics_steps_per_frame)</td>
      <td>`8`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[physics_jitter_fix](#class_Engine_property_physics_jitter_fix)</td>
      <td>`0.5`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[physics_ticks_per_second](#class_Engine_property_physics_ticks_per_second)</td>
      <td>`60`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[print_error_messages](#class_Engine_property_print_error_messages)</td>
      <td>`true`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[print_to_stdout](#class_Engine_property_print_to_stdout)</td>
      <td>`true`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[time_scale](#class_Engine_property_time_scale)</td>
      <td>`1.0`</td>
    </tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr>
      <th>[Array](class_array.md)\[[ScriptBacktrace](class_scriptbacktrace.md)\]</th>
      <th>[capture_script_backtraces](#class_Engine_method_capture_script_backtraces)\ (\ include_variables\: [bool](class_bool.md) = false\ ) <span class="const">const</span></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_architecture_name](#class_Engine_method_get_architecture_name)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Dictionary](class_dictionary.md)</td>
      <td>[get_author_info](#class_Engine_method_get_author_info)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Array](class_array.md)\[[Dictionary](class_dictionary.md)\]</td>
      <td>[get_copyright_info](#class_Engine_method_get_copyright_info)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Dictionary](class_dictionary.md)</td>
      <td>[get_donor_info](#class_Engine_method_get_donor_info)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_frames_drawn](#class_Engine_method_get_frames_drawn)\ (\ )</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[get_frames_per_second](#class_Engine_method_get_frames_per_second)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Dictionary](class_dictionary.md)</td>
      <td>[get_godot_author_info](#class_Engine_method_get_godot_author_info)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Dictionary](class_dictionary.md)</td>
      <td>[get_godot_compatible_version_info](#class_Engine_method_get_godot_compatible_version_info)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Dictionary](class_dictionary.md)</td>
      <td>[get_license_info](#class_Engine_method_get_license_info)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_license_text](#class_Engine_method_get_license_text)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[MainLoop](class_mainloop.md)</td>
      <td>[get_main_loop](#class_Engine_method_get_main_loop)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_physics_frames](#class_Engine_method_get_physics_frames)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[get_physics_interpolation_fraction](#class_Engine_method_get_physics_interpolation_fraction)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_process_frames](#class_Engine_method_get_process_frames)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[ScriptLanguage](class_scriptlanguage.md)</td>
      <td>[get_script_language](#class_Engine_method_get_script_language)\ (\ index\: [int](class_int.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_script_language_count](#class_Engine_method_get_script_language_count)\ (\ )</td>
    </tr>
    <tr>
      <td>[Object](class_object.md)</td>
      <td>[get_singleton](#class_Engine_method_get_singleton)\ (\ name\: [StringName](class_stringname.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[PackedStringArray](class_packedstringarray.md)</td>
      <td>[get_singleton_list](#class_Engine_method_get_singleton_list)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Dictionary](class_dictionary.md)</td>
      <td>[get_version_info](#class_Engine_method_get_version_info)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[String](class_string.md)</td>
      <td>[get_write_movie_path](#class_Engine_method_get_write_movie_path)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[has_singleton](#class_Engine_method_has_singleton)\ (\ name\: [StringName](class_stringname.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_editor_hint](#class_Engine_method_is_editor_hint)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_embedded_in_editor](#class_Engine_method_is_embedded_in_editor)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_in_physics_frame](#class_Engine_method_is_in_physics_frame)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[register_script_language](#class_Engine_method_register_script_language)\ (\ language\: [ScriptLanguage](class_scriptlanguage.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[register_singleton](#class_Engine_method_register_singleton)\ (\ name\: [StringName](class_stringname.md), instance\: [Object](class_object.md)\ )</td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[unregister_script_language](#class_Engine_method_unregister_script_language)\ (\ language\: [ScriptLanguage](class_scriptlanguage.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[unregister_singleton](#class_Engine_method_unregister_singleton)\ (\ name\: [StringName](class_stringname.md)\ )</td>
    </tr>
  </tbody>
</table>
...
<a id="class_Engine_property_max_fps"></a>

<!-- classref-property -->

[int](class_int.md) **max_fps** = `0` [🔗](#class_Engine_property_max_fps)
...
<a id="class_Engine_property_max_physics_steps_per_frame"></a>

<!-- classref-property -->

[int](class_int.md) **max_physics_steps_per_frame** = `8` [🔗](#class_Engine_property_max_physics_steps_per_frame)
...
<a id="class_Engine_property_physics_jitter_fix"></a>

<!-- classref-property -->

[float](class_float.md) **physics_jitter_fix** = `0.5` [🔗](#class_Engine_property_physics_jitter_fix)
...
<a id="class_Engine_property_physics_ticks_per_second"></a>

<!-- classref-property -->

[int](class_int.md) **physics_ticks_per_second** = `60` [🔗](#class_Engine_property_physics_ticks_per_second)
...
<a id="class_Engine_property_print_error_messages"></a>

<!-- classref-property -->

[bool](class_bool.md) **print_error_messages** = `true` [🔗](#class_Engine_property_print_error_messages)
...
<a id="class_Engine_property_print_to_stdout"></a>

<!-- classref-property -->

[bool](class_bool.md) **print_to_stdout** = `true` [🔗](#class_Engine_property_print_to_stdout)
...
<a id="class_Engine_property_time_scale"></a>

<!-- classref-property -->

[float](class_float.md) **time_scale** = `1.0` [🔗](#class_Engine_property_time_scale)
...
<a id="class_Engine_method_capture_script_backtraces"></a>

<!-- classref-method -->

[Array](class_array.md)\[[ScriptBacktrace](class_scriptbacktrace.md)\] **capture_script_backtraces**\ (\ include_variables\: [bool](class_bool.md) = false\ ) <span class="const">const</span> [🔗](#class_Engine_method_capture_script_backtraces)

Captures and returns backtraces from all registered script languages.

By default, the returned [ScriptBacktrace](class_scriptbacktrace.md) will only contain stack frames in editor builds and debug builds. To enable them for release builds as well, you need to enable [ProjectSettings.debug/settings/gdscript/always_track_call_stacks](class_projectsettings.md#class_ProjectSettings_property_debug/settings/gdscript/always_track_call_stacks).
...
\ **Warning:** When `include_variables` is ``true``, any captured variables can potentially (e.g. with GDScript backtraces) be their actual values, including any object references. This means that storing such a [ScriptBacktrace](class_scriptbacktrace.md) will prevent those objects from being deallocated, so it's generally recommended not to do so.

<hr class="classref-item-separator">

<a id="class_Engine_method_get_architecture_name"></a>

<!-- classref-method -->

[String](class_string.md) **get_architecture_name**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_architecture_name)
...
\ **Note:** This method does *not* return the name of the system's CPU architecture (like [OS.get_processor_name()](class_os.md#class_OS_method_get_processor_name)). For example, when running an ``x86_32`` Redot binary on an ``x86_64`` system, the returned value will still be ``"x86_32"``.

<hr class="classref-item-separator">

<a id="class_Engine_method_get_author_info"></a>

<!-- classref-method -->

[Dictionary](class_dictionary.md) **get_author_info**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_author_info)

Returns the engine author information as a [Dictionary](class_dictionary.md), where each entry is an [Array](class_array.md) of strings with the names of notable contributors to the Redot Engine: ``lead_developers``, ``founders``, ``project_managers``, and ``developers``.

See also [get_godot_author_info()](class_engine.md#class_Engine_method_get_godot_author_info) for Godot's author info.

<hr class="classref-item-separator">

<a id="class_Engine_method_get_copyright_info"></a>

<!-- classref-method -->

[Array](class_array.md)\[[Dictionary](class_dictionary.md)\] **get_copyright_info**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_copyright_info)

Returns an [Array](class_array.md) of dictionaries with copyright information for every component of Redot's source code.
...
<a id="class_Engine_method_get_donor_info"></a>

<!-- classref-method -->

[Dictionary](class_dictionary.md) **get_donor_info**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_donor_info)
...
<a id="class_Engine_method_get_frames_drawn"></a>
...
<a id="class_Engine_method_get_frames_per_second"></a>

<!-- classref-method -->

[float](class_float.md) **get_frames_per_second**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_frames_per_second)

Returns the average frames rendered every second (FPS), also known as the framerate.

<hr class="classref-item-separator">

<a id="class_Engine_method_get_godot_author_info"></a>

<!-- classref-method -->

[Dictionary](class_dictionary.md) **get_godot_author_info**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_godot_author_info)

Returns the engine author information for Redot as a [Dictionary](class_dictionary.md), where each entry is an [Array](class_array.md) of strings with the names of notable contributors to the Redot Engine: ``lead_developers``, ``founders``, ``project_managers``, and ``developers``.

See also [get_author_info()](class_engine.md#class_Engine_method_get_author_info) for Redot's author info.

<hr class="classref-item-separator">

<a id="class_Engine_method_get_godot_compatible_version_info"></a>

<!-- classref-method -->

[Dictionary](class_dictionary.md) **get_godot_compatible_version_info**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_godot_compatible_version_info)

Returns the current engine minimal version compatibility info in relation to Godot as a [Dictionary](class_dictionary.md) containing the following entries:
...
See also [get_version_info()](class_engine.md#class_Engine_method_get_version_info) for Redot's version info.

<hr class="classref-item-separator">

<a id="class_Engine_method_get_license_info"></a>

<!-- classref-method -->

[Dictionary](class_dictionary.md) **get_license_info**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_license_info)

Returns a [Dictionary](class_dictionary.md) of licenses used by Redot and included third party components. Each entry is a license name (such as "[Expat](https://en.wikipedia.org/wiki/MIT_License#Ambiguity_and_variants)") and its associated text.

<hr class="classref-item-separator">

<a id="class_Engine_method_get_license_text"></a>

<!-- classref-method -->

[String](class_string.md) **get_license_text**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_license_text)

Returns the full Redot license text.

<hr class="classref-item-separator">

<a id="class_Engine_method_get_main_loop"></a>

<!-- classref-method -->

[MainLoop](class_mainloop.md) **get_main_loop**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_main_loop)
...
<a id="class_Engine_method_get_physics_frames"></a>

<!-- classref-method -->

[int](class_int.md) **get_physics_frames**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_physics_frames)
...
<a id="class_Engine_method_get_physics_interpolation_fraction"></a>

<!-- classref-method -->

[float](class_float.md) **get_physics_interpolation_fraction**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_physics_interpolation_fraction)

Returns the fraction through the current physics tick we are at the time of rendering the frame. This can be used to implement fixed timestep interpolation.

<hr class="classref-item-separator">

<a id="class_Engine_method_get_process_frames"></a>

<!-- classref-method -->

[int](class_int.md) **get_process_frames**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_process_frames)
...
<a id="class_Engine_method_get_script_language"></a>

<!-- classref-method -->

[ScriptLanguage](class_scriptlanguage.md) **get_script_language**\ (\ index\: [int](class_int.md)\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_script_language)

Returns an instance of a [ScriptLanguage](class_scriptlanguage.md) with the given `index`.

<hr class="classref-item-separator">

<a id="class_Engine_method_get_script_language_count"></a>
...
<a id="class_Engine_method_get_singleton"></a>

<!-- classref-method -->

[Object](class_object.md) **get_singleton**\ (\ name\: [StringName](class_stringname.md)\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_singleton)
...
<a id="class_Engine_method_get_singleton_list"></a>

<!-- classref-method -->

[PackedStringArray](class_packedstringarray.md) **get_singleton_list**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_singleton_list)
...
<a id="class_Engine_method_get_version_info"></a>

<!-- classref-method -->

[Dictionary](class_dictionary.md) **get_version_info**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_version_info)
...
See also [get_godot_compatible_version_info()](class_engine.md#class_Engine_method_get_godot_compatible_version_info) for Redot's minimal compatibility version info.

<hr class="classref-item-separator">

<a id="class_Engine_method_get_write_movie_path"></a>

<!-- classref-method -->

[String](class_string.md) **get_write_movie_path**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_get_write_movie_path)
...
<a id="class_Engine_method_has_singleton"></a>

<!-- classref-method -->

[bool](class_bool.md) **has_singleton**\ (\ name\: [StringName](class_stringname.md)\ ) <span class="const">const</span> [🔗](#class_Engine_method_has_singleton)
...
<a id="class_Engine_method_is_editor_hint"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_editor_hint**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_is_editor_hint)
...
<a id="class_Engine_method_is_embedded_in_editor"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_embedded_in_editor**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_is_embedded_in_editor)
...
<a id="class_Engine_method_is_in_physics_frame"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_in_physics_frame**\ (\ ) <span class="const">const</span> [🔗](#class_Engine_method_is_in_physics_frame)
...
<a id="class_Engine_method_register_script_language"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **register_script_language**\ (\ language\: [ScriptLanguage](class_scriptlanguage.md)\ ) [🔗](#class_Engine_method_register_script_language)
...
<a id="class_Engine_method_register_singleton"></a>

<!-- classref-method -->

`void` **register_singleton**\ (\ name\: [StringName](class_stringname.md), instance\: [Object](class_object.md)\ ) [🔗](#class_Engine_method_register_singleton)

Registers the given [Object](class_object.md) `instance` as a singleton, available globally under `name`. Useful for plugins.

<hr class="classref-item-separator">

<a id="class_Engine_method_unregister_script_language"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **unregister_script_language**\ (\ language\: [ScriptLanguage](class_scriptlanguage.md)\ ) [🔗](#class_Engine_method_unregister_script_language)
...
<a id="class_Engine_method_unregister_singleton"></a>

<!-- classref-method -->

`void` **unregister_singleton**\ (\ name\: [StringName](class_stringname.md)\ ) [🔗](#class_Engine_method_unregister_singleton)
