...
<a id="class_NavigationObstacle3D"></a>
...
<table>
  <thead>
    <tr>
      ...
      <th>[affect_navigation_mesh](#class_NavigationObstacle3D_property_affect_navigation_mesh)</th>
      <th>`false`</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>[avoidance_enabled](#class_NavigationObstacle3D_property_avoidance_enabled)</td>
      <td>`true`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[avoidance_layers](#class_NavigationObstacle3D_property_avoidance_layers)</td>
      <td>`1`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[carve_navigation_mesh](#class_NavigationObstacle3D_property_carve_navigation_mesh)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[height](#class_NavigationObstacle3D_property_height)</td>
      <td>`1.0`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[radius](#class_NavigationObstacle3D_property_radius)</td>
      <td>`0.0`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[use_3d_avoidance](#class_NavigationObstacle3D_property_use_3d_avoidance)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[Vector3](class_vector3.md)</td>
      <td>[velocity](#class_NavigationObstacle3D_property_velocity)</td>
      <td>`Vector3(0, 0, 0)`</td>
    </tr>
    <tr>
      <td>[PackedVector3Array](class_packedvector3array.md)</td>
      <td>[vertices](#class_NavigationObstacle3D_property_vertices)</td>
...
<table>
  <thead>
    <tr>
      <th>[bool](class_bool.md)</th>
      <th>[get_avoidance_layer_value](#class_NavigationObstacle3D_method_get_avoidance_layer_value)\ (\ layer_number\: [int](class_int.md)\ ) <span class="const">const</span></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>[RID](class_rid.md)</td>
      <td>[get_navigation_map](#class_NavigationObstacle3D_method_get_navigation_map)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[RID](class_rid.md)</td>
      <td>[get_rid](#class_NavigationObstacle3D_method_get_rid)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_avoidance_layer_value](#class_NavigationObstacle3D_method_set_avoidance_layer_value)\ (\ layer_number\: [int](class_int.md), value\: [bool](class_bool.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_navigation_map](#class_NavigationObstacle3D_method_set_navigation_map)\ (\ navigation_map\: [RID](class_rid.md)\ )</td>
    </tr>
  </tbody>
</table>
...
<a id="class_NavigationObstacle3D_property_affect_navigation_mesh"></a>

<!-- classref-property -->

[bool](class_bool.md) **affect_navigation_mesh** = `false` [🔗](#class_NavigationObstacle3D_property_affect_navigation_mesh)
...
<a id="class_NavigationObstacle3D_property_avoidance_enabled"></a>

<!-- classref-property -->

[bool](class_bool.md) **avoidance_enabled** = `true` [🔗](#class_NavigationObstacle3D_property_avoidance_enabled)
...
<a id="class_NavigationObstacle3D_property_avoidance_layers"></a>

<!-- classref-property -->

[int](class_int.md) **avoidance_layers** = `1` [🔗](#class_NavigationObstacle3D_property_avoidance_layers)
...
<a id="class_NavigationObstacle3D_property_carve_navigation_mesh"></a>

<!-- classref-property -->

[bool](class_bool.md) **carve_navigation_mesh** = `false` [🔗](#class_NavigationObstacle3D_property_carve_navigation_mesh)
...
<a id="class_NavigationObstacle3D_property_height"></a>

<!-- classref-property -->

[float](class_float.md) **height** = `1.0` [🔗](#class_NavigationObstacle3D_property_height)
...
<a id="class_NavigationObstacle3D_property_radius"></a>

<!-- classref-property -->

[float](class_float.md) **radius** = `0.0` [🔗](#class_NavigationObstacle3D_property_radius)
...
<a id="class_NavigationObstacle3D_property_use_3d_avoidance"></a>

<!-- classref-property -->

[bool](class_bool.md) **use_3d_avoidance** = `false` [🔗](#class_NavigationObstacle3D_property_use_3d_avoidance)
...
<a id="class_NavigationObstacle3D_property_velocity"></a>

<!-- classref-property -->

[Vector3](class_vector3.md) **velocity** = `Vector3(0, 0, 0)` [🔗](#class_NavigationObstacle3D_property_velocity)
...
<a id="class_NavigationObstacle3D_property_vertices"></a>

<!-- classref-property -->

[PackedVector3Array](class_packedvector3array.md) **vertices** = `PackedVector3Array()` [🔗](#class_NavigationObstacle3D_property_vertices)
...
<a id="class_NavigationObstacle3D_method_get_avoidance_layer_value"></a>

<!-- classref-method -->

[bool](class_bool.md) **get_avoidance_layer_value**\ (\ layer_number\: [int](class_int.md)\ ) <span class="const">const</span> [🔗](#class_NavigationObstacle3D_method_get_avoidance_layer_value)
...
<a id="class_NavigationObstacle3D_method_get_navigation_map"></a>

<!-- classref-method -->

[RID](class_rid.md) **get_navigation_map**\ (\ ) <span class="const">const</span> [🔗](#class_NavigationObstacle3D_method_get_navigation_map)
...
<a id="class_NavigationObstacle3D_method_get_rid"></a>

<!-- classref-method -->

[RID](class_rid.md) **get_rid**\ (\ ) <span class="const">const</span> [🔗](#class_NavigationObstacle3D_method_get_rid)

Returns the [RID](class_rid.md) of this obstacle on the [NavigationServer3D](class_navigationserver3d.md).

<hr class="classref-item-separator">

<a id="class_NavigationObstacle3D_method_set_avoidance_layer_value"></a>

<!-- classref-method -->

`void` **set_avoidance_layer_value**\ (\ layer_number\: [int](class_int.md), value\: [bool](class_bool.md)\ ) [🔗](#class_NavigationObstacle3D_method_set_avoidance_layer_value)
...
<a id="class_NavigationObstacle3D_method_set_navigation_map"></a>

<!-- classref-method -->

`void` **set_navigation_map**\ (\ navigation_map\: [RID](class_rid.md)\ ) [🔗](#class_NavigationObstacle3D_method_set_navigation_map)
