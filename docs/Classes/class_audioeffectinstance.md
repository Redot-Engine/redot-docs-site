...
<a id="class_AudioEffectInstance"></a>

# AudioEffectInstance

**Inherits:** [RefCounted](class_refcounted.md) **<** [Object](class_object.md)

**Inherited By:** [AudioEffectSpectrumAnalyzerInstance](class_audioeffectspectrumanalyzerinstance.md)
...
<table>
  <thead>
    <tr>
      <th>`void`</th>
      <th>[_process](#class_AudioEffectInstance_private_method__process)\ (\ src_buffer\: `const void*`, dst_buffer\: `AudioFrame*`, frame_count\: [int](class_int.md)\ ) <span class="virtual">virtual</span> <span class="required">required</span></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[_process_silence](#class_AudioEffectInstance_private_method__process_silence)\ (\ ) <span class="virtual">virtual</span> <span class="const">const</span></td>
    </tr>
  </tbody>
</table>
...
<a id="class_AudioEffectInstance_private_method__process"></a>

<!-- classref-method -->

`void` **_process**\ (\ src_buffer\: `const void*`, dst_buffer\: `AudioFrame*`, frame_count\: [int](class_int.md)\ ) <span class="virtual">virtual</span> <span class="required">required</span> [🔗](#class_AudioEffectInstance_private_method__process)
...
<a id="class_AudioEffectInstance_private_method__process_silence"></a>

<!-- classref-method -->

[bool](class_bool.md) **_process_silence**\ (\ ) <span class="virtual">virtual</span> <span class="const">const</span> [🔗](#class_AudioEffectInstance_private_method__process_silence)
