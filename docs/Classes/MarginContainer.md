...
<table>
  <thead>
    <tr>
      <th>[int](int.md)</th>
      <th>[margin_bottom](#MarginContainer_theme_constant_margin_bottom)</th>
      <th>`0`</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>[int](int.md)</td>
      <td>[margin_left](#MarginContainer_theme_constant_margin_left)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[int](int.md)</td>
      <td>[margin_right](#MarginContainer_theme_constant_margin_right)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[int](int.md)</td>
      <td>[margin_top](#MarginContainer_theme_constant_margin_top)</td>
      <td>`0`</td>
    </tr>
  </tbody>
</table>
...
<a id="MarginContainer_theme_constant_margin_bottom"></a>

<!-- classref-themeproperty -->

[int](int.md) **margin_bottom** = `0` [🔗](#MarginContainer_theme_constant_margin_bottom)

Offsets towards the inside direct children of the container by this amount of pixels from the bottom.

<hr class="classref-item-separator"/>

<a id="MarginContainer_theme_constant_margin_left"></a>

<!-- classref-themeproperty -->

[int](int.md) **margin_left** = `0` [🔗](#MarginContainer_theme_constant_margin_left)

Offsets towards the inside direct children of the container by this amount of pixels from the left.

<hr class="classref-item-separator"/>

<a id="MarginContainer_theme_constant_margin_right"></a>

<!-- classref-themeproperty -->

[int](int.md) **margin_right** = `0` [🔗](#MarginContainer_theme_constant_margin_right)

Offsets towards the inside direct children of the container by this amount of pixels from the right.

<hr class="classref-item-separator"/>

<a id="MarginContainer_theme_constant_margin_top"></a>

<!-- classref-themeproperty -->

[int](int.md) **margin_top** = `0` [🔗](#MarginContainer_theme_constant_margin_top)
