...
<table>
  <thead>
    <tr>
      <th>`void`</th>
      <th>[add_node](#class_EditorSelection_method_add_node)\ (\ node\: [Node](class_node.md)\ )</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>`void`</td>
      <td>[clear](#class_EditorSelection_method_clear)\ (\ )</td>
    </tr>
    <tr>
      <td>[Array](class_array.md)\[[Node](class_node.md)\]</td>
      <td>[get_selected_nodes](#class_EditorSelection_method_get_selected_nodes)\ (\ )</td>
    </tr>
    <tr>
      <td>[Array](class_array.md)\[[Node](class_node.md)\]</td>
      <td>[get_top_selected_nodes](#class_EditorSelection_method_get_top_selected_nodes)\ (\ )</td>
    </tr>
    <tr>
      <td>[Array](class_array.md)\[[Node](class_node.md)\]</td>
      <td>[get_transformable_selected_nodes](#class_EditorSelection_method_get_transformable_selected_nodes)\ (\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[remove_node](#class_EditorSelection_method_remove_node)\ (\ node\: [Node](class_node.md)\ )</td>
    </tr>
  </tbody>
</table>
...
<a id="class_EditorSelection_signal_selection_changed"></a>
...
<a id="class_EditorSelection_method_add_node"></a>

<!-- classref-method -->

`void` **add_node**\ (\ node\: [Node](class_node.md)\ ) [🔗](#class_EditorSelection_method_add_node)
...
<a id="class_EditorSelection_method_clear"></a>
...
<a id="class_EditorSelection_method_get_selected_nodes"></a>
...
<a id="class_EditorSelection_method_get_top_selected_nodes"></a>

<!-- classref-method -->

[Array](class_array.md)\[[Node](class_node.md)\] **get_top_selected_nodes**\ (\ ) [🔗](#class_EditorSelection_method_get_top_selected_nodes)
...
<a id="class_EditorSelection_method_get_transformable_selected_nodes"></a>
...
<a id="class_EditorSelection_method_remove_node"></a>

<!-- classref-method -->

`void` **remove_node**\ (\ node\: [Node](class_node.md)\ ) [🔗](#class_EditorSelection_method_remove_node)
