...
<table>
  <thead>
    <tr>
      <th>[Signal](class_signal.md)</th>
      <th>[Signal](#class_Signal_constructor_Signal)\ (\ )</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>[Signal](class_signal.md)</td>
      <td>[Signal](#class_Signal_constructor_Signal)\ (\ from\: [Signal](class_signal.md)\ )</td>
    </tr>
    <tr>
      <td>[Signal](class_signal.md)</td>
      <td>[Signal](#class_Signal_constructor_Signal)\ (\ object\: [Object](class_object.md), signal\: [StringName](class_stringname.md)\ )</td>
    </tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr>
      ...
      <th>[connect](#class_Signal_method_connect)\ (\ callable\: [Callable](class_callable.md), flags\: [int](class_int.md) = 0\ )</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>`void`</td>
      <td>[disconnect](#class_Signal_method_disconnect)\ (\ callable\: [Callable](class_callable.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[emit](#class_Signal_method_emit)\ (\ ...\ ) <span class="vararg">vararg</span> <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Array](class_array.md)</td>
      <td>[get_connections](#class_Signal_method_get_connections)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[StringName](class_stringname.md)</td>
      <td>[get_name](#class_Signal_method_get_name)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Object](class_object.md)</td>
      <td>[get_object](#class_Signal_method_get_object)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_object_id](#class_Signal_method_get_object_id)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[has_connections](#class_Signal_method_has_connections)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_connected](#class_Signal_method_is_connected)\ (\ callable\: [Callable](class_callable.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_null](#class_Signal_method_is_null)\ (\ ) <span class="const">const</span></td>
    </tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr>
      ...
      <th>[operator !=](#class_Signal_operator_neq_Signal)\ (\ right\: [Signal](class_signal.md)\ )</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[operator ==](#class_Signal_operator_eq_Signal)\ (\ right\: [Signal](class_signal.md)\ )</td>
    </tr>
  </tbody>
</table>
...
<a id="class_Signal_constructor_Signal"></a>
...
<a id="class_Signal_method_connect"></a>

<!-- classref-method -->

[int](class_int.md) **connect**\ (\ callable\: [Callable](class_callable.md), flags\: [int](class_int.md) = 0\ ) [🔗](#class_Signal_method_connect)
...
<a id="class_Signal_method_disconnect"></a>

<!-- classref-method -->

`void` **disconnect**\ (\ callable\: [Callable](class_callable.md)\ ) [🔗](#class_Signal_method_disconnect)
...
<a id="class_Signal_method_emit"></a>

<!-- classref-method -->

`void` **emit**\ (\ ...\ ) <span class="vararg">vararg</span> <span class="const">const</span> [🔗](#class_Signal_method_emit)
...
<a id="class_Signal_method_get_connections"></a>

<!-- classref-method -->

[Array](class_array.md) **get_connections**\ (\ ) <span class="const">const</span> [🔗](#class_Signal_method_get_connections)
...
<a id="class_Signal_method_get_name"></a>

<!-- classref-method -->

[StringName](class_stringname.md) **get_name**\ (\ ) <span class="const">const</span> [🔗](#class_Signal_method_get_name)

Returns the name of this signal.

<hr class="classref-item-separator">

<a id="class_Signal_method_get_object"></a>

<!-- classref-method -->

[Object](class_object.md) **get_object**\ (\ ) <span class="const">const</span> [🔗](#class_Signal_method_get_object)

Returns the object emitting this signal.

<hr class="classref-item-separator">

<a id="class_Signal_method_get_object_id"></a>

<!-- classref-method -->

[int](class_int.md) **get_object_id**\ (\ ) <span class="const">const</span> [🔗](#class_Signal_method_get_object_id)
...
<a id="class_Signal_method_has_connections"></a>

<!-- classref-method -->

[bool](class_bool.md) **has_connections**\ (\ ) <span class="const">const</span> [🔗](#class_Signal_method_has_connections)

Returns ``true`` if any [Callable](class_callable.md) is connected to this signal.

<hr class="classref-item-separator">

<a id="class_Signal_method_is_connected"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_connected**\ (\ callable\: [Callable](class_callable.md)\ ) <span class="const">const</span> [🔗](#class_Signal_method_is_connected)

Returns ``true`` if the specified [Callable](class_callable.md) is connected to this signal.

<hr class="classref-item-separator">

<a id="class_Signal_method_is_null"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_null**\ (\ ) <span class="const">const</span> [🔗](#class_Signal_method_is_null)
...
<a id="class_Signal_operator_neq_Signal"></a>

<!-- classref-operator -->

[bool](class_bool.md) **operator !=**\ (\ right\: [Signal](class_signal.md)\ ) [🔗](#class_Signal_operator_neq_Signal)

Returns ``true`` if the signals do not share the same object and name.

<hr class="classref-item-separator">

<a id="class_Signal_operator_eq_Signal"></a>

<!-- classref-operator -->

[bool](class_bool.md) **operator ==**\ (\ right\: [Signal](class_signal.md)\ ) [🔗](#class_Signal_operator_eq_Signal)
