...
The global [@GlobalScope.typeof()](class_@globalscope.md#class_@GlobalScope_method_typeof) function returns the enumerated value of the Variant type stored in the current variable (see [Variant.Type](class_@globalscope.md#enum_@GlobalScope_Variant.Type)).
