...
<table>
  <thead>
    <tr>
      ...
      <th>[get_id](#class_Thread_method_get_id)\ (\ ) <span class="const">const</span></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_alive](#class_Thread_method_is_alive)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_started](#class_Thread_method_is_started)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_thread_safety_checks_enabled](#class_Thread_method_set_thread_safety_checks_enabled)\ (\ enabled\: [bool](class_bool.md)\ ) <span class="static">static</span></td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[start](#class_Thread_method_start)\ (\ callable\: [Callable](class_callable.md), priority\: [Priority](class_thread.md#enum_Thread_Priority) = 1\ )</td>
    </tr>
    <tr>
      <td>[Variant](class_variant.md)</td>
      <td>[wait_to_finish](#class_Thread_method_wait_to_finish)\ (\ )</td>
    </tr>
  </tbody>
</table>
...
<a id="class_Thread_constant_PRIORITY_LOW"></a>

<!-- classref-enumeration-constant -->

[Priority](class_thread.md#enum_Thread_Priority) **PRIORITY_LOW** = `0`

A thread running with lower priority than normally.<a id="class_Thread_constant_PRIORITY_NORMAL"></a>

<!-- classref-enumeration-constant -->

[Priority](class_thread.md#enum_Thread_Priority) **PRIORITY_NORMAL** = `1`

A thread with a standard priority.<a id="class_Thread_constant_PRIORITY_HIGH"></a>
...
<a id="class_Thread_method_get_id"></a>

<!-- classref-method -->

[String](class_string.md) **get_id**\ (\ ) <span class="const">const</span> [🔗](#class_Thread_method_get_id)
...
<a id="class_Thread_method_is_alive"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_alive**\ (\ ) <span class="const">const</span> [🔗](#class_Thread_method_is_alive)
...
<a id="class_Thread_method_is_started"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_started**\ (\ ) <span class="const">const</span> [🔗](#class_Thread_method_is_started)
...
<a id="class_Thread_method_set_thread_safety_checks_enabled"></a>

<!-- classref-method -->

`void` **set_thread_safety_checks_enabled**\ (\ enabled\: [bool](class_bool.md)\ ) <span class="static">static</span> [🔗](#class_Thread_method_set_thread_safety_checks_enabled)
...
<a id="class_Thread_method_start"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **start**\ (\ callable\: [Callable](class_callable.md), priority\: [Priority](class_thread.md#enum_Thread_Priority) = 1\ ) [🔗](#class_Thread_method_start)
...
<a id="class_Thread_method_wait_to_finish"></a>
