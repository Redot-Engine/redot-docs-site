...
<table>
  <thead>
    <tr>
      ...
      <th>[_process_custom_fx](#class_RichTextEffect_private_method__process_custom_fx)\ (\ char_fx\: [CharFXTransform](class_charfxtransform.md)\ ) <span class="virtual">virtual</span> <span class="const">const</span></th>
    </tr>
  </thead>
  <tbody>
  </tbody>
...
<a id="class_RichTextEffect_private_method__process_custom_fx"></a>

<!-- classref-method -->

[bool](class_bool.md) **_process_custom_fx**\ (\ char_fx\: [CharFXTransform](class_charfxtransform.md)\ ) <span class="virtual">virtual</span> <span class="const">const</span> [🔗](#class_RichTextEffect_private_method__process_custom_fx)
