...
<a id="class_OccluderInstance3D"></a>
...
<table>
  <thead>
    <tr>
      ...
      <th>[bake_mask](#class_OccluderInstance3D_property_bake_mask)</th>
      <th>`4294967295`</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>[bake_simplification_distance](#class_OccluderInstance3D_property_bake_simplification_distance)</td>
      <td>`0.1`</td>
    </tr>
    <tr>
      <td>[Occluder3D](class_occluder3d.md)</td>
      <td>[occluder](#class_OccluderInstance3D_property_occluder)</td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr>
      ...
      <th>[get_bake_mask_value](#class_OccluderInstance3D_method_get_bake_mask_value)\ (\ layer_number\: [int](class_int.md)\ ) <span class="const">const</span></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>`void`</td>
      <td>[set_bake_mask_value](#class_OccluderInstance3D_method_set_bake_mask_value)\ (\ layer_number\: [int](class_int.md), value\: [bool](class_bool.md)\ )</td>
    </tr>
  </tbody>
</table>
...
<a id="class_OccluderInstance3D_property_bake_mask"></a>

<!-- classref-property -->

[int](class_int.md) **bake_mask** = `4294967295` [🔗](#class_OccluderInstance3D_property_bake_mask)
...
<a id="class_OccluderInstance3D_property_bake_simplification_distance"></a>

<!-- classref-property -->

[float](class_float.md) **bake_simplification_distance** = `0.1` [🔗](#class_OccluderInstance3D_property_bake_simplification_distance)
...
<a id="class_OccluderInstance3D_property_occluder"></a>
...
<a id="class_OccluderInstance3D_method_get_bake_mask_value"></a>

<!-- classref-method -->

[bool](class_bool.md) **get_bake_mask_value**\ (\ layer_number\: [int](class_int.md)\ ) <span class="const">const</span> [🔗](#class_OccluderInstance3D_method_get_bake_mask_value)
...
<a id="class_OccluderInstance3D_method_set_bake_mask_value"></a>

<!-- classref-method -->

`void` **set_bake_mask_value**\ (\ layer_number\: [int](class_int.md), value\: [bool](class_bool.md)\ ) [🔗](#class_OccluderInstance3D_method_set_bake_mask_value)
