...
<table>
  <thead>
    <tr>
      ...
      <th>[clear_margin](#class_CanvasGroup_property_clear_margin)</th>
      <th>`10.0`</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>[fit_margin](#class_CanvasGroup_property_fit_margin)</td>
      <td>`10.0`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[use_mipmaps](#class_CanvasGroup_property_use_mipmaps)</td>
      <td>`false`</td>
    </tr>
  </tbody>
</table>
...
<a id="class_CanvasGroup_property_clear_margin"></a>

<!-- classref-property -->

[float](class_float.md) **clear_margin** = `10.0` [🔗](#class_CanvasGroup_property_clear_margin)
...
<a id="class_CanvasGroup_property_fit_margin"></a>
...
<a id="class_CanvasGroup_property_use_mipmaps"></a>

<!-- classref-property -->

[bool](class_bool.md) **use_mipmaps** = `false` [🔗](#class_CanvasGroup_property_use_mipmaps)
