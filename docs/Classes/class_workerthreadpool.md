...
<table>
  <thead>
    <tr>
      ...
      <th>[add_group_task](#class_WorkerThreadPool_method_add_group_task)\ (\ action\: [Callable](class_callable.md), elements\: [int](class_int.md), tasks_needed\: [int](class_int.md) = -1, high_priority\: [bool](class_bool.md) = false, description\: [String](class_string.md) = ""\ )</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[add_task](#class_WorkerThreadPool_method_add_task)\ (\ action\: [Callable](class_callable.md), high_priority\: [bool](class_bool.md) = false, description\: [String](class_string.md) = ""\ )</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_caller_group_id](#class_WorkerThreadPool_method_get_caller_group_id)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_caller_task_id](#class_WorkerThreadPool_method_get_caller_task_id)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_group_processed_element_count](#class_WorkerThreadPool_method_get_group_processed_element_count)\ (\ group_id\: [int](class_int.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_group_task_completed](#class_WorkerThreadPool_method_is_group_task_completed)\ (\ group_id\: [int](class_int.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_task_completed](#class_WorkerThreadPool_method_is_task_completed)\ (\ task_id\: [int](class_int.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[wait_for_group_task_completion](#class_WorkerThreadPool_method_wait_for_group_task_completion)\ (\ group_id\: [int](class_int.md)\ )</td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[wait_for_task_completion](#class_WorkerThreadPool_method_wait_for_task_completion)\ (\ task_id\: [int](class_int.md)\ )</td>
    </tr>
  </tbody>
</table>
...
<a id="class_WorkerThreadPool_method_add_group_task"></a>

<!-- classref-method -->

[int](class_int.md) **add_group_task**\ (\ action\: [Callable](class_callable.md), elements\: [int](class_int.md), tasks_needed\: [int](class_int.md) = -1, high_priority\: [bool](class_bool.md) = false, description\: [String](class_string.md) = ""\ ) [🔗](#class_WorkerThreadPool_method_add_group_task)
...
<a id="class_WorkerThreadPool_method_add_task"></a>

<!-- classref-method -->

[int](class_int.md) **add_task**\ (\ action\: [Callable](class_callable.md), high_priority\: [bool](class_bool.md) = false, description\: [String](class_string.md) = ""\ ) [🔗](#class_WorkerThreadPool_method_add_task)
...
<a id="class_WorkerThreadPool_method_get_caller_group_id"></a>

<!-- classref-method -->

[int](class_int.md) **get_caller_group_id**\ (\ ) <span class="const">const</span> [🔗](#class_WorkerThreadPool_method_get_caller_group_id)
...
<a id="class_WorkerThreadPool_method_get_caller_task_id"></a>

<!-- classref-method -->

[int](class_int.md) **get_caller_task_id**\ (\ ) <span class="const">const</span> [🔗](#class_WorkerThreadPool_method_get_caller_task_id)
...
<a id="class_WorkerThreadPool_method_get_group_processed_element_count"></a>

<!-- classref-method -->

[int](class_int.md) **get_group_processed_element_count**\ (\ group_id\: [int](class_int.md)\ ) <span class="const">const</span> [🔗](#class_WorkerThreadPool_method_get_group_processed_element_count)
...
<a id="class_WorkerThreadPool_method_is_group_task_completed"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_group_task_completed**\ (\ group_id\: [int](class_int.md)\ ) <span class="const">const</span> [🔗](#class_WorkerThreadPool_method_is_group_task_completed)
...
<a id="class_WorkerThreadPool_method_is_task_completed"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_task_completed**\ (\ task_id\: [int](class_int.md)\ ) <span class="const">const</span> [🔗](#class_WorkerThreadPool_method_is_task_completed)
...
<a id="class_WorkerThreadPool_method_wait_for_group_task_completion"></a>

<!-- classref-method -->

`void` **wait_for_group_task_completion**\ (\ group_id\: [int](class_int.md)\ ) [🔗](#class_WorkerThreadPool_method_wait_for_group_task_completion)

Pauses the thread that calls this method until the group task with the given ID is completed.

<hr class="classref-item-separator">

<a id="class_WorkerThreadPool_method_wait_for_task_completion"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **wait_for_task_completion**\ (\ task_id\: [int](class_int.md)\ ) [🔗](#class_WorkerThreadPool_method_wait_for_task_completion)
