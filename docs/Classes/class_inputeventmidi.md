...
<table>
  <thead>
    <tr>
      ...
      <th>[channel](#class_InputEventMIDI_property_channel)</th>
      <th>`0`</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>[controller_number](#class_InputEventMIDI_property_controller_number)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[controller_value](#class_InputEventMIDI_property_controller_value)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[instrument](#class_InputEventMIDI_property_instrument)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[MIDIMessage](class_@globalscope.md#enum_@GlobalScope_MIDIMessage)</td>
      <td>[message](#class_InputEventMIDI_property_message)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[pitch](#class_InputEventMIDI_property_pitch)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[pressure](#class_InputEventMIDI_property_pressure)</td>
      <td>`0`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[velocity](#class_InputEventMIDI_property_velocity)</td>
      <td>`0`</td>
    </tr>
  </tbody>
</table>
...
<a id="class_InputEventMIDI_property_channel"></a>

<!-- classref-property -->

[int](class_int.md) **channel** = `0` [🔗](#class_InputEventMIDI_property_channel)
...
<a id="class_InputEventMIDI_property_controller_number"></a>

<!-- classref-property -->

[int](class_int.md) **controller_number** = `0` [🔗](#class_InputEventMIDI_property_controller_number)
...
<a id="class_InputEventMIDI_property_controller_value"></a>

<!-- classref-property -->

[int](class_int.md) **controller_value** = `0` [🔗](#class_InputEventMIDI_property_controller_value)
...
<a id="class_InputEventMIDI_property_instrument"></a>

<!-- classref-property -->

[int](class_int.md) **instrument** = `0` [🔗](#class_InputEventMIDI_property_instrument)
...
<a id="class_InputEventMIDI_property_message"></a>

<!-- classref-property -->

[MIDIMessage](class_@globalscope.md#enum_@GlobalScope_MIDIMessage) **message** = `0` [🔗](#class_InputEventMIDI_property_message)

<!-- classref-property-setget -->

- `void` **set_message**\ (\ value\: [MIDIMessage](class_@globalscope.md#enum_@GlobalScope_MIDIMessage)\ )
- [MIDIMessage](class_@globalscope.md#enum_@GlobalScope_MIDIMessage) **get_message**\ (\ )

Represents the type of MIDI message (see the [MIDIMessage](class_@globalscope.md#enum_@GlobalScope_MIDIMessage) enum).
...
<a id="class_InputEventMIDI_property_pitch"></a>

<!-- classref-property -->

[int](class_int.md) **pitch** = `0` [🔗](#class_InputEventMIDI_property_pitch)
...
<a id="class_InputEventMIDI_property_pressure"></a>

<!-- classref-property -->

[int](class_int.md) **pressure** = `0` [🔗](#class_InputEventMIDI_property_pressure)
...
<a id="class_InputEventMIDI_property_velocity"></a>

<!-- classref-property -->

[int](class_int.md) **velocity** = `0` [🔗](#class_InputEventMIDI_property_velocity)
