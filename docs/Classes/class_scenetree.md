...
<a id="class_SceneTree"></a>

# SceneTree

**Inherits:** [MainLoop](class_mainloop.md) **<** [Object](class_object.md)
...
<table>
  <thead>
    <tr>
      ...
      <th>[auto_accept_quit](#class_SceneTree_property_auto_accept_quit)</th>
      <th>`true`</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>[current_scene](#class_SceneTree_property_current_scene)</td>
      <td></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[debug_collisions_hint](#class_SceneTree_property_debug_collisions_hint)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[debug_navigation_hint](#class_SceneTree_property_debug_navigation_hint)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[debug_paths_hint](#class_SceneTree_property_debug_paths_hint)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[Node](class_node.md)</td>
      <td>[edited_scene_root](#class_SceneTree_property_edited_scene_root)</td>
      <td></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[multiplayer_poll](#class_SceneTree_property_multiplayer_poll)</td>
      <td>`true`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[paused](#class_SceneTree_property_paused)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[physics_interpolation](#class_SceneTree_property_physics_interpolation)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[quit_on_go_back](#class_SceneTree_property_quit_on_go_back)</td>
      <td>`true`</td>
    </tr>
    <tr>
      <td>[Window](class_window.md)</td>
      <td>[root](#class_SceneTree_property_root)</td>
      <td></td>
    </tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr>
      <th>`void`</th>
      <th>[call_group](#class_SceneTree_method_call_group)\ (\ group\: [StringName](class_stringname.md), method\: [StringName](class_stringname.md), ...\ ) <span class="vararg">vararg</span></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>`void`</td>
      <td>[call_group_flags](#class_SceneTree_method_call_group_flags)\ (\ flags\: [int](class_int.md), group\: [StringName](class_stringname.md), method\: [StringName](class_stringname.md), ...\ ) <span class="vararg">vararg</span></td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[change_scene_to_file](#class_SceneTree_method_change_scene_to_file)\ (\ path\: [String](class_string.md)\ )</td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[change_scene_to_packed](#class_SceneTree_method_change_scene_to_packed)\ (\ packed_scene\: [PackedScene](class_packedscene.md)\ )</td>
    </tr>
    <tr>
      <td>[SceneTreeTimer](class_scenetreetimer.md)</td>
      <td>[create_timer](#class_SceneTree_method_create_timer)\ (\ time_sec\: [float](class_float.md), process_always\: [bool](class_bool.md) = true, process_in_physics\: [bool](class_bool.md) = false, ignore_time_scale\: [bool](class_bool.md) = false\ )</td>
    </tr>
    <tr>
      <td>[Tween](class_tween.md)</td>
      <td>[create_tween](#class_SceneTree_method_create_tween)\ (\ )</td>
    </tr>
    <tr>
      <td>[Node](class_node.md)</td>
      <td>[get_first_node_in_group](#class_SceneTree_method_get_first_node_in_group)\ (\ group\: [StringName](class_stringname.md)\ )</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_frame](#class_SceneTree_method_get_frame)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[MultiplayerAPI](class_multiplayerapi.md)</td>
      <td>[get_multiplayer](#class_SceneTree_method_get_multiplayer)\ (\ for_path\: [NodePath](class_nodepath.md) = NodePath("")\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_node_count](#class_SceneTree_method_get_node_count)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[get_node_count_in_group](#class_SceneTree_method_get_node_count_in_group)\ (\ group\: [StringName](class_stringname.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Array](class_array.md)\[[Node](class_node.md)\]</td>
      <td>[get_nodes_in_group](#class_SceneTree_method_get_nodes_in_group)\ (\ group\: [StringName](class_stringname.md)\ )</td>
    </tr>
    <tr>
      <td>[Array](class_array.md)\[[Tween](class_tween.md)\]</td>
      <td>[get_processed_tweens](#class_SceneTree_method_get_processed_tweens)\ (\ )</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[has_group](#class_SceneTree_method_has_group)\ (\ name\: [StringName](class_stringname.md)\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_accessibility_enabled](#class_SceneTree_method_is_accessibility_enabled)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[is_accessibility_supported](#class_SceneTree_method_is_accessibility_supported)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[notify_group](#class_SceneTree_method_notify_group)\ (\ group\: [StringName](class_stringname.md), notification\: [int](class_int.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[notify_group_flags](#class_SceneTree_method_notify_group_flags)\ (\ call_flags\: [int](class_int.md), group\: [StringName](class_stringname.md), notification\: [int](class_int.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[queue_delete](#class_SceneTree_method_queue_delete)\ (\ obj\: [Object](class_object.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[quit](#class_SceneTree_method_quit)\ (\ exit_code\: [int](class_int.md) = 0\ )</td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[reload_current_scene](#class_SceneTree_method_reload_current_scene)\ (\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_group](#class_SceneTree_method_set_group)\ (\ group\: [StringName](class_stringname.md), property\: [String](class_string.md), value\: [Variant](class_variant.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_group_flags](#class_SceneTree_method_set_group_flags)\ (\ call_flags\: [int](class_int.md), group\: [StringName](class_stringname.md), property\: [String](class_string.md), value\: [Variant](class_variant.md)\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[set_multiplayer](#class_SceneTree_method_set_multiplayer)\ (\ multiplayer\: [MultiplayerAPI](class_multiplayerapi.md), root_path\: [NodePath](class_nodepath.md) = NodePath("")\ )</td>
    </tr>
    <tr>
      <td>`void`</td>
      <td>[unload_current_scene](#class_SceneTree_method_unload_current_scene)\ (\ )</td>
    </tr>
  </tbody>
</table>
...
<a id="class_SceneTree_signal_node_added"></a>

<!-- classref-signal -->

**node_added**\ (\ node\: [Node](class_node.md)\ ) [🔗](#class_SceneTree_signal_node_added)

Emitted when the `node` enters this tree.

<hr class="classref-item-separator">

<a id="class_SceneTree_signal_node_configuration_warning_changed"></a>

<!-- classref-signal -->

**node_configuration_warning_changed**\ (\ node\: [Node](class_node.md)\ ) [🔗](#class_SceneTree_signal_node_configuration_warning_changed)
...
<a id="class_SceneTree_signal_node_removed"></a>

<!-- classref-signal -->

**node_removed**\ (\ node\: [Node](class_node.md)\ ) [🔗](#class_SceneTree_signal_node_removed)

Emitted when the `node` exits this tree.

<hr class="classref-item-separator">

<a id="class_SceneTree_signal_node_renamed"></a>

<!-- classref-signal -->

**node_renamed**\ (\ node\: [Node](class_node.md)\ ) [🔗](#class_SceneTree_signal_node_renamed)

Emitted when the `node`'s [Node.name](class_node.md#class_Node_property_name) is changed.

<hr class="classref-item-separator">

<a id="class_SceneTree_signal_physics_frame"></a>
...
<a id="class_SceneTree_signal_process_frame"></a>
...
<a id="class_SceneTree_signal_scene_changed"></a>
...
<a id="class_SceneTree_signal_tree_changed"></a>
...
<a id="class_SceneTree_signal_tree_process_mode_changed"></a>
...
<a id="class_SceneTree_constant_GROUP_CALL_DEFAULT"></a>

<!-- classref-enumeration-constant -->

[GroupCallFlags](class_scenetree.md#enum_SceneTree_GroupCallFlags) **GROUP_CALL_DEFAULT** = `0`

Call nodes within a group with no special behavior (default).<a id="class_SceneTree_constant_GROUP_CALL_REVERSE"></a>

<!-- classref-enumeration-constant -->

[GroupCallFlags](class_scenetree.md#enum_SceneTree_GroupCallFlags) **GROUP_CALL_REVERSE** = `1`

Call nodes within a group in reverse tree hierarchy order (all nested children are called before their respective parent nodes).<a id="class_SceneTree_constant_GROUP_CALL_DEFERRED"></a>

<!-- classref-enumeration-constant -->

[GroupCallFlags](class_scenetree.md#enum_SceneTree_GroupCallFlags) **GROUP_CALL_DEFERRED** = `2`

Call nodes within a group at the end of the current frame (can be either process or physics frame), similar to [Object.call_deferred()](class_object.md#class_Object_method_call_deferred).<a id="class_SceneTree_constant_GROUP_CALL_UNIQUE"></a>
...
<a id="class_SceneTree_property_auto_accept_quit"></a>

<!-- classref-property -->

[bool](class_bool.md) **auto_accept_quit** = `true` [🔗](#class_SceneTree_property_auto_accept_quit)
...
<a id="class_SceneTree_property_current_scene"></a>
...
<a id="class_SceneTree_property_debug_collisions_hint"></a>

<!-- classref-property -->

[bool](class_bool.md) **debug_collisions_hint** = `false` [🔗](#class_SceneTree_property_debug_collisions_hint)
...
<a id="class_SceneTree_property_debug_navigation_hint"></a>

<!-- classref-property -->

[bool](class_bool.md) **debug_navigation_hint** = `false` [🔗](#class_SceneTree_property_debug_navigation_hint)
...
<a id="class_SceneTree_property_debug_paths_hint"></a>

<!-- classref-property -->

[bool](class_bool.md) **debug_paths_hint** = `false` [🔗](#class_SceneTree_property_debug_paths_hint)
...
<a id="class_SceneTree_property_edited_scene_root"></a>
...
<a id="class_SceneTree_property_multiplayer_poll"></a>

<!-- classref-property -->

[bool](class_bool.md) **multiplayer_poll** = `true` [🔗](#class_SceneTree_property_multiplayer_poll)
...
<a id="class_SceneTree_property_paused"></a>

<!-- classref-property -->

[bool](class_bool.md) **paused** = `false` [🔗](#class_SceneTree_property_paused)
...
<a id="class_SceneTree_property_physics_interpolation"></a>

<!-- classref-property -->

[bool](class_bool.md) **physics_interpolation** = `false` [🔗](#class_SceneTree_property_physics_interpolation)
...
<a id="class_SceneTree_property_quit_on_go_back"></a>

<!-- classref-property -->

[bool](class_bool.md) **quit_on_go_back** = `true` [🔗](#class_SceneTree_property_quit_on_go_back)
...
<a id="class_SceneTree_property_root"></a>
...
<a id="class_SceneTree_method_call_group"></a>

<!-- classref-method -->

`void` **call_group**\ (\ group\: [StringName](class_stringname.md), method\: [StringName](class_stringname.md), ...\ ) <span class="vararg">vararg</span> [🔗](#class_SceneTree_method_call_group)
...
<a id="class_SceneTree_method_call_group_flags"></a>

<!-- classref-method -->

`void` **call_group_flags**\ (\ flags\: [int](class_int.md), group\: [StringName](class_stringname.md), method\: [StringName](class_stringname.md), ...\ ) <span class="vararg">vararg</span> [🔗](#class_SceneTree_method_call_group_flags)
...
<a id="class_SceneTree_method_change_scene_to_file"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **change_scene_to_file**\ (\ path\: [String](class_string.md)\ ) [🔗](#class_SceneTree_method_change_scene_to_file)
...
<a id="class_SceneTree_method_change_scene_to_packed"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **change_scene_to_packed**\ (\ packed_scene\: [PackedScene](class_packedscene.md)\ ) [🔗](#class_SceneTree_method_change_scene_to_packed)
...
<a id="class_SceneTree_method_create_timer"></a>

<!-- classref-method -->

[SceneTreeTimer](class_scenetreetimer.md) **create_timer**\ (\ time_sec\: [float](class_float.md), process_always\: [bool](class_bool.md) = true, process_in_physics\: [bool](class_bool.md) = false, ignore_time_scale\: [bool](class_bool.md) = false\ ) [🔗](#class_SceneTree_method_create_timer)
...
<a id="class_SceneTree_method_create_tween"></a>

<!-- classref-method -->

[Tween](class_tween.md) **create_tween**\ (\ ) [🔗](#class_SceneTree_method_create_tween)

Creates and returns a new [Tween](class_tween.md) processed in this tree. The Tween will start automatically on the next process frame or physics frame (depending on its [TweenProcessMode](class_tween.md#enum_Tween_TweenProcessMode)).
...
<a id="class_SceneTree_method_get_first_node_in_group"></a>

<!-- classref-method -->

[Node](class_node.md) **get_first_node_in_group**\ (\ group\: [StringName](class_stringname.md)\ ) [🔗](#class_SceneTree_method_get_first_node_in_group)
...
<a id="class_SceneTree_method_get_frame"></a>

<!-- classref-method -->

[int](class_int.md) **get_frame**\ (\ ) <span class="const">const</span> [🔗](#class_SceneTree_method_get_frame)
...
<a id="class_SceneTree_method_get_multiplayer"></a>

<!-- classref-method -->

[MultiplayerAPI](class_multiplayerapi.md) **get_multiplayer**\ (\ for_path\: [NodePath](class_nodepath.md) = NodePath("")\ ) <span class="const">const</span> [🔗](#class_SceneTree_method_get_multiplayer)
...
<a id="class_SceneTree_method_get_node_count"></a>

<!-- classref-method -->

[int](class_int.md) **get_node_count**\ (\ ) <span class="const">const</span> [🔗](#class_SceneTree_method_get_node_count)

Returns the number of nodes inside this tree.

<hr class="classref-item-separator">

<a id="class_SceneTree_method_get_node_count_in_group"></a>

<!-- classref-method -->

[int](class_int.md) **get_node_count_in_group**\ (\ group\: [StringName](class_stringname.md)\ ) <span class="const">const</span> [🔗](#class_SceneTree_method_get_node_count_in_group)

Returns the number of nodes assigned to the given group.

<hr class="classref-item-separator">

<a id="class_SceneTree_method_get_nodes_in_group"></a>

<!-- classref-method -->

[Array](class_array.md)\[[Node](class_node.md)\] **get_nodes_in_group**\ (\ group\: [StringName](class_stringname.md)\ ) [🔗](#class_SceneTree_method_get_nodes_in_group)
...
<a id="class_SceneTree_method_get_processed_tweens"></a>
...
<a id="class_SceneTree_method_has_group"></a>

<!-- classref-method -->

[bool](class_bool.md) **has_group**\ (\ name\: [StringName](class_stringname.md)\ ) <span class="const">const</span> [🔗](#class_SceneTree_method_has_group)

Returns ``true`` if a node added to the given group `name` exists in the tree.

<hr class="classref-item-separator">

<a id="class_SceneTree_method_is_accessibility_enabled"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_accessibility_enabled**\ (\ ) <span class="const">const</span> [🔗](#class_SceneTree_method_is_accessibility_enabled)

Returns ``true`` if accessibility features are enabled, and accessibility information updates are actively processed.

<hr class="classref-item-separator">

<a id="class_SceneTree_method_is_accessibility_supported"></a>

<!-- classref-method -->

[bool](class_bool.md) **is_accessibility_supported**\ (\ ) <span class="const">const</span> [🔗](#class_SceneTree_method_is_accessibility_supported)

Returns ``true`` if accessibility features are supported by the OS and enabled in project settings.

<hr class="classref-item-separator">

<a id="class_SceneTree_method_notify_group"></a>

<!-- classref-method -->

`void` **notify_group**\ (\ group\: [StringName](class_stringname.md), notification\: [int](class_int.md)\ ) [🔗](#class_SceneTree_method_notify_group)

Calls [Object.notification()](class_object.md#class_Object_method_notification) with the given `notification` to all nodes inside this tree added to the `group`. See also [Redot notifications](../tutorials/best_practices/redot_notifications.md) and [call_group()](class_scenetree.md#class_SceneTree_method_call_group) and [set_group()](class_scenetree.md#class_SceneTree_method_set_group).

\ **Note:** This method acts immediately on all selected nodes at once, which may cause stuttering in some performance-intensive situations.

<hr class="classref-item-separator">

<a id="class_SceneTree_method_notify_group_flags"></a>

<!-- classref-method -->

`void` **notify_group_flags**\ (\ call_flags\: [int](class_int.md), group\: [StringName](class_stringname.md), notification\: [int](class_int.md)\ ) [🔗](#class_SceneTree_method_notify_group_flags)
...
<a id="class_SceneTree_method_queue_delete"></a>

<!-- classref-method -->

`void` **queue_delete**\ (\ obj\: [Object](class_object.md)\ ) [🔗](#class_SceneTree_method_queue_delete)
...
<a id="class_SceneTree_method_quit"></a>

<!-- classref-method -->

`void` **quit**\ (\ exit_code\: [int](class_int.md) = 0\ ) [🔗](#class_SceneTree_method_quit)
...
<a id="class_SceneTree_method_reload_current_scene"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **reload_current_scene**\ (\ ) [🔗](#class_SceneTree_method_reload_current_scene)
...
<a id="class_SceneTree_method_set_group"></a>

<!-- classref-method -->

`void` **set_group**\ (\ group\: [StringName](class_stringname.md), property\: [String](class_string.md), value\: [Variant](class_variant.md)\ ) [🔗](#class_SceneTree_method_set_group)
...
<a id="class_SceneTree_method_set_group_flags"></a>

<!-- classref-method -->

`void` **set_group_flags**\ (\ call_flags\: [int](class_int.md), group\: [StringName](class_stringname.md), property\: [String](class_string.md), value\: [Variant](class_variant.md)\ ) [🔗](#class_SceneTree_method_set_group_flags)
...
<a id="class_SceneTree_method_set_multiplayer"></a>

<!-- classref-method -->

`void` **set_multiplayer**\ (\ multiplayer\: [MultiplayerAPI](class_multiplayerapi.md), root_path\: [NodePath](class_nodepath.md) = NodePath("")\ ) [🔗](#class_SceneTree_method_set_multiplayer)
...
\ **Note:** [set_multiplayer()](class_scenetree.md#class_SceneTree_method_set_multiplayer) should be called *before* the child nodes are ready at the given `root_path`. If multiplayer nodes like [MultiplayerSpawner](class_multiplayerspawner.md) or [MultiplayerSynchronizer](class_multiplayersynchronizer.md) are added to the tree before the custom multiplayer API is set, they will not work.

<hr class="classref-item-separator">

<a id="class_SceneTree_method_unload_current_scene"></a>
