...
- **The class reference.** This is the documentation for the complete Godot API
  ...
  offline, directly in Godot's code editor, or online at Godot [Class Reference ](doc_class_reference). To contribute to the class reference, you have to edit the
