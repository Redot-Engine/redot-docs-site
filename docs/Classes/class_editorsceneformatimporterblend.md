...
<a id="class_EditorSceneFormatImporterBlend"></a>
...
The location of the Blender binary is set via the [EditorSettings.filesystem/import/blender/blender_path](class_editorsettings.md#class_EditorSettings_property_filesystem/import/blender/blender_path) setting.
