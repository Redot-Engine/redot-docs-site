...
See [doc_renderers](doc_renderers) for a detailed comparison of the rendering methods.
...
- [doc_variable_rate_shading](doc_variable_rate_shading) on supported GPUs in Forward+ and Mobile.
...
- *Images:* See [doc_importing_images](doc_importing_images).
- *Audio:*
...
- *3D scenes:* See [doc_importing_3d_scenes](doc_importing_3d_scenes).
