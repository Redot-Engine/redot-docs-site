...
<a id="class_ResourceImporterDynamicFont"></a>
...
<table>
  <thead>
    <tr>
      ...
      <th>[allow_system_fallback](#class_ResourceImporterDynamicFont_property_allow_system_fallback)</th>
      <th>`true`</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>[antialiasing](#class_ResourceImporterDynamicFont_property_antialiasing)</td>
      <td>`1`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[compress](#class_ResourceImporterDynamicFont_property_compress)</td>
      <td>`true`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[disable_embedded_bitmaps](#class_ResourceImporterDynamicFont_property_disable_embedded_bitmaps)</td>
      <td>`true`</td>
    </tr>
    <tr>
      <td>[Array](class_array.md)</td>
      <td>[fallbacks](#class_ResourceImporterDynamicFont_property_fallbacks)</td>
      <td>`[]`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[force_autohinter](#class_ResourceImporterDynamicFont_property_force_autohinter)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[generate_mipmaps](#class_ResourceImporterDynamicFont_property_generate_mipmaps)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[hinting](#class_ResourceImporterDynamicFont_property_hinting)</td>
      <td>`1`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[keep_rounding_remainders](#class_ResourceImporterDynamicFont_property_keep_rounding_remainders)</td>
      <td>`true`</td>
    </tr>
    <tr>
      <td>[Dictionary](class_dictionary.md)</td>
      <td>[language_support](#class_ResourceImporterDynamicFont_property_language_support)</td>
      <td>`{}`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[modulate_color_glyphs](#class_ResourceImporterDynamicFont_property_modulate_color_glyphs)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[msdf_pixel_range](#class_ResourceImporterDynamicFont_property_msdf_pixel_range)</td>
      <td>`8`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[msdf_size](#class_ResourceImporterDynamicFont_property_msdf_size)</td>
      <td>`48`</td>
    </tr>
    <tr>
      <td>[bool](class_bool.md)</td>
      <td>[multichannel_signed_distance_field](#class_ResourceImporterDynamicFont_property_multichannel_signed_distance_field)</td>
      <td>`false`</td>
    </tr>
    <tr>
      <td>[Dictionary](class_dictionary.md)</td>
      <td>[opentype_features](#class_ResourceImporterDynamicFont_property_opentype_features)</td>
      <td>`{}`</td>
    </tr>
    <tr>
      <td>[float](class_float.md)</td>
      <td>[oversampling](#class_ResourceImporterDynamicFont_property_oversampling)</td>
      <td>`0.0`</td>
    </tr>
    <tr>
      <td>[Array](class_array.md)</td>
      <td>[preload](#class_ResourceImporterDynamicFont_property_preload)</td>
      <td>`[]`</td>
    </tr>
    <tr>
      <td>[Dictionary](class_dictionary.md)</td>
      <td>[script_support](#class_ResourceImporterDynamicFont_property_script_support)</td>
      <td>`{}`</td>
    </tr>
    <tr>
      <td>[int](class_int.md)</td>
      <td>[subpixel_positioning](#class_ResourceImporterDynamicFont_property_subpixel_positioning)</td>
      <td>`4`</td>
    </tr>
  </tbody>
</table>
...
<a id="class_ResourceImporterDynamicFont_property_allow_system_fallback"></a>

<!-- classref-property -->

[bool](class_bool.md) **allow_system_fallback** = `true` [🔗](#class_ResourceImporterDynamicFont_property_allow_system_fallback)
...
<a id="class_ResourceImporterDynamicFont_property_antialiasing"></a>

<!-- classref-property -->

[int](class_int.md) **antialiasing** = `1` [🔗](#class_ResourceImporterDynamicFont_property_antialiasing)
...
<a id="class_ResourceImporterDynamicFont_property_compress"></a>

<!-- classref-property -->

[bool](class_bool.md) **compress** = `true` [🔗](#class_ResourceImporterDynamicFont_property_compress)

If ``true``, uses lossless compression for the resulting font.

<hr class="classref-item-separator">

<a id="class_ResourceImporterDynamicFont_property_disable_embedded_bitmaps"></a>

<!-- classref-property -->

[bool](class_bool.md) **disable_embedded_bitmaps** = `true` [🔗](#class_ResourceImporterDynamicFont_property_disable_embedded_bitmaps)

If set to ``true``, embedded font bitmap loading is disabled (bitmap-only and color fonts ignore this property).

<hr class="classref-item-separator">

<a id="class_ResourceImporterDynamicFont_property_fallbacks"></a>
...
<a id="class_ResourceImporterDynamicFont_property_force_autohinter"></a>

<!-- classref-property -->

[bool](class_bool.md) **force_autohinter** = `false` [🔗](#class_ResourceImporterDynamicFont_property_force_autohinter)
...
<a id="class_ResourceImporterDynamicFont_property_generate_mipmaps"></a>

<!-- classref-property -->

[bool](class_bool.md) **generate_mipmaps** = `false` [🔗](#class_ResourceImporterDynamicFont_property_generate_mipmaps)
...
<a id="class_ResourceImporterDynamicFont_property_hinting"></a>

<!-- classref-property -->

[int](class_int.md) **hinting** = `1` [🔗](#class_ResourceImporterDynamicFont_property_hinting)
...
<a id="class_ResourceImporterDynamicFont_property_keep_rounding_remainders"></a>

<!-- classref-property -->

[bool](class_bool.md) **keep_rounding_remainders** = `true` [🔗](#class_ResourceImporterDynamicFont_property_keep_rounding_remainders)

If set to ``true``, when aligning glyphs to the pixel boundaries rounding remainders are accumulated to ensure more uniform glyph distribution. This setting has no effect if subpixel positioning is enabled.

<hr class="classref-item-separator">

<a id="class_ResourceImporterDynamicFont_property_language_support"></a>
...
<a id="class_ResourceImporterDynamicFont_property_modulate_color_glyphs"></a>

<!-- classref-property -->

[bool](class_bool.md) **modulate_color_glyphs** = `false` [🔗](#class_ResourceImporterDynamicFont_property_modulate_color_glyphs)

If set to ``true``, color modulation is applied when drawing colored glyphs, otherwise it's applied to the monochrome glyphs only.

<hr class="classref-item-separator">

<a id="class_ResourceImporterDynamicFont_property_msdf_pixel_range"></a>

<!-- classref-property -->

[int](class_int.md) **msdf_pixel_range** = `8` [🔗](#class_ResourceImporterDynamicFont_property_msdf_pixel_range)
...
<a id="class_ResourceImporterDynamicFont_property_msdf_size"></a>

<!-- classref-property -->

[int](class_int.md) **msdf_size** = `48` [🔗](#class_ResourceImporterDynamicFont_property_msdf_size)
...
<a id="class_ResourceImporterDynamicFont_property_multichannel_signed_distance_field"></a>

<!-- classref-property -->

[bool](class_bool.md) **multichannel_signed_distance_field** = `false` [🔗](#class_ResourceImporterDynamicFont_property_multichannel_signed_distance_field)
...
<a id="class_ResourceImporterDynamicFont_property_opentype_features"></a>
...
<a id="class_ResourceImporterDynamicFont_property_oversampling"></a>

<!-- classref-property -->

[float](class_float.md) **oversampling** = `0.0` [🔗](#class_ResourceImporterDynamicFont_property_oversampling)
...
<a id="class_ResourceImporterDynamicFont_property_preload"></a>
...
<a id="class_ResourceImporterDynamicFont_property_script_support"></a>
...
<a id="class_ResourceImporterDynamicFont_property_subpixel_positioning"></a>

<!-- classref-property -->

[int](class_int.md) **subpixel_positioning** = `4` [🔗](#class_ResourceImporterDynamicFont_property_subpixel_positioning)
