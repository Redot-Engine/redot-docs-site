...
<table>
  <thead>
    <tr>
      ...
      <th>[setup](#class_DTLSServer_method_setup)\ (\ server_options\: [TLSOptions](class_tlsoptions.md)\ )</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>[PacketPeerDTLS](class_packetpeerdtls.md)</td>
      <td>[take_connection](#class_DTLSServer_method_take_connection)\ (\ udp_peer\: [PacketPeerUDP](class_packetpeerudp.md)\ )</td>
    </tr>
  </tbody>
</table>
...
<a id="class_DTLSServer_method_setup"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **setup**\ (\ server_options\: [TLSOptions](class_tlsoptions.md)\ ) [🔗](#class_DTLSServer_method_setup)
...
<a id="class_DTLSServer_method_take_connection"></a>

<!-- classref-method -->

[PacketPeerDTLS](class_packetpeerdtls.md) **take_connection**\ (\ udp_peer\: [PacketPeerUDP](class_packetpeerudp.md)\ ) [🔗](#class_DTLSServer_method_take_connection)
