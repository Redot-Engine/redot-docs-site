...
<table>
  <thead>
    <tr>
      ...
      <th>[can_instantiate](#class_PackedScene_method_can_instantiate)\ (\ ) <span class="const">const</span></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>[SceneState](class_scenestate.md)</td>
      <td>[get_state](#class_PackedScene_method_get_state)\ (\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Node](class_node.md)</td>
      <td>[instantiate](#class_PackedScene_method_instantiate)\ (\ edit_state\: [GenEditState](class_packedscene.md#enum_PackedScene_GenEditState) = 0\ ) <span class="const">const</span></td>
    </tr>
    <tr>
      <td>[Error](class_@globalscope.md#enum_@GlobalScope_Error)</td>
      <td>[pack](#class_PackedScene_method_pack)\ (\ path\: [Node](class_node.md)\ )</td>
    </tr>
  </tbody>
</table>
...
<a id="class_PackedScene_constant_GEN_EDIT_STATE_DISABLED"></a>

<!-- classref-enumeration-constant -->

[GenEditState](class_packedscene.md#enum_PackedScene_GenEditState) **GEN_EDIT_STATE_DISABLED** = `0`

If passed to [instantiate()](class_packedscene.md#class_PackedScene_method_instantiate), blocks edits to the scene state.<a id="class_PackedScene_constant_GEN_EDIT_STATE_INSTANCE"></a>
...
\ **Note:** Only available in editor builds.<a id="class_PackedScene_constant_GEN_EDIT_STATE_MAIN"></a>
...
\ **Note:** Only available in editor builds.<a id="class_PackedScene_constant_GEN_EDIT_STATE_MAIN_INHERITED"></a>
...
<a id="class_PackedScene_method_can_instantiate"></a>

<!-- classref-method -->

[bool](class_bool.md) **can_instantiate**\ (\ ) <span class="const">const</span> [🔗](#class_PackedScene_method_can_instantiate)

Returns ``true`` if the scene file has nodes.

<hr class="classref-item-separator">

<a id="class_PackedScene_method_get_state"></a>

<!-- classref-method -->

[SceneState](class_scenestate.md) **get_state**\ (\ ) <span class="const">const</span> [🔗](#class_PackedScene_method_get_state)

Returns the [SceneState](class_scenestate.md) representing the scene file contents.

<hr class="classref-item-separator">

<a id="class_PackedScene_method_instantiate"></a>

<!-- classref-method -->

[Node](class_node.md) **instantiate**\ (\ edit_state\: [GenEditState](class_packedscene.md#enum_PackedScene_GenEditState) = 0\ ) <span class="const">const</span> [🔗](#class_PackedScene_method_instantiate)
...
<a id="class_PackedScene_method_pack"></a>

<!-- classref-method -->

[Error](class_@globalscope.md#enum_@GlobalScope_Error) **pack**\ (\ path\: [Node](class_node.md)\ ) [🔗](#class_PackedScene_method_pack)
